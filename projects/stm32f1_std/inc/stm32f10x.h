...
/* Uncomment the line below according to the target STM32 device used in your
  ...
  */
		...
		!defined(STM32F10X_MD_VL) && !defined(STM32F10X_HD) &&                             \
 ...
 */
	...
	#define AFIO_MAPR_USART3_REMAP_PARTIALREMAP                                                \
		((uint32_t)0x00000010) /*!< Partial remap (TX/PC10, RX/PC11, CK/PC12, CTS/PB13,    \
					  RTS/PB14) */
	...
	#define AFIO_MAPR_TIM1_REMAP_PARTIALREMAP                                                  \
		((uint32_t)0x00000040) /*!< Partial remap (ETR/PA12, CH1/PA8, CH2/PA9, CH3/PA10,   \
	...
	#define SysTick_LOAD_RELOAD                                                                \
		((uint32_t)0x00FFFFFF) /*!< Value to load into the SysTick Current Value Register  \
	...
	#define SCB_ICSR_RETTOBASE                                                                 \
		((uint32_t)0x00000800) /*!< All active exceptions minus the IPSR_current_exception \
					  yields the empty set */
	#define SCB_ICSR_VECTPENDING ((uint32_t)0x003FF000) /*!< Pending ISR number field */
	#define SCB_ICSR_ISRPENDING ((uint32_t)0x00400000)  /*!< Interrupt pending flag */
	#define SCB_ICSR_ISRPREEMPT                                                                \
		((uint32_t)0x00800000) /*!< It indicates that a pending interrupt becomes active   \
					  in the next running cycle */
	...
	#define SCB_AIRCR_PRIGROUP0                                                                \
		((uint32_t)0x00000000) /*!< Priority group=0 (7 bits of pre-emption priority, 1    \
					  bit of subpriority) */
	#define SCB_AIRCR_PRIGROUP1                                                                \
		((uint32_t)0x00000100) /*!< Priority group=1 (6 bits of pre-emption priority, 2    \
					  bits of subpriority) */
	#define SCB_AIRCR_PRIGROUP2                                                                \
		((uint32_t)0x00000200) /*!< Priority group=2 (5 bits of pre-emption priority, 3    \
					  bits of subpriority) */
	#define SCB_AIRCR_PRIGROUP3                                                                \
		((uint32_t)0x00000300) /*!< Priority group=3 (4 bits of pre-emption priority, 4    \
					  bits of subpriority) */
	#define SCB_AIRCR_PRIGROUP4                                                                \
		((uint32_t)0x00000400) /*!< Priority group=4 (3 bits of pre-emption priority, 5    \
					  bits of subpriority) */
	#define SCB_AIRCR_PRIGROUP5                                                                \
		((uint32_t)0x00000500) /*!< Priority group=5 (2 bits of pre-emption priority, 6    \
					  bits of subpriority) */
	#define SCB_AIRCR_PRIGROUP6                                                                \
		((uint32_t)0x00000600) /*!< Priority group=6 (1 bit of pre-emption priority, 7     \
					  bits of subpriority) */
	#define SCB_AIRCR_PRIGROUP7                                                                \
		((uint32_t)0x00000700) /*!< Priority group=7 (no pre-emption priority, 8 bits of   \
					  subpriority) */
	...
	#define SCB_CCR_NONBASETHRDENA                                                             \
		((uint16_t)0x0001) /*!< Thread mode can be entered from any level in Handler mode  \
				      by controlled return value */
	#define SCB_CCR_USERSETMPEND                                                               \
		((uint16_t)0x0002) /*!< Enables user code to write the Software Trigger Interrupt  \
				      register to trigger (pend) a Main exception */
	#define SCB_CCR_UNALIGN_TRP ((uint16_t)0x0008) /*!< Trap for unaligned access */
	#define SCB_CCR_DIV_0_TRP ((uint16_t)0x0010)   /*!< Trap on Divide by 0 */
	#define SCB_CCR_BFHFNMIGN ((uint16_t)0x0100)   /*!< Handlers running at priority -1 and -2 \
							*/
	#define SCB_CCR_STKALIGN                                                                   \
		((uint16_t)0x0200) /*!< On exception entry, the SP used prior to the exception is  \
				      adjusted to be 8-byte aligned */

	/*******************  Bit definition for SCB_SHPR register ********************/
	#define SCB_SHPR_PRI_N                                                                     \
		((uint32_t)0x000000FF) /*!< Priority of system handler 4,8, and 12. Mem Manage,    \
					  reserved and Debug Monitor */
	#define SCB_SHPR_PRI_N1                                                                    \
		((uint32_t)0x0000FF00) /*!< Priority of system handler 5,9, and 13. Bus Fault,     \
					  reserved and reserved */
	#define SCB_SHPR_PRI_N2                                                                    \
		((uint32_t)0x00FF0000) /*!< Priority of system handler 6,10, and 14. Usage Fault,  \
					  reserved and PendSV */
	#define SCB_SHPR_PRI_N3                                                                    \
		((uint32_t)0xFF000000) /*!< Priority of system handler 7,11, and 15. Reserved,     \
					  SVCall and SysTick */
	...
	#define SCB_CFSR_DIVBYZERO                                                                 \
		((uint32_t)0x02000000) /*!< Fault occurs when SDIV or DIV instruction is used with \
					  a divisor of 0 */

	/*******************  Bit definition for SCB_HFSR register  *******************/
	#define SCB_HFSR_VECTTBL                                                                   \
		((uint32_t)0x00000002) /*!< Fault occurs because of vector table read on exception \
					  processing */
	#define SCB_HFSR_FORCED                                                                    \
		((uint32_t)0x40000000) /*!< Hard Fault activated when a configurable Fault was     \
					  received and cannot activate */
	...
	#define ADC_CR2_JEXTSEL                                                                    \
		((uint32_t)0x00007000) /*!< JEXTSEL[2:0] bits (External event select for injected  \
					  group) */
	...
	#define ADC_CR2_EXTSEL                                                                     \
		((uint32_t)0x000E0000) /*!< EXTSEL[2:0] bits (External Event Select for regular    \
					  group) */
...
/*----------------------------------------------------------------------------*/
	...
	#define FSMC_PATT2_ATTHIZ2                                                                 \
		((uint32_t)0xFF000000) /*!< ATTHIZ2[7:0] bits (Attribute memory 2 databus HiZ      \
					  time) */
	...
	#define FSMC_PATT3_ATTHIZ3                                                                 \
		((uint32_t)0xFF000000) /*!< ATTHIZ3[7:0] bits (Attribute memory 3 databus HiZ      \
					  time) */
	...
	#define FSMC_PATT4_ATTHIZ4                                                                 \
		((uint32_t)0xFF000000) /*!< ATTHIZ4[7:0] bits (Attribute memory 4 databus HiZ      \
					  time) */
	...
	#define SDIO_FIFOCNT_FIFOCOUNT                                                             \
		((uint32_t)0x00FFFFFF) /*!< Remaining number of words to be written to or read     \
					  from the FIFO */
	...
	#define FLASH_WRP3_nWRP3                                                                   \
		...
		/* Eight sequential Writes to this address (offset 0x28) will write all Wake-UpFrame
   Filter Registers. Eight sequential Reads from this address (offset 0x28) will read all
   ...
   Wake-UpFrame Filter Re7 : Filter3 CRC16 - Filter2 CRC16 */
		...
		/* Bit definition for Ethernet MMC Transmitted Good Frames after Single Collision
		 * Counter Register */

 ...
 *   This parameter can be one of the following values:
 *     @arg  RCC_OTGFSCLKSource_PLLVCO_Div3: PLL VCO clock divided by 2 selected as USB OTG FS clock
 * source
 *     @arg  RCC_OTGFSCLKSource_PLLVCO_Div2: PLL VCO clock divided by 2 selected as USB OTG FS clock
 * source
 * @retval None
 */
...
void RCC_GetClocksFreq(RCC_ClocksTypeDef *RCC_Clocks)
{
	...
	case 0x08: /* PLL used as system clock */
		...
		if (pllsource ==
		    0x00) { /* HSI oscillator clock divided by 2 selected as PLL clock entry */

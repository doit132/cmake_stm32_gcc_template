 ...
 *
 *  - For all TIMx
 *     @arg TIM_TRGOSource_Reset:  The UG bit in the TIM_EGR register is used as the trigger output
 * (TRGO).
 ...
 *     @arg TIM_SlaveMode_Gated:     The counter clock is enabled when the trigger signal (TRGI) is
 * high.

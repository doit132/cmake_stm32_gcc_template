...
typedef struct {
	...
	__IO uint8_t
		SHP[12]; /*!< Offset: 0x18  System Handlers Priority Registers (4-7, 8-11, 12-15) */
...
typedef struct {
	...
	#define InterruptType_ACTLR_DISDEFWBUF_Msk                                                 \
		(1ul << InterruptType_ACTLR_DISDEFWBUF_Pos) /*!< InterruptType ACTLR: DISDEFWBUF   \
							       Mask */
	...
	#define InterruptType_ACTLR_DISMCYCINT_Msk                                                 \
		(1ul << InterruptType_ACTLR_DISMCYCINT_Pos) /*!< InterruptType ACTLR: DISMCYCINT   \
							       Mask */

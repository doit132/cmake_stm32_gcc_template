...
typedef struct {
        ...
        #define InterruptType_ICTR_INTLINESNUM_Msk \
                (0x1Ful << InterruptType_ICTR_INTLINESNUM_Pos) /*!< InterruptType ICTR: INTLINESNUM Mask */
        ...
        #define InterruptType_ACTLR_DISFOLD_Msk \
                (1ul << InterruptType_ACTLR_DISFOLD_Pos) /*!< InterruptType ACTLR: DISFOLD Mask */
        ...
        #define InterruptType_ACTLR_DISDEFWBUF_Msk \
                (1ul << InterruptType_ACTLR_DISDEFWBUF_Pos) /*!< InterruptType ACTLR: DISDEFWBUF Mask */
        ...
        #define InterruptType_ACTLR_DISMCYCINT_Msk \
                (1ul << InterruptType_ACTLR_DISMCYCINT_Pos) /*!< InterruptType ACTLR: DISMCYCINT Mask */

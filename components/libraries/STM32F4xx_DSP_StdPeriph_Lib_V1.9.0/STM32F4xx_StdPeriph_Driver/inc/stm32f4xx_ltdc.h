...
/** @defgroup LTDC_SYNC 
  ...
  */
        ...
        #define IS_LTDC_GET_CD(CD) \
                (((CD) == LTDC_CD_VDES) || ((CD) == LTDC_CD_HDES) || ((CD) == LTDC_CD_VSYNC) || ((CD) == LTDC_CD_HSYNC))
        /**
  * @}
  */
  ...
  */
        ...
        #define IS_LTDC_FLAG(FLAG)                                                                  \
                (((FLAG) == LTDC_FLAG_LI) || ((FLAG) == LTDC_FLAG_FU) || ((FLAG) == LTDC_FLAG_TERR) \
                 || ((FLAG) == LTDC_FLAG_RR))
        /**
  * @}
  */
  ...
  */
        ...
        #define IS_LTDC_BlendingFactor1(BlendingFactor1) \
                (((BlendingFactor1) == LTDC_BlendingFactor1_CA) || ((BlendingFactor1) == LTDC_BlendingFactor1_PAxCA))
        /**
  * @}
  */
  ...
  */
        ...
        #define IS_LTDC_BlendingFactor2(BlendingFactor2) \
                (((BlendingFactor2) == LTDC_BlendingFactor2_CA) || ((BlendingFactor2) == LTDC_BlendingFactor2_PAxCA))
        /**
  * @}
  */

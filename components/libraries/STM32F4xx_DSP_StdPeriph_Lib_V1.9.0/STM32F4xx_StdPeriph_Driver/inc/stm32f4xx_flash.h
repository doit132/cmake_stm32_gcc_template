...
typedef enum {
  ...
  */
        ...
        #define IS_FLASH_LATENCY(LATENCY)                                                                              \
                (((LATENCY) == FLASH_Latency_0) || ((LATENCY) == FLASH_Latency_1) || ((LATENCY) == FLASH_Latency_2)    \
                 ...
                 || ((LATENCY) == FLASH_Latency_9) || ((LATENCY) == FLASH_Latency_10)                                  \
                 || ((LATENCY) == FLASH_Latency_11) || ((LATENCY) == FLASH_Latency_12)                                 \
                 || ((LATENCY) == FLASH_Latency_13) || ((LATENCY) == FLASH_Latency_14)                                 \
  ...
  */
        ...
        #define IS_VOLTAGERANGE(RANGE)                                                                     \
                (((RANGE) == VoltageRange_1) || ((RANGE) == VoltageRange_2) || ((RANGE) == VoltageRange_3) \
  ...
  */
        ...
        #define IS_FLASH_GET_FLAG(FLAG)                                                                             \
                (((FLAG) == FLASH_FLAG_EOP) || ((FLAG) == FLASH_FLAG_OPERR) || ((FLAG) == FLASH_FLAG_WRPERR)        \
                 || ((FLAG) == FLASH_FLAG_PGAERR) || ((FLAG) == FLASH_FLAG_PGPERR) || ((FLAG) == FLASH_FLAG_PGSERR) \

...
typedef enum {
	...
	#define OB_PcROP_Enable                                                                    \
		((uint8_t)0x80) /*!< Enable PcROP, nWPRi bits used for PCRoP Protection on sector  \
				   i   */
	#define IS_OB_PCROP_SELECT(PCROP)                                                          \
		(((PCROP) == OB_PcROP_Disable) || ((PCROP) == OB_PcROP_Enable))
	/**
	 * @}
	 */
	...
	#define OB_PCROP_Sector_0                                                                  \
		((uint32_t)0x00000001) /*!< PC Read/Write protection of Sector0      */
	#define OB_PCROP_Sector_1                                                                  \
		((uint32_t)0x00000002) /*!< PC Read/Write protection of Sector1      */
	#define OB_PCROP_Sector_2                                                                  \
		((uint32_t)0x00000004) /*!< PC Read/Write protection of Sector2      */
	#define OB_PCROP_Sector_3                                                                  \
		((uint32_t)0x00000008) /*!< PC Read/Write protection of Sector3      */
	#define OB_PCROP_Sector_4                                                                  \
		((uint32_t)0x00000010) /*!< PC Read/Write protection of Sector4      */
	#define OB_PCROP_Sector_5                                                                  \
		((uint32_t)0x00000020) /*!< PC Read/Write protection of Sector5      */
	#define OB_PCROP_Sector_6                                                                  \
		((uint32_t)0x00000040) /*!< PC Read/Write protection of Sector6      */
	#define OB_PCROP_Sector_7                                                                  \
		((uint32_t)0x00000080) /*!< PC Read/Write protection of Sector7      */
	#define OB_PCROP_Sector_8                                                                  \
		((uint32_t)0x00000100) /*!< PC Read/Write protection of Sector8      */
	#define OB_PCROP_Sector_9                                                                  \
		((uint32_t)0x00000200) /*!< PC Read/Write protection of Sector9      */
	#define OB_PCROP_Sector_10                                                                 \
		((uint32_t)0x00000400) /*!< PC Read/Write protection of Sector10     */
	#define OB_PCROP_Sector_11                                                                 \
		((uint32_t)0x00000800) /*!< PC Read/Write protection of Sector11     */
	#define OB_PCROP_Sector_12                                                                 \
		((uint32_t)0x00000001) /*!< PC Read/Write protection of Sector12     */
	#define OB_PCROP_Sector_13                                                                 \
		((uint32_t)0x00000002) /*!< PC Read/Write protection of Sector13     */
	#define OB_PCROP_Sector_14                                                                 \
		((uint32_t)0x00000004) /*!< PC Read/Write protection of Sector14     */
	#define OB_PCROP_Sector_15                                                                 \
		((uint32_t)0x00000008) /*!< PC Read/Write protection of Sector15     */
	#define OB_PCROP_Sector_16                                                                 \
		((uint32_t)0x00000010) /*!< PC Read/Write protection of Sector16     */
	#define OB_PCROP_Sector_17                                                                 \
		((uint32_t)0x00000020) /*!< PC Read/Write protection of Sector17     */
	#define OB_PCROP_Sector_18                                                                 \
		((uint32_t)0x00000040) /*!< PC Read/Write protection of Sector18     */
	#define OB_PCROP_Sector_19                                                                 \
		((uint32_t)0x00000080) /*!< PC Read/Write protection of Sector19     */
	#define OB_PCROP_Sector_20                                                                 \
		((uint32_t)0x00000100) /*!< PC Read/Write protection of Sector20     */
	#define OB_PCROP_Sector_21                                                                 \
		((uint32_t)0x00000200) /*!< PC Read/Write protection of Sector21     */
	#define OB_PCROP_Sector_22                                                                 \
		((uint32_t)0x00000400) /*!< PC Read/Write protection of Sector22     */
	#define OB_PCROP_Sector_23                                                                 \
		((uint32_t)0x00000800) /*!< PC Read/Write protection of Sector23     */
	#define OB_PCROP_Sector_All                                                                \
		((uint32_t)0x00000FFF) /*!< PC Read/Write protection of all Sectors  */
	...
	/*#define OB_RDP_Level_2   ((uint8_t)0xCC)*/ /*!< Warning: When enabling read protection
						  level 2 it's no more possible to go back to level
						  1 or 0 */
	...
	#define IS_OB_BOOT(BOOT)                                                                   \
		(((BOOT) == OB_Dual_BootEnabled) || ((BOOT) == OB_Dual_BootDisabled))
	/**
	 * @}
	 */
	...
	#define FLASH_FLAG_RDERR                                                                   \
		((uint32_t)0x00000100) /*!< Read Protection error flag (PCROP)        */

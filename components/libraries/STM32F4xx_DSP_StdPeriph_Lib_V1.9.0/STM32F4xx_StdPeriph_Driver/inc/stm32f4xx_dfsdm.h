...
typedef struct {
  ...
  */
                #define DFSDM_Interface_SPI_RisingEdge \
                        ((uint32_t)0x00000000) /*!<  DFSDM SPI interface with rising edge to strobe data */
                #define DFSDM_Interface_SPI_FallingEdge \
                        ((uint32_t)0x00000001) /*!<  DFSDM SPI interface with falling edge to strobe data */
                #define DFSDM_Interface_Manchester1 \
                        ((uint32_t)0x00000002) /*!<  DFSDM Manchester coded input, rising edge = logic 0, falling edge = logic 1 */
                #define DFSDM_Interface_Manchester2 \
                        ((uint32_t)0x00000003) /*!<  DFSDM Manchester coded input, rising edge = logic 1, falling edge = logic 0 */
  ...
  */
                #define DFSDM_Clock_External \
                        ((uint32_t)0x00000000) /*!<  DFSDM clock coming from external DFSDM_CKINy input */
                #define DFSDM_Clock_Internal \
                        ((uint32_t)0x00000004) /*!<  DFSDM clock coming from internal DFSDM_CKOUT output */
                #define DFSDM_Clock_InternalDiv2_Mode1 \
                        ((uint32_t)0x00000008) /*!<  DFSDM clock coming from internal DFSDM_CKOUT output divided by 2
                                                                       and clock change is on every rising edge of DFSDM_CKOUT output signal */
                #define DFSDM_Clock_InternalDiv2_Mode2 \
                        ((uint32_t)0x0000000C) /*!<  DFSDM clock coming from internal DFSDM_CKOUT output divided by 2
  ...
  */
                ...
                #define DFSDM_Input_ADC \
                        ((uint32_t)0x00001000) /*!<  DFSDM clock coming from internal DFSDM_CKOUT output */
                #define DFSDM_Input_Internal \
                        ((uint32_t)0x00002000) /*!<  DFSDM clock coming from internal DFSDM_CKOUT output divided by 2
                                                               and clock change is on every rising edge of DFSDM_CKOUT output signal */
  ...
  */
                #define DFSDM_Redirection_Disabled \
                        ((uint32_t)0x00000000) /*!< DFSDM Channel serial inputs are taken from pins of the same channel y */
                #define DFSDM_Redirection_Enabled \
                        DFSDM_CHCFGR1_CHINSEL /*!< DFSDM Channel serial inputs are taken from pins of the channel (y+1) modulo 8 */

                #define IS_DFSDM_Redirection_STATE(STATE) \
                        (((STATE) == DFSDM_Redirection_Disabled) || ((STATE) == DFSDM_Redirection_Enabled))
                /**
  * @}
  */
  ...
  */
                #define DFSDM_PackingMode_Standard \
                        ((uint32_t)0x00000000) /*!<  DFSDM Input data in DFSDM_CHDATINyR register are stored only in INDAT0[15:0] */
                #define DFSDM_PackingMode_Interleaved \
                        ((uint32_t)0x00004000) /*!<  DFSDM Input data in DFSDM_CHDATINyR register are stored as two samples:
                ...
                #define DFSDM_PackingMode_Dual \
                        ((uint32_t)0x00008000) /*!<  DFSDM Input data in DFSDM_CHDATINyR register are stored as two samples:
                ...
                #define IS_DFSDM_PACK_MODE(MODE)                                                             \
                        (((MODE) == DFSDM_PackingMode_Standard) || ((MODE) == DFSDM_PackingMode_Interleaved) \
  ...
  */
                ...
                #define IS_DFSDM_CLK_DETECTOR_STATE(STATE) \
                        (((STATE) == DFSDM_CLKAbsenceDetector_Enable) || ((STATE) == DFSDM_CLKAbsenceDetector_Disable))
                /**
  * @}
  */
  ...
  */
                ...
                #define IS_DFSDM_SINC_ORDER(ORDER)                                                   \
                        (((ORDER) == DFSDM_SincOrder_FastSinc) || ((ORDER) == DFSDM_SincOrder_Sinc1) \
                         || ((ORDER) == DFSDM_SincOrder_Sinc2) || ((ORDER) == DFSDM_SincOrder_Sinc3) \
  ...
  */
                #define DFSDM_SCDBreak_0 \
                        ((uint32_t)0x00001000) /*!<  DFSDM Break 0 signal assigned to short circuit detector */
                #define DFSDM_SCDBreak_1 \
                        ((uint32_t)0x00002000) /*!<  DFSDM Break 1 signal assigned to short circuit detector */
                #define DFSDM_SCDBreak_2 \
                        ((uint32_t)0x00004000) /*!<  DFSDM Break 2 signal assigned to short circuit detector */
                #define DFSDM_SCDBreak_3 \
                        ((uint32_t)0x00008000) /*!<  DFSDM Break 3 signal assigned to short circuit detector */

                #define IS_DFSDM_SCD_BREAK_SIGNAL(RANK)                                                               \
                        (((RANK) == DFSDM_SCDBreak_0) || ((RANK) == DFSDM_SCDBreak_1) || ((RANK) == DFSDM_SCDBreak_2) \
  ...
  */
                ...
                #define IS_DFSDM_AWD_SINC_ORDER(ORDER)                                                 \
                        (((ORDER) == DFSDM_AWDSincOrder_Fast) || ((ORDER) == DFSDM_AWDSincOrder_Sinc1) \
                         || ((ORDER) == DFSDM_AWDSincOrder_Sinc2) || ((ORDER) == DFSDM_AWDSincOrder_Sinc3))
                /**
  * @}
  */
  ...
  */
                ...
                #define IS_DFSDM_Threshold(THR) (((THR) == DFSDM_Threshold_Low) || ((THR) == DFSDM_Threshold_High))
                /**
  * @}
  */
  ...
  */
                ...
                #define IS_DFSDM_AWD_MODE(MODE) \
                        (((MODE) == DFSDM_AWDFastMode_Disable) || ((MODE) == DFSDM_AWDFastMode_Enable))
                /**
  * @}
  */
  ...
  */
                #define DFSDM_ClkOutSource_SysClock \
                        ((uint32_t)0x00000000) /*!<  DFSDM Source for output clock is comming from system clock */
                #define DFSDM_ClkOutSource_AudioClock \
                        DFSDM_CHCFGR1_CKOUTSRC /*!<  DFSDM Source for output clock is comming from audio clock */

                #define IS_DFSDM_CLOCK_OUT_SOURCE(SRC) \
                        (((SRC) == DFSDM_ClkOutSource_SysClock) || ((SRC) == DFSDM_ClkOutSource_AudioClock))
                /**
  * @}
  */
  ...
  */
                ...
                #define IS_DFSDM_CONVERSION_MODE(MODE) \
                        (((MODE) == DFSDM_DMAConversionMode_Regular) || ((MODE) == DFSDM_DMAConversionMode_Injected))
                /**
  * @}
  */
  ...
  */
                ...
                #define IS_DFSDM_EXTREM_CHANNEL(CHANNEL)                                               \
                        (((CHANNEL) == DFSDM_ExtremChannel0) || ((CHANNEL) == DFSDM_ExtremChannel1)    \
                         || ((CHANNEL) == DFSDM_ExtremChannel2) || ((CHANNEL) == DFSDM_ExtremChannel3) \
                         || ((CHANNEL) == DFSDM_ExtremChannel4) || ((CHANNEL) == DFSDM_ExtremChannel5) \
                         || ((CHANNEL) == DFSDM_ExtremChannel6) || ((CHANNEL) == DFSDM_ExtremChannel7))
                /**
  * @}
  */
  ...
  */
                #define DFSDM_InjectedChannel0 \
                        ((uint32_t)0x00000001) /*!<  DFSDM channel 0 is selected as injected channel */
                #define DFSDM_InjectedChannel1 \
                        ((uint32_t)0x00000002) /*!<  DFSDM channel 1 is selected as injected channel */
                #define DFSDM_InjectedChannel2 \
                        ((uint32_t)0x00000004) /*!<  DFSDM channel 2 is selected as injected channel */
                #define DFSDM_InjectedChannel3 \
                        ((uint32_t)0x00000008) /*!<  DFSDM channel 3 is selected as injected channel */
                #define DFSDM_InjectedChannel4 \
                        ((uint32_t)0x00000010) /*!<  DFSDM channel 4 is selected as injected channel */
                #define DFSDM_InjectedChannel5 \
                        ((uint32_t)0x00000020) /*!<  DFSDM channel 5 is selected as injected channel */
                #define DFSDM_InjectedChannel6 \
                        ((uint32_t)0x00000040) /*!<  DFSDM channel 6 is selected as injected channel */
                #define DFSDM_InjectedChannel7 \
                        ((uint32_t)0x00000080) /*!<  DFSDM channel 7 is selected as injected channel */

                #define IS_DFSDM_INJECT_CHANNEL(CHANNEL)                                                   \
                        (((CHANNEL) == DFSDM_InjectedChannel0) || ((CHANNEL) == DFSDM_InjectedChannel1)    \
                         || ((CHANNEL) == DFSDM_InjectedChannel2) || ((CHANNEL) == DFSDM_InjectedChannel3) \
                         || ((CHANNEL) == DFSDM_InjectedChannel4) || ((CHANNEL) == DFSDM_InjectedChannel5) \
                         || ((CHANNEL) == DFSDM_InjectedChannel6) || ((CHANNEL) == DFSDM_InjectedChannel7))
                /**
  * @}
  */
  ...
  */
                #define DFSDM_RegularChannel0 \
                        ((uint32_t)0x00000000) /*!<  DFSDM channel 0 is selected as regular channel */
                #define DFSDM_RegularChannel1 \
                        ((uint32_t)0x01000000) /*!<  DFSDM channel 1 is selected as regular channel */
                #define DFSDM_RegularChannel2 \
                        ((uint32_t)0x02000000) /*!<  DFSDM channel 2 is selected as regular channel */
                #define DFSDM_RegularChannel3 \
                        ((uint32_t)0x03000000) /*!<  DFSDM channel 3 is selected as regular channel */
                #define DFSDM_RegularChannel4 \
                        ((uint32_t)0x04000000) /*!<  DFSDM channel 4 is selected as regular channel */
                #define DFSDM_RegularChannel5 \
                        ((uint32_t)0x05000000) /*!<  DFSDM channel 5 is selected as regular channel */
                #define DFSDM_RegularChannel6 \
                        ((uint32_t)0x06000000) /*!<  DFSDM channel 6 is selected as regular channel */
                #define DFSDM_RegularChannel7 \
                        ((uint32_t)0x07000000) /*!<  DFSDM channel 7 is selected as regular channel */

                #define IS_DFSDM_REGULAR_CHANNEL(CHANNEL)                                                \
                        (((CHANNEL) == DFSDM_RegularChannel0) || ((CHANNEL) == DFSDM_RegularChannel1)    \
                         || ((CHANNEL) == DFSDM_RegularChannel2) || ((CHANNEL) == DFSDM_RegularChannel3) \
                         || ((CHANNEL) == DFSDM_RegularChannel4) || ((CHANNEL) == DFSDM_RegularChannel5) \
                         || ((CHANNEL) == DFSDM_RegularChannel6) || ((CHANNEL) == DFSDM_RegularChannel7))
                /**
  * @}
  */
  ...
  */
                ...
                #define IS_DFSDM0_INJ_TRIGGER(TRIG)                                                     \
                        (((TRIG) == DFSDM_Trigger_TIM1_TRGO) || ((TRIG) == DFSDM_Trigger_TIM1_TRGO2)    \
                         || ((TRIG) == DFSDM_Trigger_TIM8_TRGO) || ((TRIG) == DFSDM_Trigger_TIM8_TRGO2) \
                         || ((TRIG) == DFSDM_Trigger_TIM4_TRGO) || ((TRIG) == DFSDM_Trigger_TIM6_TRGO)  \
                         || ((TRIG) == DFSDM_Trigger_TIM7_TRGO) || ((TRIG) == DFSDM_Trigger_EXTI15)     \
                         || ((TRIG) == DFSDM_Trigger_TIM3_TRGO) || ((TRIG) == DFSDM_Trigger_TIM16_OC1)  \
  ...
  */
                ...
                #define DFSDM_TriggerEdge_Rising \
                        ((uint32_t)0x00002000) /*!<  DFSDM Each rising edge makes a request to launch an injected conversion */
                #define DFSDM_TriggerEdge_Falling \
                        ((uint32_t)0x00004000) /*!<  DFSDM Each falling edge makes a request to launch an injected conversion */
                #define DFSDM_TriggerEdge_BothEdges \
                        ((uint32_t)0x00006000) /*!<  DFSDM Both edges make a request to launch an injected conversion */

                #define IS_DFSDM_TRIGGER_EDGE(EDGE)                                                     \
                        (((EDGE) == DFSDM_TriggerEdge_Disabled) || ((EDGE) == DFSDM_TriggerEdge_Rising) \
                         || ((EDGE) == DFSDM_TriggerEdge_Falling) || ((EDGE) == DFSDM_TriggerEdge_BothEdges))
                /**
  * @}
  */
  ...
  */
                ...
                #define DFSDM_InjectConvMode_Scan \
                        ((uint32_t)0x00000010) /*!<  DFSDM Each rising edge makes a request to launch an injected conversion */

                #define IS_DFSDM_INJ_CONV_MODE(MODE) \
                        (((MODE) == DFSDM_InjectConvMode_Single) || ((MODE) == DFSDM_InjectConvMode_Scan))
                /**
  * @}
  */
  ...
  */
                ...
                #define IS_DFSDM_IT(IT)                                                                 \
                        (((IT) == DFSDM_IT_JEOC) || ((IT) == DFSDM_IT_REOC) || ((IT) == DFSDM_IT_JOVR)  \
                         || ((IT) == DFSDM_IT_ROVR) || ((IT) == DFSDM_IT_AWD) || ((IT) == DFSDM_IT_SCD) \
                         || ((IT) == DFSDM_IT_CKAB))
                /**
  * @}
  */
  ...
  */
                ...
                #define IS_DFSDM_FLAG(FLAG)                                                                          \
                        (((FLAG) == DFSDM_FLAG_JEOC) || ((FLAG) == DFSDM_FLAG_REOC) || ((FLAG) == DFSDM_FLAG_JOVR)   \
                         || ((FLAG) == DFSDM_FLAG_ROVR) || ((FLAG) == DFSDM_FLAG_AWD) || ((FLAG) == DFSDM_FLAG_JCIP) \
  ...
  */
                ...
                #define IS_DFSDM_CLK_ABS_FLAG(FLAG)                                                                  \
                        (((FLAG) == DFSDM_FLAG_CLKAbsence_Channel0) || ((FLAG) == DFSDM_FLAG_CLKAbsence_Channel1)    \
                         || ((FLAG) == DFSDM_FLAG_CLKAbsence_Channel2) || ((FLAG) == DFSDM_FLAG_CLKAbsence_Channel3) \
                         || ((FLAG) == DFSDM_FLAG_CLKAbsence_Channel4) || ((FLAG) == DFSDM_FLAG_CLKAbsence_Channel5) \
                         || ((FLAG) == DFSDM_FLAG_CLKAbsence_Channel6) || ((FLAG) == DFSDM_FLAG_CLKAbsence_Channel7))
                /**
  * @}
  */
  ...
  */
                ...
                #define IS_DFSDM_SCD_FLAG(FLAG)                                                        \
                        (((FLAG) == DFSDM_FLAG_SCD_Channel0) || ((FLAG) == DFSDM_FLAG_SCD_Channel1)    \
                         || ((FLAG) == DFSDM_FLAG_SCD_Channel2) || ((FLAG) == DFSDM_FLAG_SCD_Channel3) \
                         || ((FLAG) == DFSDM_FLAG_SCD_Channel4) || ((FLAG) == DFSDM_FLAG_SCD_Channel5) \
                         || ((FLAG) == DFSDM_FLAG_SCD_Channel6) || ((FLAG) == DFSDM_FLAG_SCD_Channel7))
                /**
  * @}
  */
  ...
  */
                ...
                #define IS_DFSDM_CLEAR_FLAG(FLAG) (((FLAG) == DFSDM_CLEARF_JOVR) || ((FLAG) == DFSDM_CLEARF_ROVR))
                /**
  * @}
  */
  ...
  */
                ...
                #define IS_DFSDM_CLK_ABS_CLEARF(FLAG)                                                                 \
                        (((FLAG) == DFSDM_CLEARF_CLKAbsence_Channel0) || ((FLAG) == DFSDM_CLEARF_CLKAbsence_Channel1) \
  ...
  */
                ...
                #define IS_DFSDM_SCD_CHANNEL_FLAG(FLAG)                                                    \
                        (((FLAG) == DFSDM_CLEARF_SCD_Channel0) || ((FLAG) == DFSDM_CLEARF_SCD_Channel1)    \
                         || ((FLAG) == DFSDM_CLEARF_SCD_Channel2) || ((FLAG) == DFSDM_CLEARF_SCD_Channel3) \
                         || ((FLAG) == DFSDM_CLEARF_SCD_Channel4) || ((FLAG) == DFSDM_CLEARF_SCD_Channel5) \
                         || ((FLAG) == DFSDM_CLEARF_SCD_Channel6) || ((FLAG) == DFSDM_CLEARF_SCD_Channel7))
                /**
  * @}
  */
  ...
  */
                ...
                #define IS_DFSDM_CLK_ABS_IT(IT)                                                              \
                        (((IT) == DFSDM_IT_CLKAbsence_Channel0) || ((IT) == DFSDM_IT_CLKAbsence_Channel1)    \
                         || ((IT) == DFSDM_IT_CLKAbsence_Channel2) || ((IT) == DFSDM_IT_CLKAbsence_Channel3) \
                         || ((IT) == DFSDM_IT_CLKAbsence_Channel4) || ((IT) == DFSDM_IT_CLKAbsence_Channel5) \
                         || ((IT) == DFSDM_IT_CLKAbsence_Channel6) || ((IT) == DFSDM_IT_CLKAbsence_Channel7))
                /**
  * @}
  */
  ...
  */
                ...
                #define IS_DFSDM_OFFSET(OFFSET) ((OFFSET) < 0x01000000)
                        ...
                        #define IS_DFSDM_ALL_CHANNEL(CHANNEL)                                        \
                                (((CHANNEL) == DFSDM1_Channel0) || ((CHANNEL) == DFSDM1_Channel1)    \
                                 || ((CHANNEL) == DFSDM1_Channel2) || ((CHANNEL) == DFSDM1_Channel3) \
                                 || ((CHANNEL) == DFSDM2_Channel0) || ((CHANNEL) == DFSDM2_Channel1) \
                                 || ((CHANNEL) == DFSDM2_Channel2) || ((CHANNEL) == DFSDM2_Channel3) \
                                 || ((CHANNEL) == DFSDM2_Channel4) || ((CHANNEL) == DFSDM2_Channel5) \
                                 || ((CHANNEL) == DFSDM2_Channel6) || ((CHANNEL) == DFSDM2_Channel7))

                        #define IS_DFSDM_ALL_FILTER(FILTER)                                                 \
                                (((FILTER) == DFSDM1_0) || ((FILTER) == DFSDM1_1) || ((FILTER) == DFSDM2_0) \
                                 || ((FILTER) == DFSDM2_1) || ((FILTER) == DFSDM2_2) || ((FILTER) == DFSDM2_3))
                        ...
                        #define IS_DFSDM_ALL_FILTER(FILTER) (((FILTER) == DFSDM1_0) || ((FILTER) == DFSDM1_1))

                        #define IS_DFSDM_SYNC_FILTER(FILTER) (((FILTER) == DFSDM1_0) || ((FILTER) == DFSDM1_1))
...
void DFSDM_ConfigBRKShortCircuitDetector(DFSDM_Channel_TypeDef* DFSDM_Channelx,
                                         uint32_t               DFSDM_SCDBreak_i,
                                         FunctionalState        NewState);
void DFSDM_ConfigBRKAnalogWatchDog(DFSDM_Channel_TypeDef* DFSDM_Channelx,
                                   uint32_t               DFSDM_SCDBreak_i,
                                   FunctionalState        NewState);
...
void DFSDM_ConfigAWDFilter(DFSDM_Channel_TypeDef* DFSDM_Channelx,
                           uint32_t               DFSDM_AWDSincOrder,
...
FlagStatus DFSDM_GetShortCircuitFlagStatus(uint32_t Instance, uint32_t DFSDM_FLAG_SCD);
                #endif /* STM32F412xG */
FlagStatus
        DFSDM_GetWatchdogFlagStatus(DFSDM_Filter_TypeDef* DFSDMx, uint32_t DFSDM_AWDChannelx, uint8_t DFSDM_Threshold);

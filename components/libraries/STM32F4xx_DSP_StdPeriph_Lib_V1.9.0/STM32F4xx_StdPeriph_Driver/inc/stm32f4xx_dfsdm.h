...
typedef struct {
	uint32_t DFSDM_Interface; /*!< Selects the serial interface type and input clock phase.
				     ...
				     DFSDM_Interface_Selection */

	uint32_t DFSDM_Clock; /*!< Specifies the clock source for the serial interface transceiver.
					    This parameter can be a value of @ref
				 DFSDM_Clock_Selection */

	uint32_t DFSDM_Input; /*!< Specifies the Input mode for the serial interface transceiver.
					    This parameter can be a value of @ref
				 DFSDM_Input_Selection */

	uint32_t DFSDM_Redirection; /*!< Specifies if the channel input is redirected from channel
				       channel (y+1). This parameter can be a value of @ref
				       DFSDM_Redirection_Selection */

	uint32_t DFSDM_PackingMode; /*!< Specifies the packing mode for the serial interface
				       transceiver. This parameter can be a value of @ref
...
typedef struct {
	...
	uint32_t DFSDM_IntegratorOversamplingRatio; /*!< Sets the Integrator Oversampling Ratio.
		 ...
		 * @{
		 */
		#define DFSDM_Interface_SPI_RisingEdge                                             \
			((uint32_t)0x00000000) /*!<  DFSDM SPI interface with rising edge to       \
						  strobe data */
		#define DFSDM_Interface_SPI_FallingEdge                                            \
			((uint32_t)0x00000001) /*!<  DFSDM SPI interface with falling edge to      \
						  strobe data */
		#define DFSDM_Interface_Manchester1                                                \
			((uint32_t)0x00000002) /*!<  DFSDM Manchester coded input, rising edge =   \
						  logic 0, falling edge = logic 1 */
		#define DFSDM_Interface_Manchester2                                                \
			((uint32_t)0x00000003) /*!<  DFSDM Manchester coded input, rising edge =   \
						  logic 1, falling edge = logic 0 */

		#define IS_DFSDM_INTERFACE(INTERFACE)                                              \
			(((INTERFACE) == DFSDM_Interface_SPI_RisingEdge) ||                        \
		 ...
		 * @{
		 */
		#define DFSDM_Clock_External                                                       \
			((uint32_t)0x00000000) /*!<  DFSDM clock coming from external DFSDM_CKINy  \
						  input */
		#define DFSDM_Clock_Internal                                                       \
			((uint32_t)0x00000004) /*!<  DFSDM clock coming from internal DFSDM_CKOUT  \
						  output */
		...
		#define IS_DFSDM_CLOCK(CLOCK)                                                      \
			(((CLOCK) == DFSDM_Clock_External) || ((CLOCK) == DFSDM_Clock_Internal) || \
		 ...
		 * @{
		 */
		#define DFSDM_Input_External                                                       \
			((uint32_t)0x00000000) /*!<  DFSDM clock coming from external DFSDM_CKINy  \
						  input */
		#define DFSDM_Input_ADC                                                            \
			((uint32_t)0x00001000) /*!<  DFSDM clock coming from internal DFSDM_CKOUT  \
						  output */
		...
		#define IS_DFSDM_Input_MODE(INPUT)                                                 \
			(((INPUT) == DFSDM_Input_External) || ((INPUT) == DFSDM_Input_ADC) ||      \
		 ...
		 * @{
		 */
		#define DFSDM_Redirection_Disabled                                                 \
			((uint32_t)0x00000000) /*!< DFSDM Channel serial inputs are taken from     \
						  pins of the same channel y */
		#define DFSDM_Redirection_Enabled                                                  \
			DFSDM_CHCFGR1_CHINSEL /*!< DFSDM Channel serial inputs are taken from pins \
						 of the channel (y+1) modulo 8 */

		#define IS_DFSDM_Redirection_STATE(STATE)                                          \
			(((STATE) == DFSDM_Redirection_Disabled) ||                                \
		 ...
		 * @{
		 */
		#define DFSDM_PackingMode_Standard                                                 \
			((uint32_t)0x00000000) /*!<  DFSDM Input data in DFSDM_CHDATINyR register  \
						  are stored only in INDAT0[15:0] */
		#define DFSDM_PackingMode_Interleaved                                              \
			((uint32_t)0x00004000) /*!<  DFSDM Input data in DFSDM_CHDATINyR register  \
						  are stored as two samples:                       \
									- first sample in          \
						  INDAT0[15:0] - assigned to channel y             \
									- second sample            \
						  INDAT1[15:0]   - assigned to channel y */
		#define DFSDM_PackingMode_Dual                                                     \
			((uint32_t)0x00008000) /*!<  DFSDM Input data in DFSDM_CHDATINyR register  \
						  are stored as two samples:                       \
									- first sample             \
						  INDAT0[15:0]    - assigned to channel y          \
									- second sample            \
						  INDAT1[15:0]   - assigned to channel (y+1) */

		#define IS_DFSDM_PACK_MODE(MODE)                                                   \
			(((MODE) == DFSDM_PackingMode_Standard) ||                                 \
		 ...
		 * @{
		 */
		#define DFSDM_CLKAbsenceDetector_Enable                                            \
			DFSDM_CHCFGR1_CKABEN /*!<  DFSDM Clock Absence Detector is Enabled */
		#define DFSDM_CLKAbsenceDetector_Disable                                           \
			((uint32_t)0x00000000) /*!<  DFSDM Clock Absence Detector is Disabled */

		#define IS_DFSDM_CLK_DETECTOR_STATE(STATE)                                         \
			(((STATE) == DFSDM_CLKAbsenceDetector_Enable) ||                           \
		 ...
		 * @{
		 */
		#define DFSDM_ShortCircuitDetector_Enable                                          \
			DFSDM_CHCFGR1_SCDEN /*!<  DFSDM Short Circuit Detector is Enabled */
		#define DFSDM_ShortCircuitDetector_Disable                                         \
			((uint32_t)0x00000000) /*!<  DFSDM Short Circuit Detector is Disabled */

		#define IS_DFSDM_SC_DETECTOR_STATE(STATE)                                          \
			(((STATE) == DFSDM_ShortCircuitDetector_Enable) ||                         \
		 ...
		 * @{
		 */
		#define DFSDM_SincOrder_FastSinc                                                   \
			((uint32_t)0x00000000) /*!<  DFSDM Sinc filter order = Fast sinc */
		#define DFSDM_SincOrder_Sinc1                                                      \
			((uint32_t)0x20000000) /*!<  DFSDM Sinc filter order = 1 */
		#define DFSDM_SincOrder_Sinc2                                                      \
			((uint32_t)0x40000000) /*!<  DFSDM Sinc filter order = 2 */
		#define DFSDM_SincOrder_Sinc3                                                      \
			((uint32_t)0x60000000) /*!<  DFSDM Sinc filter order = 3 */
		#define DFSDM_SincOrder_Sinc4                                                      \
			((uint32_t)0x80000000) /*!<  DFSDM Sinc filter order = 4 */
		#define DFSDM_SincOrder_Sinc5                                                      \
			((uint32_t)0xA0000000) /*!<  DFSDM Sinc filter order = 5 */

		#define IS_DFSDM_SINC_ORDER(ORDER)                                                 \
			(((ORDER) == DFSDM_SincOrder_FastSinc) ||                                  \
			 ((ORDER) == DFSDM_SincOrder_Sinc1) ||                                     \
			 ((ORDER) == DFSDM_SincOrder_Sinc2) ||                                     \
			 ((ORDER) == DFSDM_SincOrder_Sinc3) ||                                     \
			 ((ORDER) == DFSDM_SincOrder_Sinc4) || ((ORDER) == DFSDM_SincOrder_Sinc5))
		/**
		 * @}
		 */
		 ...
		 * @{
		 */
		#define DFSDM_SCDBreak_0                                                           \
			((uint32_t)0x00001000) /*!<  DFSDM Break 0 signal assigned to short        \
						  circuit detector */
		#define DFSDM_SCDBreak_1                                                           \
			((uint32_t)0x00002000) /*!<  DFSDM Break 1 signal assigned to short        \
						  circuit detector */
		#define DFSDM_SCDBreak_2                                                           \
			((uint32_t)0x00004000) /*!<  DFSDM Break 2 signal assigned to short        \
						  circuit detector */
		#define DFSDM_SCDBreak_3                                                           \
			((uint32_t)0x00008000) /*!<  DFSDM Break 3 signal assigned to short        \
						  circuit detector */

		#define IS_DFSDM_SCD_BREAK_SIGNAL(RANK)                                            \
			(((RANK) == DFSDM_SCDBreak_0) || ((RANK) == DFSDM_SCDBreak_1) ||           \
			 ((RANK) == DFSDM_SCDBreak_2) || ((RANK) == DFSDM_SCDBreak_3))
		/**
		 * @}
		 */
		...
		#define IS_DFSDM_AWD_CHANNEL(CHANNEL)                                              \
			(((CHANNEL) == DFSDM_AWDChannel0) || ((CHANNEL) == DFSDM_AWDChannel1) ||   \
			 ((CHANNEL) == DFSDM_AWDChannel2) || ((CHANNEL) == DFSDM_AWDChannel3) ||   \
			 ((CHANNEL) == DFSDM_AWDChannel4) || ((CHANNEL) == DFSDM_AWDChannel5) ||   \
			 ((CHANNEL) == DFSDM_AWDChannel6) || ((CHANNEL) == DFSDM_AWDChannel7))
		/**
		 * @}
		 */
		...
		#define IS_DFSDM_Threshold(THR)                                                    \
			(((THR) == DFSDM_Threshold_Low) || ((THR) == DFSDM_Threshold_High))
		/**
		 * @}
		 */
		 ...
		 * @{
		 */
		#define DFSDM_AWDFastMode_Disable                                                  \
			((uint32_t)0x00000000) /*!<  DFSDM Fast mode for AWD is disabled */
		#define DFSDM_AWDFastMode_Enable                                                   \
			((uint32_t)0x40000000) /*!<  DFSDM Fast mode for AWD is enabled */

		#define IS_DFSDM_AWD_MODE(MODE)                                                    \
			(((MODE) == DFSDM_AWDFastMode_Disable) ||                                  \
		 ...
		 * @{
		 */
		#define DFSDM_ClkOutSource_SysClock                                                \
			((uint32_t)0x00000000) /*!<  DFSDM Source for output clock is comming from \
						  system clock */
		#define DFSDM_ClkOutSource_AudioClock                                              \
			DFSDM_CHCFGR1_CKOUTSRC /*!<  DFSDM Source for output clock is comming from \
						  audio clock */

		#define IS_DFSDM_CLOCK_OUT_SOURCE(SRC)                                             \
			(((SRC) == DFSDM_ClkOutSource_SysClock) ||                                 \
		 ...
		 * @{
		 */
		#define DFSDM_DMAConversionMode_Regular                                            \
			((uint32_t)0x00000010) /*!<  DFSDM Regular mode */
		#define DFSDM_DMAConversionMode_Injected                                           \
			((uint32_t)0x00000000) /*!<  DFSDM Injected mode */

		#define IS_DFSDM_CONVERSION_MODE(MODE)                                             \
			(((MODE) == DFSDM_DMAConversionMode_Regular) ||                            \
		 ...
		 * @{
		 */
		#define DFSDM_ExtremChannel0                                                       \
			((uint32_t)0x00000100) /*!<  DFSDM Extreme detector guard channel 0 */
		#define DFSDM_ExtremChannel1                                                       \
			((uint32_t)0x00000200) /*!<  DFSDM Extreme detector guard channel 1 */
		#define DFSDM_ExtremChannel2                                                       \
			((uint32_t)0x00000400) /*!<  DFSDM Extreme detector guard channel 2 */
		#define DFSDM_ExtremChannel3                                                       \
			((uint32_t)0x00000800) /*!<  DFSDM Extreme detector guard channel 3 */
		#define DFSDM_ExtremChannel4                                                       \
			((uint32_t)0x00001000) /*!<  DFSDM Extreme detector guard channel 4 */
		#define DFSDM_ExtremChannel5                                                       \
			((uint32_t)0x00002000) /*!<  DFSDM Extreme detector guard channel 5 */
		#define DFSDM_ExtremChannel6                                                       \
			((uint32_t)0x00004000) /*!<  DFSDM Extreme detector guard channel 6 */
		#define DFSDM_ExtremChannel7                                                       \
			((uint32_t)0x00008000) /*!<  DFSDM Extreme detector guard channel 7 */

		#define IS_DFSDM_EXTREM_CHANNEL(CHANNEL)                                           \
			(((CHANNEL) == DFSDM_ExtremChannel0) ||                                    \
		 ...
		 * @{
		 */
		#define DFSDM_InjectedChannel0                                                     \
			((uint32_t)0x00000001) /*!<  DFSDM channel 0 is selected as injected       \
						  channel */
		#define DFSDM_InjectedChannel1                                                     \
			((uint32_t)0x00000002) /*!<  DFSDM channel 1 is selected as injected       \
						  channel */
		#define DFSDM_InjectedChannel2                                                     \
			((uint32_t)0x00000004) /*!<  DFSDM channel 2 is selected as injected       \
						  channel */
		#define DFSDM_InjectedChannel3                                                     \
			((uint32_t)0x00000008) /*!<  DFSDM channel 3 is selected as injected       \
						  channel */
		#define DFSDM_InjectedChannel4                                                     \
			((uint32_t)0x00000010) /*!<  DFSDM channel 4 is selected as injected       \
						  channel */
		#define DFSDM_InjectedChannel5                                                     \
			((uint32_t)0x00000020) /*!<  DFSDM channel 5 is selected as injected       \
						  channel */
		#define DFSDM_InjectedChannel6                                                     \
			((uint32_t)0x00000040) /*!<  DFSDM channel 6 is selected as injected       \
						  channel */
		#define DFSDM_InjectedChannel7                                                     \
			((uint32_t)0x00000080) /*!<  DFSDM channel 7 is selected as injected       \
						  channel */

		#define IS_DFSDM_INJECT_CHANNEL(CHANNEL)                                           \
			(((CHANNEL) == DFSDM_InjectedChannel0) ||                                  \
		 ...
		 * @{
		 */
		#define DFSDM_RegularChannel0                                                      \
			((uint32_t)0x00000000) /*!<  DFSDM channel 0 is selected as regular        \
						  channel */
		#define DFSDM_RegularChannel1                                                      \
			((uint32_t)0x01000000) /*!<  DFSDM channel 1 is selected as regular        \
						  channel */
		#define DFSDM_RegularChannel2                                                      \
			((uint32_t)0x02000000) /*!<  DFSDM channel 2 is selected as regular        \
						  channel */
		#define DFSDM_RegularChannel3                                                      \
			((uint32_t)0x03000000) /*!<  DFSDM channel 3 is selected as regular        \
						  channel */
		#define DFSDM_RegularChannel4                                                      \
			((uint32_t)0x04000000) /*!<  DFSDM channel 4 is selected as regular        \
						  channel */
		#define DFSDM_RegularChannel5                                                      \
			((uint32_t)0x05000000) /*!<  DFSDM channel 5 is selected as regular        \
						  channel */
		#define DFSDM_RegularChannel6                                                      \
			((uint32_t)0x06000000) /*!<  DFSDM channel 6 is selected as regular        \
						  channel */
		#define DFSDM_RegularChannel7                                                      \
			((uint32_t)0x07000000) /*!<  DFSDM channel 7 is selected as regular        \
						  channel */

		#define IS_DFSDM_REGULAR_CHANNEL(CHANNEL)                                          \
			(((CHANNEL) == DFSDM_RegularChannel0) ||                                   \
		 ...
		 * @{
		 */
		#define DFSDM_Trigger_TIM1_TRGO                                                    \
			((uint32_t)0x00000000) /*!<  DFSDM Internal trigger 0 */
		#define DFSDM_Trigger_TIM1_TRGO2                                                   \
			((uint32_t)0x00000100) /*!<  DFSDM Internal trigger 1 */
		#define DFSDM_Trigger_TIM8_TRGO                                                    \
			((uint32_t)0x00000200) /*!<  DFSDM Internal trigger 2 */
		#define DFSDM_Trigger_TIM8_TRGO2                                                   \
			((uint32_t)0x00000300) /*!<  DFSDM Internal trigger 3 */
		#define DFSDM_Trigger_TIM3_TRGO                                                    \
			((uint32_t)0x00000300) /*!<  DFSDM Internal trigger 4 */
		#define DFSDM_Trigger_TIM4_TRGO                                                    \
			((uint32_t)0x00000400) /*!<  DFSDM Internal trigger 5 */
		#define DFSDM_Trigger_TIM16_OC1                                                    \
			((uint32_t)0x00000400) /*!<  DFSDM Internal trigger 6 */
		#define DFSDM_Trigger_TIM6_TRGO                                                    \
			((uint32_t)0x00000500) /*!<  DFSDM Internal trigger 7 */
		#define DFSDM_Trigger_TIM7_TRGO                                                    \
			((uint32_t)0x00000500) /*!<  DFSDM Internal trigger 8 */
		#define DFSDM_Trigger_EXTI11                                                       \
			((uint32_t)0x00000600) /*!<  DFSDM External trigger 0 */
		#define DFSDM_Trigger_EXTI15                                                       \
			((uint32_t)0x00000700) /*!<  DFSDM External trigger 1 */

		#define IS_DFSDM0_INJ_TRIGGER(TRIG)                                                \
			(((TRIG) == DFSDM_Trigger_TIM1_TRGO) ||                                    \
			 ...
			 ((TRIG) == DFSDM_Trigger_TIM16_OC1) || ((TRIG) == DFSDM_Trigger_EXTI11))
		 ...
		 * @{
		 */
		#define DFSDM_TriggerEdge_Disabled                                                 \
			((uint32_t)0x00000000) /*!<  DFSDM Trigger detection disabled */
		#define DFSDM_TriggerEdge_Rising                                                   \
			((uint32_t)0x00002000) /*!<  DFSDM Each rising edge makes a request to     \
						  launch an injected conversion */
		#define DFSDM_TriggerEdge_Falling                                                  \
			((uint32_t)0x00004000) /*!<  DFSDM Each falling edge makes a request to    \
						  launch an injected conversion */
		#define DFSDM_TriggerEdge_BothEdges                                                \
			((uint32_t)0x00006000) /*!<  DFSDM Both edges make a request to launch an  \
						  injected conversion */

		#define IS_DFSDM_TRIGGER_EDGE(EDGE)                                                \
			(((EDGE) == DFSDM_TriggerEdge_Disabled) ||                                 \
		 ...
		 * @{
		 */
		#define DFSDM_InjectConvMode_Single                                                \
			((uint32_t)0x00000000) /*!<  DFSDM Trigger detection disabled */
		#define DFSDM_InjectConvMode_Scan                                                  \
			((uint32_t)0x00000010) /*!<  DFSDM Each rising edge makes a request to     \
						  launch an injected conversion */

		#define IS_DFSDM_INJ_CONV_MODE(MODE)                                               \
			(((MODE) == DFSDM_InjectConvMode_Single) ||                                \
		...
		#define IS_DFSDM_IT(IT)                                                            \
			(((IT) == DFSDM_IT_JEOC) || ((IT) == DFSDM_IT_REOC) ||                     \
			 ((IT) == DFSDM_IT_JOVR) || ((IT) == DFSDM_IT_ROVR) ||                     \
			 ((IT) == DFSDM_IT_AWD) || ((IT) == DFSDM_IT_SCD) ||                       \
			 ((IT) == DFSDM_IT_CKAB))
		/**
		 * @}
		 */
		...
		#define IS_DFSDM_FLAG(FLAG)                                                        \
			(((FLAG) == DFSDM_FLAG_JEOC) || ((FLAG) == DFSDM_FLAG_REOC) ||             \
			 ((FLAG) == DFSDM_FLAG_JOVR) || ((FLAG) == DFSDM_FLAG_ROVR) ||             \
			 ((FLAG) == DFSDM_FLAG_AWD) || ((FLAG) == DFSDM_FLAG_JCIP) ||              \
		...
		#define IS_DFSDM_CLK_ABS_FLAG(FLAG)                                                \
			(((FLAG) == DFSDM_FLAG_CLKAbsence_Channel0) ||                             \
		...
		#define IS_DFSDM_SCD_FLAG(FLAG)                                                    \
			(((FLAG) == DFSDM_FLAG_SCD_Channel0) ||                                    \
		...
		#define IS_DFSDM_CLEAR_FLAG(FLAG)                                                  \
			(((FLAG) == DFSDM_CLEARF_JOVR) || ((FLAG) == DFSDM_CLEARF_ROVR))
		/**
		 * @}
		 */
		...
		#define IS_DFSDM_CLK_ABS_CLEARF(FLAG)                                              \
			(((FLAG) == DFSDM_CLEARF_CLKAbsence_Channel0) ||                           \
		...
		#define IS_DFSDM_SCD_CHANNEL_FLAG(FLAG)                                            \
			(((FLAG) == DFSDM_CLEARF_SCD_Channel0) ||                                  \
		...
		#define IS_DFSDM_CLK_ABS_IT(IT)                                                    \
			(((IT) == DFSDM_IT_CLKAbsence_Channel0) ||                                 \
		...
		#define IS_DFSDM_SCD_IT(IT)                                                        \
			(((IT) == DFSDM_IT_SCD_Channel0) || ((IT) == DFSDM_IT_SCD_Channel1) ||     \
			 ((IT) == DFSDM_IT_SCD_Channel2) || ((IT) == DFSDM_IT_SCD_Channel3) ||     \
			 ((IT) == DFSDM_IT_SCD_Channel4) || ((IT) == DFSDM_IT_SCD_Channel5) ||     \
			 ((IT) == DFSDM_IT_SCD_Channel6) || ((IT) == DFSDM_IT_SCD_Channel7))
	/**
	 * @}
	 */
		...
		#define IS_DFSDM_OFFSET(OFFSET)		     ((OFFSET) < 0x01000000)
			...
			#define IS_DFSDM_ALL_CHANNEL(CHANNEL)                                      \
				(((CHANNEL) == DFSDM1_Channel0) ||                                 \
				 ...
				 ((CHANNEL) == DFSDM2_Channel6) || ((CHANNEL) == DFSDM2_Channel7))

			#define IS_DFSDM_ALL_FILTER(FILTER)                                        \
				(((FILTER) == DFSDM1_0) || ((FILTER) == DFSDM1_1) ||               \
				 ((FILTER) == DFSDM2_0) || ((FILTER) == DFSDM2_1) ||               \
				 ((FILTER) == DFSDM2_2) || ((FILTER) == DFSDM2_3))

			#define IS_DFSDM_SYNC_FILTER(FILTER)                                       \
				(((FILTER) == DFSDM1_0) || ((FILTER) == DFSDM1_1) ||               \
				 ((FILTER) == DFSDM2_0) || ((FILTER) == DFSDM2_1) ||               \
				 ((FILTER) == DFSDM2_2) || ((FILTER) == DFSDM2_3))
		#else
			#define IS_DFSDM_ALL_CHANNEL(CHANNEL)                                      \
				(((CHANNEL) == DFSDM1_Channel0) ||                                 \
				 ((CHANNEL) == DFSDM1_Channel1) ||                                 \
				 ((CHANNEL) == DFSDM1_Channel2) || ((CHANNEL) == DFSDM1_Channel3))
...
void DFSDM_TransceiverInit(DFSDM_Channel_TypeDef *DFSDM_Channelx,
...
void DFSDM_FilterInit(DFSDM_Filter_TypeDef *DFSDMx,
...
void DFSDM_ConfigClkOutputSource(uint32_t Instance, uint32_t DFSDM_ClkOutSource);
		#endif /* STM32F412xG */
void DFSDM_SelectInjectedConversionMode(DFSDM_Filter_TypeDef *DFSDMx,
					uint32_t DFSDM_InjectConvMode);
...
void DFSDM_ConfigInjectedTrigger(DFSDM_Filter_TypeDef *DFSDMx, uint32_t DFSDM_Trigger,
				 uint32_t DFSDM_TriggerEdge);
void DFSDM_ConfigBRKShortCircuitDetector(DFSDM_Channel_TypeDef *DFSDM_Channelx,
					 uint32_t DFSDM_SCDBreak_i, FunctionalState NewState);
void DFSDM_ConfigBRKAnalogWatchDog(DFSDM_Channel_TypeDef *DFSDM_Channelx, uint32_t DFSDM_SCDBreak_i,
				   FunctionalState NewState);
void DFSDM_ConfigShortCircuitThreshold(DFSDM_Channel_TypeDef *DFSDM_Channelx,
				       uint32_t DFSDM_SCDThreshold);
void DFSDM_ConfigAnalogWatchdog(DFSDM_Filter_TypeDef *DFSDMx, uint32_t DFSDM_AWDChannelx,
				uint32_t DFSDM_AWDFastMode);
void DFSDM_ConfigAWDFilter(DFSDM_Channel_TypeDef *DFSDM_Channelx, uint32_t DFSDM_AWDSincOrder,
			   uint32_t DFSDM_AWDSincOverSampleRatio);
uint32_t DFSDM_GetAWDConversionValue(DFSDM_Channel_TypeDef *DFSDM_Channelx);
void DFSDM_SetAWDThreshold(DFSDM_Filter_TypeDef *DFSDMx, uint32_t DFSDM_HighThreshold,
			   uint32_t DFSDM_LowThreshold);
void DFSDM_SelectExtremesDetectorChannel(DFSDM_Filter_TypeDef *DFSDMx,
					 uint32_t DFSDM_ExtremChannelx);
...
void DFSDM_DMATransferConfig(DFSDM_Filter_TypeDef *DFSDMx, uint32_t DFSDM_DMAConversionMode,
			     FunctionalState NewState);
...
FlagStatus DFSDM_GetShortCircuitFlagStatus(uint32_t Instance, uint32_t DFSDM_FLAG_SCD);
		#endif /* STM32F412xG */
FlagStatus DFSDM_GetWatchdogFlagStatus(DFSDM_Filter_TypeDef *DFSDMx, uint32_t DFSDM_AWDChannelx,
				       uint8_t DFSDM_Threshold);
...
void DFSDM_ClearShortCircuitFlag(uint32_t Instance, uint32_t DFSDM_CLEARF_SCD);
		#endif /* STM32F412xG */
void DFSDM_ClearAnalogWatchdogFlag(DFSDM_Filter_TypeDef *DFSDMx, uint32_t DFSDM_AWDChannelx,
				   uint8_t DFSDM_Threshold);

...
extern "C" {
  ...
  */
        ...
        #define IS_EXTI_PORT_SOURCE(PORTSOURCE)                                                      \
                (((PORTSOURCE) == EXTI_PortSourceGPIOA) || ((PORTSOURCE) == EXTI_PortSourceGPIOB)    \
                 || ((PORTSOURCE) == EXTI_PortSourceGPIOC) || ((PORTSOURCE) == EXTI_PortSourceGPIOD) \
                 || ((PORTSOURCE) == EXTI_PortSourceGPIOE) || ((PORTSOURCE) == EXTI_PortSourceGPIOF) \
                 || ((PORTSOURCE) == EXTI_PortSourceGPIOG) || ((PORTSOURCE) == EXTI_PortSourceGPIOH) \
                 || ((PORTSOURCE) == EXTI_PortSourceGPIOI) || ((PORTSOURCE) == EXTI_PortSourceGPIOJ) \
  ...
  */
        ...
        #define SYSCFG_MemoryRemap_SDRAM       ((uint8_t)0x04)
                ...
                #define IS_SYSCFG_MEMORY_REMAP_CONFING(REMAP)                                                 \
                        (((REMAP) == SYSCFG_MemoryRemap_Flash) || ((REMAP) == SYSCFG_MemoryRemap_SystemFlash) \
                         || ((REMAP) == SYSCFG_MemoryRemap_SRAM) || ((REMAP) == SYSCFG_MemoryRemap_FSMC))
        #endif /* STM32F40_41xxx || STM32F412xG || STM32F413_423xx */
                ...
                #define IS_SYSCFG_MEMORY_REMAP_CONFING(REMAP)                                                 \
                        (((REMAP) == SYSCFG_MemoryRemap_Flash) || ((REMAP) == SYSCFG_MemoryRemap_SystemFlash) \
                         || ((REMAP) == SYSCFG_MemoryRemap_SRAM) || ((REMAP) == SYSCFG_MemoryRemap_SDRAM)     \
                         || ((REMAP) == SYSCFG_MemoryRemap_FMC))
        #endif /* STM32F427_437xx ||  STM32F429_439xx */

        #if defined(STM32F446xx) || defined(STM32F469_479xx)
                #define IS_SYSCFG_MEMORY_REMAP_CONFING(REMAP)                                                   \
                        (((REMAP) == SYSCFG_MemoryRemap_Flash) || ((REMAP) == SYSCFG_MemoryRemap_ExtMEM)        \
                         || ((REMAP) == SYSCFG_MemoryRemap_SystemFlash) || ((REMAP) == SYSCFG_MemoryRemap_SRAM) \
                ...
                #define IS_SYSCFG_LOCK_CONFIG(BREAK) \
                        (((BREAK) == SYSCFG_Break_PVD) || ((BREAK) == SYSCFG_Break_HardFault))
  ...
  */
        ...
        #define IS_SYSCFG_ETH_MEDIA_INTERFACE(INTERFACE) \
                (((INTERFACE) == SYSCFG_ETH_MediaInterface_MII) || ((INTERFACE) == SYSCFG_ETH_MediaInterface_RMII))
/**
  * @}
  */

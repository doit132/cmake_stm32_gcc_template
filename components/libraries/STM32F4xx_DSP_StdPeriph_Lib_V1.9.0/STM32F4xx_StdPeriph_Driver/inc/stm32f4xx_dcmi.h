...
typedef struct {
        ...
        uint16_t
                DCMI_HorizontalOffsetCount; /*!< Specifies the number of pixel clocks to count before starting a capture.
...
typedef struct {
  ...
  */
        ...
        #define IS_DCMI_CAPTURE_RATE(RATE)                                                         \
                (((RATE) == DCMI_CaptureRate_All_Frame) || ((RATE) == DCMI_CaptureRate_1of2_Frame) \
  ...
  */
        ...
        #define IS_DCMI_GET_IT(IT)                                                                                    \
                (((IT) == DCMI_IT_FRAME) || ((IT) == DCMI_IT_OVF) || ((IT) == DCMI_IT_ERR) || ((IT) == DCMI_IT_VSYNC) \
                 || ((IT) == DCMI_IT_LINE))
        /**
  * @}
  */
  ...
  */
        ...
        #define IS_DCMI_GET_FLAG(FLAG)                                                                             \
                (((FLAG) == DCMI_FLAG_HSYNC) || ((FLAG) == DCMI_FLAG_VSYNC) || ((FLAG) == DCMI_FLAG_FNE)           \
                 || ((FLAG) == DCMI_FLAG_FRAMERI) || ((FLAG) == DCMI_FLAG_OVFRI) || ((FLAG) == DCMI_FLAG_ERRRI)    \
                 || ((FLAG) == DCMI_FLAG_VSYNCRI) || ((FLAG) == DCMI_FLAG_LINERI) || ((FLAG) == DCMI_FLAG_FRAMEMI) \
                 || ((FLAG) == DCMI_FLAG_OVFMI) || ((FLAG) == DCMI_FLAG_ERRMI) || ((FLAG) == DCMI_FLAG_VSYNCMI)    \

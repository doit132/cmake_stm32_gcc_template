...
typedef struct {
        ...
        uint32_t
                FMC_CLKDivision; /*!< Defines the period of CLK clock output signal, expressed in number of HCLK cycles.
                                             This parameter can be a value between 1 and 15.
...
typedef struct {
        ...
        FMC_NORSRAMTimingInitTypeDef*
                FMC_ReadWriteTimingStruct; /*!< Timing Parameters for write and read access if the  Extended Mode is not used*/

        FMC_NORSRAMTimingInitTypeDef*
                FMC_WriteTimingStruct; /*!< Timing Parameters for write access if the  Extended Mode is used*/
...
typedef struct {
  ...
  */
        ...
        #define IS_FMC_NORSRAM_BANK(BANK)                                                                           \
                (((BANK) == FMC_Bank1_NORSRAM1) || ((BANK) == FMC_Bank1_NORSRAM2) || ((BANK) == FMC_Bank1_NORSRAM3) \
...
/** @defgroup FMC_Data_Address_Bus_Multiplexing 
  ...
  */
        ...
        #define IS_FMC_MUX(MUX) (((MUX) == FMC_DataAddressMux_Disable) || ((MUX) == FMC_DataAddressMux_Enable))
/**
  * @}
  */
...
/** @defgroup FMC_NORSRAM_Data_Width 
  ...
  */
        ...
        #define IS_FMC_NORSRAM_MEMORY_WIDTH(WIDTH)                                                           \
                (((WIDTH) == FMC_NORSRAM_MemoryDataWidth_8b) || ((WIDTH) == FMC_NORSRAM_MemoryDataWidth_16b) \
...
/** @defgroup FMC_Burst_Access_Mode 
  ...
  */
        ...
        #define IS_FMC_BURSTMODE(STATE) \
                (((STATE) == FMC_BurstAccessMode_Disable) || ((STATE) == FMC_BurstAccessMode_Enable))
        /**
  * @}
  */
  ...
  */
        ...
        #define IS_FMC_ASYNWAIT(STATE) \
                (((STATE) == FMC_AsynchronousWait_Disable) || ((STATE) == FMC_AsynchronousWait_Enable))
        /**
  * @}
  */
  ...
  */
        ...
        #define IS_FMC_WAIT_POLARITY(POLARITY) \
                (((POLARITY) == FMC_WaitSignalPolarity_Low) || ((POLARITY) == FMC_WaitSignalPolarity_High))
        /**
  * @}
  */
  ...
  */
        ...
        #define IS_FMC_WRAP_MODE(MODE) (((MODE) == FMC_WrapMode_Disable) || ((MODE) == FMC_WrapMode_Enable))
        /**
  * @}
  */
  ...
  */
        ...
        #define IS_FMC_WRITE_OPERATION(OPERATION) \
                (((OPERATION) == FMC_WriteOperation_Disable) || ((OPERATION) == FMC_WriteOperation_Enable))
        /**
  * @}
  */
  ...
  */
        ...
        #define IS_FMC_EXTENDED_MODE(MODE) (((MODE) == FMC_ExtendedMode_Disable) || ((MODE) == FMC_ExtendedMode_Enable))
/**
  * @}
  */
...
/** @defgroup FMC_Write_Burst 
  ...
  */
        ...
        #define IS_FMC_WRITE_BURST(BURST) (((BURST) == FMC_WriteBurst_Disable) || ((BURST) == FMC_WriteBurst_Enable))
/**
  * @}
  */
...
/** @defgroup FMC_Continous_Clock 
  ...
  */
        ...
        #define IS_FMC_CONTINOUS_CLOCK(CCLOCK) (((CCLOCK) == FMC_CClock_SyncOnly) || ((CCLOCK) == FMC_CClock_SyncAsync))
        /**
  * @}
  */
  ...
  */
        ...
        #define IS_FMC_ACCESS_MODE(MODE)                                                                      \
                (((MODE) == FMC_AccessMode_A) || ((MODE) == FMC_AccessMode_B) || ((MODE) == FMC_AccessMode_C) \
  ...
  */
        ...
        #define IS_FMC_NAND_MEMORY_WIDTH(WIDTH) \
                (((WIDTH) == FMC_NAND_MemoryDataWidth_8b) || ((WIDTH) == FMC_NAND_MemoryDataWidth_16b))
        /**
  * @}
  */
  ...
  */
        ...
        #define IS_FMC_ECC_STATE(STATE) (((STATE) == FMC_ECC_Disable) || ((STATE) == FMC_ECC_Enable))
        /**
  * @}
  */
  ...
  */
        ...
        #define IS_FMC_COLUMNBITS_NUMBER(COLUMN)                                                  \
                (((COLUMN) == FMC_ColumnBits_Number_8b) || ((COLUMN) == FMC_ColumnBits_Number_9b) \
                 || ((COLUMN) == FMC_ColumnBits_Number_10b) || ((COLUMN) == FMC_ColumnBits_Number_11b))
  ...
  */
        ...
        #define IS_FMC_WRITE_PROTECTION(WRITE) \
                (((WRITE) == FMC_Write_Protection_Disable) || ((WRITE) == FMC_Write_Protection_Enable))
  ...
  */
        ...
        #define IS_FMC_READ_BURST(RBURST) (((RBURST) == FMC_Read_Burst_Disable) || ((RBURST) == FMC_Read_Burst_Enable))
  ...
  */
        ...
        #define IS_FMC_COMMAND_MODE(COMMAND)                                                                \
                (((COMMAND) == FMC_Command_Mode_normal) || ((COMMAND) == FMC_Command_Mode_CLK_Enabled)      \
                 || ((COMMAND) == FMC_Command_Mode_PALL) || ((COMMAND) == FMC_Command_Mode_AutoRefresh)     \
                 || ((COMMAND) == FMC_Command_Mode_LoadMode) || ((COMMAND) == FMC_Command_Mode_Selfrefresh) \
  ...
  */
        ...
        #define IS_FMC_COMMAND_TARGET(TARGET)                                                     \
                (((TARGET) == FMC_Command_Target_bank1) || ((TARGET) == FMC_Command_Target_bank2) \
  ...
  */
        ...
        #define IS_FMC_MODE_STATUS(STATUS)                                                       \
                (((STATUS) == FMC_NormalMode_Status) || ((STATUS) == FMC_SelfRefreshMode_Status) \
  ...
  */
        ...
        #define IS_FMC_GET_IT(IT)                                                                      \
                (((IT) == FMC_IT_RisingEdge) || ((IT) == FMC_IT_Level) || ((IT) == FMC_IT_FallingEdge) \
                 || ((IT) == FMC_IT_Refresh))

        #define IS_FMC_IT_BANK(BANK)                                                                      \
                (((BANK) == FMC_Bank2_NAND) || ((BANK) == FMC_Bank3_NAND) || ((BANK) == FMC_Bank4_PCCARD) \
                 || ((BANK) == FMC_Bank1_SDRAM) || ((BANK) == FMC_Bank2_SDRAM))
        /**
  * @}
  */
  ...
  */
        ...
        #define IS_FMC_GET_FLAG(FLAG)                                                                              \
                (((FLAG) == FMC_FLAG_RisingEdge) || ((FLAG) == FMC_FLAG_Level) || ((FLAG) == FMC_FLAG_FallingEdge) \
                 || ((FLAG) == FMC_FLAG_FEMPT) || ((FLAG) == FMC_FLAG_Refresh) || ((FLAG) == FMC_SDSR_BUSY))

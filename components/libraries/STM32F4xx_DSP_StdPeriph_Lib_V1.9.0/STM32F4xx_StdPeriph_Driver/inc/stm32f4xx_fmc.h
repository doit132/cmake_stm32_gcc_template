...
typedef struct {
	...
	uint32_t FMC_BusTurnAroundDuration; /*!< Defines the number of HCLK cycles to configure
					     ...
					     This parameter can be a value between 0 and 15.
					     @note This parameter is only used for multiplexed NOR
					     Flash memories. */

	uint32_t FMC_CLKDivision; /*!< Defines the period of CLK clock output signal, expressed in
				     number of HCLK cycles. This parameter can be a value between 1
				     and 15.
					      @note This parameter is not used for asynchronous NOR
				     Flash, SRAM or ROM accesses. */

	uint32_t FMC_DataLatency; /*!< Defines the number of memory clock cycles to issue
					     to the memory before getting the first data.
					     The parameter value depends on the memory type as shown
				     below:
					      - It must be set to 0 in case of a CRAM
					      - It is don't care in asynchronous NOR, SRAM or ROM
				     accesses
					      - It may assume a value between 0 and 15 in NOR Flash
				     memories with synchronous burst mode enable */
...
typedef struct {
	...
	uint32_t FMC_MemoryDataWidth; /*!< Specifies the external memory device width.
					  This parameter can be a value of @ref
					 FMC_NORSRAM_Data_Width */

	uint32_t FMC_BurstAccessMode; /*!< Enables or disables the burst access mode for Flash
					 memory, valid only with synchronous burst Flash memories.
					  This parameter can be a value of @ref
					 FMC_Burst_Access_Mode */

	uint32_t FMC_WaitSignalPolarity; /*!< Specifies the wait signal polarity, valid only when
					  accessing the Flash memory in burst mode. This parameter
					  can be a value of @ref FMC_Wait_Signal_Polarity */

	uint32_t FMC_WrapMode; /*!< Enables or disables the Wrapped burst access mode for Flash
					  memory, valid only when accessing Flash memories in burst
				  mode. This parameter can be a value of @ref FMC_Wrap_Mode */

	uint32_t FMC_WaitSignalActive; /*!< Specifies if the wait signal is asserted by the memory
					  one clock cycle before the wait state or during the wait
					  state, valid only when accessing memories in burst mode.
					  This parameter can be a value of @ref FMC_Wait_Timing */

	uint32_t FMC_WriteOperation; /*!< Enables or disables the write operation in the selected
					bank by the FMC. This parameter can be a value of @ref
					FMC_Write_Operation */
	...
	uint32_t FMC_AsynchronousWait; /*!< Enables or disables wait signal during asynchronous
					  transfers, valid only with asynchronous Flash memories.
	...
	uint32_t FMC_ContinousClock; /*!< Enables or disables the FMC clock output to external
					memory devices. This parameter is only enabled through the
					FMC_BCR1 register, and don't care through FMC_BCR2..4
					registers. This parameter can be a value of @ref
					FMC_Continous_Clock */

	FMC_NORSRAMTimingInitTypeDef
		*FMC_ReadWriteTimingStruct; /*!< Timing Parameters for write and read access if the
					       Extended Mode is not used*/

	FMC_NORSRAMTimingInitTypeDef *FMC_WriteTimingStruct; /*!< Timing Parameters for write access
								if the  Extended Mode is used*/
...
typedef struct {
	...
	uint32_t
		FMC_Waitfeature; /*!< Enables or disables the Wait feature for the NAND Memory Bank.
				      This parameter can be any value of @ref FMC_Wait_feature */

	uint32_t
		FMC_MemoryDataWidth; /*!< Specifies the external memory device width.
	...
	FMC_NAND_PCCARDTimingInitTypeDef
		*FMC_CommonSpaceTimingStruct; /*!< FMC Common Space Timing */

	FMC_NAND_PCCARDTimingInitTypeDef
		*FMC_AttributeSpaceTimingStruct; /*!< FMC Attribute Space Timing */
} FMC_NANDInitTypeDef;
...
typedef struct {
	uint32_t
		FMC_LoadToActiveDelay; /*!< Defines the delay between a Load Mode Register command
					  and an active or Refresh command in number of memory clock
					  cycles. This parameter can be a value between 1 and 16. */

	uint32_t FMC_ExitSelfRefreshDelay; /*!< Defines the delay from releasing the self refresh
					    command to issuing the Activate command in number of
					    memory clock cycles. This parameter can be a value
					    between 1 and 16. */

	uint32_t FMC_SelfRefreshTime; /*!< Defines the minimum Self Refresh period in number of
					 memory clock cycles. This parameter can be a value between
					 1 and 16. */

	uint32_t FMC_RowCycleDelay; /*!< Defines the delay between the Refresh command and the
				       Activate command and the delay between two consecutive
				       Refresh commands in number of memory clock cycles. This
				       parameter can be a value between 1 and 16. */

	uint32_t FMC_WriteRecoveryTime; /*!< Defines the Write recovery Time in number of memory
					   clock cycles. This parameter can be a value between 1
					   and 16. */

	uint32_t
		FMC_RPDelay; /*!< Defines the delay between a Precharge Command and an other command
					   in number of memory clock cycles.
					   This parameter can be a value between 1 and 16. */

	uint32_t FMC_RCDDelay; /*!< Defines the delay between the Activate Command and a Read/Write
				  command in number of memory clock cycles. This parameter can be a
...
typedef struct {
	...
	uint32_t FMC_AutoRefreshNumber; /*!< Defines the number of consecutive auto refresh command
					   issued in auto refresh mode. This parameter can be a
					   value between 1 and 16. */
...
typedef struct {
	...
	uint32_t
		FMC_InternalBankNumber; /*!< Defines the number of bits of column address.
					   This parameter can be of @ref FMC_InternalBank_Number. */

	uint32_t
		FMC_CASLatency; /*!< Defines the SDRAM CAS latency in number of memory clock cycles.
	...
	uint32_t FMC_SDClockPeriod; /*!< Define the SDRAM Clock Period for both SDRAM Banks and they
				       allow to disable the clock before changing frequency. This
				       parameter can be a value of @ref FMC_SDClock_Period. */

	uint32_t FMC_ReadBurst; /*!< This bit enable the SDRAM controller to anticipate the next
				   read commands during the CAS latency and stores data in the Read
				   FIFO. This parameter can be a value of @ref FMC_Read_Burst. */
	...
	FMC_SDRAMTimingInitTypeDef
		*FMC_SDRAMTimingStruct; /*!< Timing Parameters for write and read access*/
	...
	#define IS_FMC_NORSRAM_BANK(BANK)                                                          \
		(((BANK) == FMC_Bank1_NORSRAM1) || ((BANK) == FMC_Bank1_NORSRAM2) ||               \
		 ((BANK) == FMC_Bank1_NORSRAM3) || ((BANK) == FMC_Bank1_NORSRAM4))
	/**
	 * @}
	 */
	...
	#define IS_FMC_NAND_BANK(BANK)	   (((BANK) == FMC_Bank2_NAND) || ((BANK) == FMC_Bank3_NAND))
	/**
	 * @}
	 */
	...
	#define IS_FMC_SDRAM_BANK(BANK)	   (((BANK) == FMC_Bank1_SDRAM) || ((BANK) == FMC_Bank2_SDRAM))
 ...
 */
	...
	#define IS_FMC_MUX(MUX)                                                                    \
		(((MUX) == FMC_DataAddressMux_Disable) || ((MUX) == FMC_DataAddressMux_Enable))
/**
 * @}
 */
 ...
 */
	...
	#define IS_FMC_MEMORY(MEMORY)                                                              \
		(((MEMORY) == FMC_MemoryType_SRAM) || ((MEMORY) == FMC_MemoryType_PSRAM) ||        \
 ...
 */
	...
	#define IS_FMC_NORSRAM_MEMORY_WIDTH(WIDTH)                                                 \
		(((WIDTH) == FMC_NORSRAM_MemoryDataWidth_8b) ||                                    \
 ...
 */
	...
	#define IS_FMC_BURSTMODE(STATE)                                                            \
		(((STATE) == FMC_BurstAccessMode_Disable) ||                                       \
	...
	#define IS_FMC_ASYNWAIT(STATE)                                                             \
		(((STATE) == FMC_AsynchronousWait_Disable) ||                                      \
	...
	#define IS_FMC_WAIT_POLARITY(POLARITY)                                                     \
		(((POLARITY) == FMC_WaitSignalPolarity_Low) ||                                     \
	...
	#define IS_FMC_WRAP_MODE(MODE)                                                             \
		(((MODE) == FMC_WrapMode_Disable) || ((MODE) == FMC_WrapMode_Enable))
	/**
	 * @}
	 */
	...
	#define IS_FMC_WAIT_SIGNAL_ACTIVE(ACTIVE)                                                  \
		(((ACTIVE) == FMC_WaitSignalActive_BeforeWaitState) ||                             \
	...
	#define IS_FMC_WRITE_OPERATION(OPERATION)                                                  \
		(((OPERATION) == FMC_WriteOperation_Disable) ||                                    \
	...
	#define IS_FMC_WAITE_SIGNAL(SIGNAL)                                                        \
		(((SIGNAL) == FMC_WaitSignal_Disable) || ((SIGNAL) == FMC_WaitSignal_Enable))
	/**
	 * @}
	 */
	...
	#define IS_FMC_EXTENDED_MODE(MODE)                                                         \
		(((MODE) == FMC_ExtendedMode_Disable) || ((MODE) == FMC_ExtendedMode_Enable))
/**
 * @}
 */
 ...
 */
	...
	#define IS_FMC_WRITE_BURST(BURST)                                                          \
		(((BURST) == FMC_WriteBurst_Disable) || ((BURST) == FMC_WriteBurst_Enable))
/**
 * @}
 */
 ...
 */
	...
	#define IS_FMC_CONTINOUS_CLOCK(CCLOCK)                                                     \
		(((CCLOCK) == FMC_CClock_SyncOnly) || ((CCLOCK) == FMC_CClock_SyncAsync))
	/**
	 * @}
	 */
	...
	#define IS_FMC_ACCESS_MODE(MODE)                                                           \
		(((MODE) == FMC_AccessMode_A) || ((MODE) == FMC_AccessMode_B) ||                   \
		 ((MODE) == FMC_AccessMode_C) || ((MODE) == FMC_AccessMode_D))
	/**
	 * @}
	 */
	...
	#define IS_FMC_WAIT_FEATURE(FEATURE)                                                       \
		(((FEATURE) == FMC_Waitfeature_Disable) || ((FEATURE) == FMC_Waitfeature_Enable))
	/**
	 * @}
	 */
	...
	#define IS_FMC_NAND_MEMORY_WIDTH(WIDTH)                                                    \
		(((WIDTH) == FMC_NAND_MemoryDataWidth_8b) ||                                       \
	...
	#define IS_FMC_ECC_STATE(STATE)                                                            \
		(((STATE) == FMC_ECC_Disable) || ((STATE) == FMC_ECC_Enable))
	/**
	 * @}
	 */
	...
	#define IS_FMC_ECCPAGE_SIZE(SIZE)                                                          \
		(((SIZE) == FMC_ECCPageSize_256Bytes) || ((SIZE) == FMC_ECCPageSize_512Bytes) ||   \
		 ((SIZE) == FMC_ECCPageSize_1024Bytes) || ((SIZE) == FMC_ECCPageSize_2048Bytes) || \
		 ((SIZE) == FMC_ECCPageSize_4096Bytes) || ((SIZE) == FMC_ECCPageSize_8192Bytes))
	/**
	 * @}
	 */
	...
	#define IS_FMC_ROWBITS_NUMBER(ROW)                                                         \
		(((ROW) == FMC_RowBits_Number_11b) || ((ROW) == FMC_RowBits_Number_12b) ||         \
	...
	#define IS_FMC_SDMEMORY_WIDTH(WIDTH)                                                       \
		(((WIDTH) == FMC_SDMemory_Width_8b) || ((WIDTH) == FMC_SDMemory_Width_16b) ||      \
	...
	#define IS_FMC_INTERNALBANK_NUMBER(NUMBER)                                                 \
		(((NUMBER) == FMC_InternalBank_Number_2) || ((NUMBER) == FMC_InternalBank_Number_4))
	...
	#define IS_FMC_CAS_LATENCY(LATENCY)                                                        \
		(((LATENCY) == FMC_CAS_Latency_1) || ((LATENCY) == FMC_CAS_Latency_2) ||           \
	...
	#define IS_FMC_SDCLOCK_PERIOD(PERIOD)                                                      \
		(((PERIOD) == FMC_SDClock_Disable) || ((PERIOD) == FMC_SDClock_Period_2) ||        \
	...
	#define IS_FMC_READ_BURST(RBURST)                                                          \
		(((RBURST) == FMC_Read_Burst_Disable) || ((RBURST) == FMC_Read_Burst_Enable))
	...
	#define IS_FMC_READPIPE_DELAY(DELAY)                                                       \
		(((DELAY) == FMC_ReadPipe_Delay_0) || ((DELAY) == FMC_ReadPipe_Delay_1) ||         \
	...
	#define IS_FMC_MODE_STATUS(STATUS)                                                         \
		(((STATUS) == FMC_NormalMode_Status) ||                                            \
	...
	#define IS_FMC_IT(IT)                                                                      \
		((((IT) & (uint32_t)0xFFFFBFC7) == 0x00000000) && ((IT) != 0x00000000))
	#define IS_FMC_GET_IT(IT)                                                                  \
		(((IT) == FMC_IT_RisingEdge) || ((IT) == FMC_IT_Level) ||                          \
		 ((IT) == FMC_IT_FallingEdge) || ((IT) == FMC_IT_Refresh))

	#define IS_FMC_IT_BANK(BANK)                                                               \
		(((BANK) == FMC_Bank2_NAND) || ((BANK) == FMC_Bank3_NAND) ||                       \
		 ((BANK) == FMC_Bank4_PCCARD) || ((BANK) == FMC_Bank1_SDRAM) ||                    \
	...
	#define IS_FMC_GET_FLAG(FLAG)                                                              \
		(((FLAG) == FMC_FLAG_RisingEdge) || ((FLAG) == FMC_FLAG_Level) ||                  \
		 ((FLAG) == FMC_FLAG_FallingEdge) || ((FLAG) == FMC_FLAG_FEMPT) ||                 \
		 ((FLAG) == FMC_FLAG_Refresh) || ((FLAG) == FMC_SDSR_BUSY))

	#define IS_FMC_GETFLAG_BANK(BANK)                                                          \
		(((BANK) == FMC_Bank2_NAND) || ((BANK) == FMC_Bank3_NAND) ||                       \
		 ((BANK) == FMC_Bank4_PCCARD) || ((BANK) == FMC_Bank1_SDRAM) ||                    \
		 ((BANK) == FMC_Bank2_SDRAM) || ((BANK) == (FMC_Bank1_SDRAM | FMC_Bank2_SDRAM)))

	#define IS_FMC_CLEAR_FLAG(FLAG)                                                            \

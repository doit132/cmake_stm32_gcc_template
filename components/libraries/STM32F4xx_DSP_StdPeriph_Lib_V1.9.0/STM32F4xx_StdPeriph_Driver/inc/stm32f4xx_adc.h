...
typedef struct {
  ...
  */
        ...
        #define IS_ADC_MODE(MODE)                                                                            \
                (((MODE) == ADC_Mode_Independent) || ((MODE) == ADC_DualMode_RegSimult_InjecSimult)          \
                 ...
                 || ((MODE) == ADC_DualMode_AlterTrig) || ((MODE) == ADC_TripleMode_RegSimult_InjecSimult)   \
                 || ((MODE) == ADC_TripleMode_RegSimult_AlterTrig) || ((MODE) == ADC_TripleMode_InjecSimult) \
                 || ((MODE) == ADC_TripleMode_RegSimult) || ((MODE) == ADC_TripleMode_Interl)                \
  ...
  */
        ...
        #define IS_ADC_PRESCALER(PRESCALER)                                                 \
                (((PRESCALER) == ADC_Prescaler_Div2) || ((PRESCALER) == ADC_Prescaler_Div4) \
  ...
  */
        ...
        #define ADC_DMAAccessMode_1 \
                ((uint32_t)0x00004000) /* DMA mode 1 enabled (2 / 3 half-words one by one - 1 then 2 then 3)*/
        #define ADC_DMAAccessMode_2 \
                ((uint32_t)0x00008000) /* DMA mode 2 enabled (2 / 3 half-words by pairs - 2&1 then 1&3 then 3&2)*/
        #define ADC_DMAAccessMode_3 \
                ((uint32_t)0x0000C000) /* DMA mode 3 enabled (2 / 3 bytes by pairs - 2&1 then 1&3 then 3&2) */
        #define IS_ADC_DMA_ACCESS_MODE(MODE)                                               \
                (((MODE) == ADC_DMAAccessMode_Disabled) || ((MODE) == ADC_DMAAccessMode_1) \
                 || ((MODE) == ADC_DMAAccessMode_2) || ((MODE) == ADC_DMAAccessMode_3))
  ...
  */
        ...
        #if defined(STM32F427_437xx) || defined(STM32F429_439xx) || defined(STM32F401xx) || defined(STM32F410xx) \
                || defined(STM32F411xE)
  ...
  */
        ...
        #define IS_ADC_IT(IT) \
                (((IT) == ADC_IT_EOC) || ((IT) == ADC_IT_AWD) || ((IT) == ADC_IT_JEOC) || ((IT) == ADC_IT_OVR))
        /**
  * @}
  */

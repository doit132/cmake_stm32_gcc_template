...
typedef struct {
        ...
        uint32_t
                FSMC_CLKDivision; /*!< Defines the period of CLK clock output signal, expressed in number of HCLK cycles.
...
typedef struct {
        ...
        FSMC_NORSRAMTimingInitTypeDef*
                FSMC_ReadWriteTimingStruct; /*!< Timing Parameters for write and read access if the  Extended Mode is not used*/

        FSMC_NORSRAMTimingInitTypeDef*
                FSMC_WriteTimingStruct; /*!< Timing Parameters for write access if the  Extended Mode is used*/
...
/**
  ...
  */
        ...
        #define IS_FSMC_NORSRAM_BANK(BANK)                                                                             \
                (((BANK) == FSMC_Bank1_NORSRAM1) || ((BANK) == FSMC_Bank1_NORSRAM2) || ((BANK) == FSMC_Bank1_NORSRAM3) \
...
/** @defgroup FSMC_Burst_Access_Mode 
  ...
  */
        ...
        #define IS_FSMC_ASYNWAIT(STATE) \
                (((STATE) == FSMC_AsynchronousWait_Disable) || ((STATE) == FSMC_AsynchronousWait_Enable))
        /**
  * @}
  */
...
/** @defgroup FSMC_Write_Burst 
  ...
  */
        ...
        #define IS_FSMC_ACCESS_MODE(MODE)                                                                        \
                (((MODE) == FSMC_AccessMode_A) || ((MODE) == FSMC_AccessMode_B) || ((MODE) == FSMC_AccessMode_C) \
  ...
  */
        ...
        #define IS_FSMC_GET_FLAG(FLAG)                                                                                \
                (((FLAG) == FSMC_FLAG_RisingEdge) || ((FLAG) == FSMC_FLAG_Level) || ((FLAG) == FSMC_FLAG_FallingEdge) \

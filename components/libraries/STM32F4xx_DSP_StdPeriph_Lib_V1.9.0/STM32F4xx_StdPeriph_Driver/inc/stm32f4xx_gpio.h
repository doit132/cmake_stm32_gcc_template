...
/* Exported types ------------------------------------------------------------*/
        ...
        #define IS_GPIO_ALL_PERIPH(PERIPH)                                                                   \
                (((PERIPH) == GPIOA) || ((PERIPH) == GPIOB) || ((PERIPH) == GPIOC) || ((PERIPH) == GPIOD)    \
                 || ((PERIPH) == GPIOE) || ((PERIPH) == GPIOF) || ((PERIPH) == GPIOG) || ((PERIPH) == GPIOH) \
                 || ((PERIPH) == GPIOI) || ((PERIPH) == GPIOJ) || ((PERIPH) == GPIOK))
...
typedef enum {
        ...
        #define IS_GPIO_MODE(MODE)                                                                 \
                (((MODE) == GPIO_Mode_IN) || ((MODE) == GPIO_Mode_OUT) || ((MODE) == GPIO_Mode_AF) \
                 || ((MODE) == GPIO_Mode_AN))
...
typedef enum {
        ...
        #define IS_GPIO_SPEED(SPEED)                                                                           \
                (((SPEED) == GPIO_Low_Speed) || ((SPEED) == GPIO_Medium_Speed) || ((SPEED) == GPIO_Fast_Speed) \
...
typedef enum { GPIO_PuPd_NOPULL = 0x00, GPIO_PuPd_UP = 0x01, GPIO_PuPd_DOWN = 0x02 } GPIOPuPd_TypeDef;
        #define IS_GPIO_PUPD(PUPD) \
                (((PUPD) == GPIO_PuPd_NOPULL) || ((PUPD) == GPIO_PuPd_UP) || ((PUPD) == GPIO_PuPd_DOWN))
...
typedef struct {
  ...
  */
        ...
        #define GPIO_AF5_SPI3 \
                ((uint8_t)0x05) /* SPI3/I2S3 Alternate Function mapping (Only for STM32F411xE and STM32F413_423xx Devices) */
  ...
  */
        ...
        #define GPIO_AF6_SPI2 \
                ((uint8_t)0x06) /* SPI2 Alternate Function mapping (Only for STM32F410xx/STM32F411xE Devices) */
        #define GPIO_AF6_SPI4 ((uint8_t)0x06) /* SPI4 Alternate Function mapping (Only for STM32F411xE Devices) */
        #define GPIO_AF6_SPI5 \
                ((uint8_t)0x06) /* SPI5 Alternate Function mapping (Only for STM32F410xx/STM32F411xE Devices) */
        #define GPIO_AF_SAI1 ((uint8_t)0x06) /* SAI1 Alternate Function mapping      */
        #define GPIO_AF_I2S2ext \
                ((uint8_t)0x06) /* I2S2ext_SD Alternate Function mapping (only for STM32F412xG and STM32F413_423xx Devices) */
  ...
  */
        ...
        #define GPIO_AF9_I2C2 \
                ((uint8_t)0x09) /* I2C2 Alternate Function mapping (Only for STM32F401xx/STM32F410xx/STM32F411xE/STM32F412xG/STM32F413_423xx Devices) */
        #define GPIO_AF9_I2C3 \
                ((uint8_t)0x09) /* I2C3 Alternate Function mapping (Only for STM32F401xx/STM32F411xE/STM32F412xG and STM32F413_423xx Devices) */
        #if defined(STM32F446xx)
        ...
        #define GPIO_AF9_LTDC ((uint8_t)0x09)         /* LTDC Alternate Function mapping */
                ...
                #define GPIO_AF9_FMPI2C \
                        ((uint8_t)0x09) /* FMPI2C Alternate Function mapping (Only for STM32F410xx Devices) */
  ...
  */
        #define GPIO_AF_EVENTOUT ((uint8_t)0x0F) /* EVENTOUT Alternate Function mapping */
                ...
                #define IS_GPIO_AF(AF)                                                                      \
                        (((AF) == GPIO_AF_RTC_50Hz) || ((AF) == GPIO_AF_TIM14) || ((AF) == GPIO_AF_MCO)     \
                         || ((AF) == GPIO_AF_TAMPER) || ((AF) == GPIO_AF_SWJ) || ((AF) == GPIO_AF_TRACE)    \
                         || ((AF) == GPIO_AF_TIM1) || ((AF) == GPIO_AF_TIM2) || ((AF) == GPIO_AF_TIM3)      \
                         || ((AF) == GPIO_AF_TIM4) || ((AF) == GPIO_AF_TIM5) || ((AF) == GPIO_AF_TIM8)      \
                         || ((AF) == GPIO_AF_I2C1) || ((AF) == GPIO_AF_I2C2) || ((AF) == GPIO_AF_I2C3)      \
                         || ((AF) == GPIO_AF_SPI1) || ((AF) == GPIO_AF_SPI2) || ((AF) == GPIO_AF_TIM13)     \
                         || ((AF) == GPIO_AF_SPI3) || ((AF) == GPIO_AF_TIM14) || ((AF) == GPIO_AF_USART1)   \
                         || ((AF) == GPIO_AF_USART2) || ((AF) == GPIO_AF_USART3) || ((AF) == GPIO_AF_UART4) \
                         || ((AF) == GPIO_AF_UART5) || ((AF) == GPIO_AF_USART6) || ((AF) == GPIO_AF_CAN1)   \
                         || ((AF) == GPIO_AF_CAN2) || ((AF) == GPIO_AF_OTG_FS) || ((AF) == GPIO_AF_OTG_HS)  \
                         || ((AF) == GPIO_AF_ETH) || ((AF) == GPIO_AF_OTG_HS_FS) || ((AF) == GPIO_AF_SDIO)  \
                         || ((AF) == GPIO_AF_DCMI) || ((AF) == GPIO_AF_EVENTOUT) || ((AF) == GPIO_AF_FSMC))
                ...
                #define IS_GPIO_AF(AF)                                                                         \
                        (((AF) == GPIO_AF_RTC_50Hz) || ((AF) == GPIO_AF_TIM14) || ((AF) == GPIO_AF_MCO)        \
                         ...
                         || ((AF) == GPIO_AF_SPI1) || ((AF) == GPIO_AF_SPI2) || ((AF) == GPIO_AF_TIM13)        \
                         || ((AF) == GPIO_AF_SPI3) || ((AF) == GPIO_AF_TIM14) || ((AF) == GPIO_AF_USART1)      \
                         || ((AF) == GPIO_AF_USART2) || ((AF) == GPIO_AF_SDIO) || ((AF) == GPIO_AF_USART6)     \
                         || ((AF) == GPIO_AF_OTG_FS) || ((AF) == GPIO_AF_OTG_HS) || ((AF) == GPIO_AF_EVENTOUT) \
                         || ((AF) == GPIO_AF_SPI4))
        #endif /* STM32F401xx */
                ...
                #define IS_GPIO_AF(AF)                                                                      \
                        (((AF) == GPIO_AF_RTC_50Hz) || ((AF) == GPIO_AF_TIM14) || ((AF) == GPIO_AF_MCO)     \
                         ...
                         || ((AF) == GPIO_AF_CAN2) || ((AF) == GPIO_AF_OTG_FS) || ((AF) == GPIO_AF_OTG_HS)  \
                         || ((AF) == GPIO_AF_ETH) || ((AF) == GPIO_AF_OTG_HS_FS) || ((AF) == GPIO_AF_SDIO)  \
                         || ((AF) == GPIO_AF_DCMI) || ((AF) == GPIO_AF_EVENTOUT) || ((AF) == GPIO_AF_SPI4)  \
                         || ((AF) == GPIO_AF_SPI5) || ((AF) == GPIO_AF_SPI6) || ((AF) == GPIO_AF_UART7)     \
                         || ((AF) == GPIO_AF_UART8) || ((AF) == GPIO_AF_FMC) || ((AF) == GPIO_AF_SAI1)      \
                         || ((AF) == GPIO_AF_LTDC))

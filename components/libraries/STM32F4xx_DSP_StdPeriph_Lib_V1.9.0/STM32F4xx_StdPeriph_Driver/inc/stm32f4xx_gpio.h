...
typedef struct {
	...
	GPIOPuPd_TypeDef
		GPIO_PuPd; /*!< Specifies the operating Pull-up/Pull down for the selected pins.
	...
	#define GPIO_AF5_SPI3                                                                      \
		((uint8_t)0x05) /* SPI3/I2S3 Alternate Function mapping (Only for STM32F411xE and  \
	...
	#define GPIO_AF6_SPI1                                                                      \
		((uint8_t)0x06) /* SPI1 Alternate Function mapping (Only for STM32F410xx Devices)  \
				 */
	#define GPIO_AF6_SPI2                                                                      \
		((uint8_t)0x06) /* SPI2 Alternate Function mapping (Only for                       \
				   STM32F410xx/STM32F411xE Devices) */
	#define GPIO_AF6_SPI4                                                                      \
		((uint8_t)0x06) /* SPI4 Alternate Function mapping (Only for STM32F411xE Devices)  \
				 */
	#define GPIO_AF6_SPI5                                                                      \
		((uint8_t)0x06)		     /* SPI5 Alternate Function mapping (Only for          \
						STM32F410xx/STM32F411xE Devices) */
	#define GPIO_AF_SAI1 ((uint8_t)0x06) /* SAI1 Alternate Function mapping      */
	#define GPIO_AF_I2S2ext                                                                    \
		((uint8_t)0x06) /* I2S2ext_SD Alternate Function mapping (only for STM32F412xG and \
				   STM32F413_423xx Devices) */
	...
	#define GPIO_AF9_I2C2                                                                      \
		((uint8_t)0x09) /* I2C2 Alternate Function mapping (Only for                       \
				   STM32F401xx/STM32F410xx/STM32F411xE/STM32F412xG/STM32F413_423xx \
				   Devices) */
	#define GPIO_AF9_I2C3                                                                      \
		((uint8_t)0x09) /* I2C3 Alternate Function mapping (Only for                       \
				   STM32F401xx/STM32F411xE/STM32F412xG and STM32F413_423xx         \
				   Devices) */
	#if defined(STM32F446xx)
	...
	#define GPIO_AF9_LTDC ((uint8_t)0x09)	      /* LTDC Alternate Function mapping */
		...
		#define GPIO_AF9_FMPI2C                                                            \
			((uint8_t)0x09) /* FMPI2C Alternate Function mapping (Only for STM32F410xx \
					   Devices) */

...
/** @addtogroup SAI
  ...
  */
        ...
        || defined(STM32F411xE) || defined(STM32F446xx) || defined(STM32F469_479xx) || defined(STM32F413_423xx)
/* Exported types ------------------------------------------------------------*/
...
typedef struct {
  ...
  */
        ...
        #if defined(STM32F40_41xxx) || defined(STM32F427_437xx) || defined(STM32F429_439xx) || defined(STM32F401xx) \
                || defined(STM32F411xE) || defined(STM32F413_423xx) || defined(STM32F469_479xx)
  ...
  */
        ...
        #define IS_SAI_BLOCK_MODE(MODE)                                                                         \
                (((MODE) == SAI_Mode_MasterTx) || ((MODE) == SAI_Mode_MasterRx) || ((MODE) == SAI_Mode_SlaveTx) \
  ...
  */
        ...
        #define IS_SAI_BLOCK_SYNCEXT(SYNCHRO)                                                      \
                (((SYNCHRO) == SAI_SyncExt_Disable) || ((SYNCHRO) == SAI_SyncExt_OutBlockA_Enable) \
  ...
  */
        ...
        #define IS_SAI_BLOCK_NODIVIDER(NODIVIDER) \
                (((NODIVIDER) == SAI_MasterDivider_Enabled) || ((NODIVIDER) == SAI_MasterDivider_Disabled))
        /**
  * @}
  */
  ...
  */
        ...
        #define IS_SAI_BLOCK_FS_DEFINITION(DEFINITION) \
                (((DEFINITION) == SAI_FS_StartFrame) || ((DEFINITION) == I2S_FS_ChannelIdentification))
        /**
  * @}
  */
  ...
  */
        ...
        #define IS_SAI_BLOCK_FIFO_THRESHOLD(THRESHOLD)                                                              \
                (((THRESHOLD) == SAI_Threshold_FIFOEmpty) || ((THRESHOLD) == SAI_FIFOThreshold_1QuarterFull)        \
                 || ((THRESHOLD) == SAI_FIFOThreshold_HalfFull) || ((THRESHOLD) == SAI_FIFOThreshold_3QuartersFull) \
  ...
  */
        ...
        #define IS_SAI_BLOCK_GET_FLAG(FLAG)                                                                 \
                (((FLAG) == SAI_FLAG_OVRUDR) || ((FLAG) == SAI_FLAG_MUTEDET) || ((FLAG) == SAI_FLAG_WCKCFG) \
                 || ((FLAG) == SAI_FLAG_FREQ) || ((FLAG) == SAI_FLAG_CNRDY) || ((FLAG) == SAI_FLAG_AFSDET)  \
  ...
  */
        ...
        #define IS_SAI_BLOCK_FIFO_STATUS(STATUS)                                                            \
                (((STATUS) == SAI_FIFOStatus_Less1QuarterFull) || ((STATUS) == SAI_FIFOStatus_HalfFull)     \
                 || ((STATUS) == SAI_FIFOStatus_1QuarterFull) || ((STATUS) == SAI_FIFOStatus_3QuartersFull) \

  ...
  */
        ...
        #define IS_USART_ALL_PERIPH(PERIPH)                                                                   \
                (((PERIPH) == USART1) || ((PERIPH) == USART2) || ((PERIPH) == USART3) || ((PERIPH) == UART4)  \
                 || ((PERIPH) == UART5) || ((PERIPH) == USART6) || ((PERIPH) == UART7) || ((PERIPH) == UART8) \
                 || ((PERIPH) == UART9) || ((PERIPH) == UART10))

        #define IS_USART_1236_PERIPH(PERIPH) \
                (((PERIPH) == USART1) || ((PERIPH) == USART2) || ((PERIPH) == USART3) || ((PERIPH) == USART6))
...
/** @defgroup USART_Mode 
  ...
  */
        ...
        #define IS_USART_HARDWARE_FLOW_CONTROL(CONTROL)                                                        \
                (((CONTROL) == USART_HardwareFlowControl_None) || ((CONTROL) == USART_HardwareFlowControl_RTS) \
                 || ((CONTROL) == USART_HardwareFlowControl_CTS) || ((CONTROL) == USART_HardwareFlowControl_RTS_CTS))
        /**
  * @}
  */
...
/**
  ...
  */
        ...
        #define IS_USART_CONFIG_IT(IT)                                                                               \
                (((IT) == USART_IT_PE) || ((IT) == USART_IT_TXE) || ((IT) == USART_IT_TC) || ((IT) == USART_IT_RXNE) \
                 || ((IT) == USART_IT_IDLE) || ((IT) == USART_IT_LBD) || ((IT) == USART_IT_CTS)                      \
                 || ((IT) == USART_IT_ERR))
        #define IS_USART_GET_IT(IT)                                                                                  \
                (((IT) == USART_IT_PE) || ((IT) == USART_IT_TXE) || ((IT) == USART_IT_TC) || ((IT) == USART_IT_RXNE) \
                 || ((IT) == USART_IT_IDLE) || ((IT) == USART_IT_LBD) || ((IT) == USART_IT_CTS)                      \
                 || ((IT) == USART_IT_ORE) || ((IT) == USART_IT_ORE_RX) || ((IT) == USART_IT_ORE_ER)                 \

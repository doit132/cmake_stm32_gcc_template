 ...
 */
	...
	#define IS_RTC_TAMPER_PIN(PIN)                                                             \
		(((PIN) == RTC_TamperPin_Default) || ((PIN) == RTC_TamperPin_Pos1))
	/* Legacy Defines */
 ...
 */
	...
	#define IS_RTC_BKP(BKP)                                                                    \
		(((BKP) == RTC_BKP_DR0) || ((BKP) == RTC_BKP_DR1) || ((BKP) == RTC_BKP_DR2) ||     \
		 ((BKP) == RTC_BKP_DR3) || ((BKP) == RTC_BKP_DR4) || ((BKP) == RTC_BKP_DR5) ||     \
		 ((BKP) == RTC_BKP_DR6) || ((BKP) == RTC_BKP_DR7) || ((BKP) == RTC_BKP_DR8) ||     \
		 ((BKP) == RTC_BKP_DR9) || ((BKP) == RTC_BKP_DR10) || ((BKP) == RTC_BKP_DR11) ||   \
		 ((BKP) == RTC_BKP_DR12) || ((BKP) == RTC_BKP_DR13) || ((BKP) == RTC_BKP_DR14) ||  \
		 ((BKP) == RTC_BKP_DR15) || ((BKP) == RTC_BKP_DR16) || ((BKP) == RTC_BKP_DR17) ||  \
	...
	#define IS_RTC_GET_IT(IT)                                                                  \
		(((IT) == RTC_IT_TS) || ((IT) == RTC_IT_WUT) || ((IT) == RTC_IT_ALRB) ||           \
		 ((IT) == RTC_IT_ALRA) || ((IT) == RTC_IT_TAMP1) || ((IT) == RTC_IT_TAMP2))
	#define IS_RTC_CLEAR_IT(IT)                                                                \
		(((IT) != (uint32_t)RESET) && (((IT)&0xFFF90FFF) == (uint32_t)RESET))

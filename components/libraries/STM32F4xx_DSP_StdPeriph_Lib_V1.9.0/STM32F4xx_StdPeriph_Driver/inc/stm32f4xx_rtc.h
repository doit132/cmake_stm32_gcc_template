...
/** @defgroup RTC_Calib_Output_selection_Definitions 
  ...
  */
        ...
        #define RTC_SmoothCalibPeriod_16sec \
                ((uint32_t)0x00002000) /*!<  if RTCCLK = 32768 Hz, Smooth calibration 
        ...
        #define IS_RTC_SMOOTH_CALIB_PERIOD(PERIOD)                                                      \
                (((PERIOD) == RTC_SmoothCalibPeriod_32sec) || ((PERIOD) == RTC_SmoothCalibPeriod_16sec) \
  ...
  */
        ...
        #define IS_RTC_SMOOTH_CALIB_PLUS(PLUS) \
                (((PLUS) == RTC_SmoothCalibPlusPulses_Set) || ((PLUS) == RTC_SmoothCalibPlusPulses_Reset))
  ...
  */
        ...
        #define IS_RTC_TAMPER_TRIGGER(TRIGGER)                                                               \
                (((TRIGGER) == RTC_TamperTrigger_RisingEdge) || ((TRIGGER) == RTC_TamperTrigger_FallingEdge) \
                 || ((TRIGGER) == RTC_TamperTrigger_LowLevel) || ((TRIGGER) == RTC_TamperTrigger_HighLevel))
...
/** @defgroup RTC_Backup_Registers_Definitions 
  ...
  */
        ...
        #define IS_RTC_BKP(BKP)                                                                                       \
                (((BKP) == RTC_BKP_DR0) || ((BKP) == RTC_BKP_DR1) || ((BKP) == RTC_BKP_DR2) || ((BKP) == RTC_BKP_DR3) \
                 || ((BKP) == RTC_BKP_DR4) || ((BKP) == RTC_BKP_DR5) || ((BKP) == RTC_BKP_DR6)                        \
                 || ((BKP) == RTC_BKP_DR7) || ((BKP) == RTC_BKP_DR8) || ((BKP) == RTC_BKP_DR9)                        \
                 || ((BKP) == RTC_BKP_DR10) || ((BKP) == RTC_BKP_DR11) || ((BKP) == RTC_BKP_DR12)                     \
                 || ((BKP) == RTC_BKP_DR13) || ((BKP) == RTC_BKP_DR14) || ((BKP) == RTC_BKP_DR15)                     \
                 || ((BKP) == RTC_BKP_DR16) || ((BKP) == RTC_BKP_DR17) || ((BKP) == RTC_BKP_DR18)                     \
                 || ((BKP) == RTC_BKP_DR19))
        /**
  * @}
  */
  ...
  */
        ...
        #define IS_RTC_GET_FLAG(FLAG)                                                                          \
                (((FLAG) == RTC_FLAG_TSOVF) || ((FLAG) == RTC_FLAG_TSF) || ((FLAG) == RTC_FLAG_WUTF)           \
                 || ((FLAG) == RTC_FLAG_ALRBF) || ((FLAG) == RTC_FLAG_ALRAF) || ((FLAG) == RTC_FLAG_INITF)     \
                 || ((FLAG) == RTC_FLAG_RSF) || ((FLAG) == RTC_FLAG_WUTWF) || ((FLAG) == RTC_FLAG_ALRBWF)      \
                 || ((FLAG) == RTC_FLAG_ALRAWF) || ((FLAG) == RTC_FLAG_TAMP1F) || ((FLAG) == RTC_FLAG_RECALPF) \
  ...
  */
        ...
        #define IS_RTC_GET_IT(IT)                                                                              \
                (((IT) == RTC_IT_TS) || ((IT) == RTC_IT_WUT) || ((IT) == RTC_IT_ALRB) || ((IT) == RTC_IT_ALRA) \

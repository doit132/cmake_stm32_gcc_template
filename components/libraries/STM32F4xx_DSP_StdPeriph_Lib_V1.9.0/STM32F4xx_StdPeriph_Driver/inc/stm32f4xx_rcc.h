...
typedef struct {
  ...
  */
        ...
        #define IS_RCC_PLLSAI_DIVR_VALUE(VALUE)                                       \
                (((VALUE) == RCC_PLLSAIDivR_Div2) || ((VALUE) == RCC_PLLSAIDivR_Div4) \
                 || ((VALUE) == RCC_PLLSAIDivR_Div8) || ((VALUE) == RCC_PLLSAIDivR_Div16))
        /**
  * @}
  */
  ...
  */
                ...
                #define IS_RCC_SYSCLK_SOURCE(SOURCE)                                              \
                        (((SOURCE) == RCC_SYSCLKSource_HSI) || ((SOURCE) == RCC_SYSCLKSource_HSE) \
                         || ((SOURCE) == RCC_SYSCLKSource_PLLPCLK) || ((SOURCE) == RCC_SYSCLKSource_PLLRCLK))
...
/**
  ...
  */
                ...
                #define IS_RCC_LPTIM1_CLOCKSOURCE(SOURCE)                                                \
                        (((SOURCE) == RCC_LPTIM1CLKSOURCE_PCLK) || ((SOURCE) == RCC_LPTIM1CLKSOURCE_HSI) \
  ...
  */
                ...
                #define IS_RCC_I2SCLK_SOURCE(SOURCE)                                                 \
                        (((SOURCE) == RCC_I2SCLKSource_PLLI2S) || ((SOURCE) == RCC_I2SCLKSource_Ext) \
  ...
  */
                        ...
                        #define IS_RCC_SAICLK_SOURCE(SOURCE)                                                    \
                                (((SOURCE) == RCC_SAICLKSource_PLLSAI) || ((SOURCE) == RCC_SAICLKSource_PLLI2S) \
  ...
  */
                        ...
                        #define IS_RCC_SAI_INSTANCE(BUS) \
                                (((BUS) == RCC_SAIInstance_SAI1) || ((BUS) == RCC_SAIInstance_SAI2))
                /**
  * @}
  */
                #endif /* STM32F446xx */
  ...
  */
                        ...
                        #define IS_RCC_SAIACLK_SOURCE(SOURCE)                                                        \
                                (((SOURCE) == RCC_SAIACLKSource_PLLI2S_R) || ((SOURCE) == RCC_SAIACLKSource_I2SCKIN) \
  ...
  */
                        ...
                        #define IS_RCC_SAIBCLK_SOURCE(SOURCE)                                                        \
                                (((SOURCE) == RCC_SAIBCLKSource_PLLI2S_R) || ((SOURCE) == RCC_SAIBCLKSource_I2SCKIN) \
  ...
  */
        ...
        #if defined(STM32F40_41xxx) || defined(STM32F427_437xx) || defined(STM32F429_439xx) || defined(STM32F401xx) \
                || defined(STM32F411xE) || defined(STM32F469_479xx)
                /** @defgroup RCC_I2S_Clock_Source
  * @{
  */
                ...
                #define IS_RCC_I2SCLK_SOURCE(SOURCE) \
                        (((SOURCE) == RCC_I2S2CLKSource_PLLI2S) || ((SOURCE) == RCC_I2S2CLKSource_Ext))
                /**
  * @}
  */
  ...
  */
                ...
                #define IS_RCC_SAIACLK_SOURCE(SOURCE)                                                     \
                        (((SOURCE) == RCC_SAIACLKSource_PLLI2S) || ((SOURCE) == RCC_SAIACLKSource_PLLSAI) \
  ...
  */
                ...
                #define IS_RCC_SAIBCLK_SOURCE(SOURCE)                                                     \
                        (((SOURCE) == RCC_SAIBCLKSource_PLLI2S) || ((SOURCE) == RCC_SAIBCLKSource_PLLSAI) \
...
/**
  ...
  */
                ...
                #define IS_RCC_DSI_CLOCKSOURCE(CLKSOURCE) \
                        (((CLKSOURCE) == RCC_DSICLKSource_PHY) || ((CLKSOURCE) == RCC_DSICLKSource_PLLR))
        /**
  * @}
  */
  ...
  */
                ...
                #define IS_RCC_SDIO_CLOCKSOURCE(CLKSOURCE) \
                        (((CLKSOURCE) == RCC_SDIOCLKSource_48MHZ) || ((CLKSOURCE) == RCC_SDIOCLKSource_SYSCLK))
                /**
  * @}
  */
  ...
  */
                        ...
                        #define IS_RCC_48MHZ_CLOCKSOURCE(CLKSOURCE) \
                                (((CLKSOURCE) == RCC_48MHZCLKSource_PLL) || ((CLKSOURCE) == RCC_48MHZCLKSource_PLLSAI))
                #endif /* STM32F446xx || STM32F469_479xx */
                #if defined(STM32F412xG) || defined(STM32F413_423xx)
                        #define RCC_CK48CLKSOURCE_PLLQ ((uint8_t)0x00)
                        #define RCC_CK48CLKSOURCE_PLLI2SQ \
                                ((uint8_t)0x01) /* Only for STM32F412xG and STM32F413_423xx Devices */
                        #define IS_RCC_48MHZ_CLOCKSOURCE(CLKSOURCE) \
                                (((CLKSOURCE) == RCC_CK48CLKSOURCE_PLLQ) || ((CLKSOURCE) == RCC_CK48CLKSOURCE_PLLI2SQ))
  ...
  */
                ...
                #define IS_RCC_SPDIFRX_CLOCKSOURCE(CLKSOURCE) \
                        (((CLKSOURCE) == RCC_SPDIFRXCLKSource_PLLR) || ((CLKSOURCE) == RCC_SPDIFRXCLKSource_PLLI2SP))
                /**
  * @}
  */
  ...
  */
                ...
                #define IS_RCC_CEC_CLOCKSOURCE(CLKSOURCE) \
                        (((CLKSOURCE) == RCC_CECCLKSource_HSIDiv488) || ((CLKSOURCE) == RCC_CECCLKSource_LSE))
                /**
  * @}
  */
  ...
  */
                ...
                #define IS_RCC_FMPI2C1_CLOCKSOURCE(SOURCE)                                                    \
                        (((SOURCE) == RCC_FMPI2C1CLKSource_APB1) || ((SOURCE) == RCC_FMPI2C1CLKSource_SYSCLK) \
 ...
 */
                ...
                #define IS_RCC_DFSDMCLK_SOURCE(SOURCE) \
                        (((SOURCE) == RCC_DFSDMCLKSource_APB) || ((SOURCE) == RCC_DFSDMCLKSource_SYS))
  ...
  */
                ...
                #define IS_RCC_DFSDM1ACLK_SOURCE(SOURCE)                \
                        (((SOURCE) == RCC_DFSDM1AUDIOCLKSOURCE_I2SAPB1) \
                         || ((SOURCE) == RCC_DFSDM1AUDIOCLKSOURCE_I2SAPB2))
  ...
  */
                        ...
                        #define IS_RCC_DFSDM2ACLK_SOURCE(SOURCE)                \
                                (((SOURCE) == RCC_DFSDM2AUDIOCLKSOURCE_I2SAPB1) \
                                 || ((SOURCE) == RCC_DFSDM2AUDIOCLKSOURCE_I2SAPB2))
                /**
  * @}
  */
                #endif /* STM32F413_423xx */
  ...
  */
        ...
        #if defined(STM32F40_41xxx) || defined(STM32F412xG) || defined(STM32F413_423xx) || defined(STM32F427_437xx) \
                || defined(STM32F429_439xx) || defined(STM32F469_479xx)
  ...
  */
        ...
        #define IS_RCC_MCO1DIV(DIV)                                                               \
                (((DIV) == RCC_MCO1Div_1) || ((DIV) == RCC_MCO1Div_2) || ((DIV) == RCC_MCO1Div_3) \
                 || ((DIV) == RCC_MCO1Div_4) || ((DIV) == RCC_MCO1Div_5))
        /**
  * @}
  */
  ...
  */
        ...
        #define IS_RCC_MCO2DIV(DIV)                                                               \
                (((DIV) == RCC_MCO2Div_1) || ((DIV) == RCC_MCO2Div_2) || ((DIV) == RCC_MCO2Div_3) \
                 || ((DIV) == RCC_MCO2Div_4) || ((DIV) == RCC_MCO2Div_5))
        /**
  * @}
  */
  ...
  */
        ...
        #define IS_RCC_FLAG(FLAG)                                                                                \
                (((FLAG) == RCC_FLAG_HSIRDY) || ((FLAG) == RCC_FLAG_HSERDY) || ((FLAG) == RCC_FLAG_PLLRDY)       \
                 || ((FLAG) == RCC_FLAG_LSERDY) || ((FLAG) == RCC_FLAG_LSIRDY) || ((FLAG) == RCC_FLAG_BORRST)    \

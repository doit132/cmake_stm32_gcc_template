 ...
 */
		...
		#define IS_RCC_SYSCLK_SOURCE(SOURCE)                                               \
		  ...
		  STM32F410xx || STM32F411xE || STM32F469_479xx */
	/**
	 * @}
	 */
 ...
 */
		...
		#define RCC_I2SCLKSource_HSI_HSE                                                   \
			((uint32_t)RCC_DCKCFGR_I2S1SRC_0 | RCC_DCKCFGR_I2S1SRC_1)
		...
		#define IS_RCC_I2S_APBx(BUS)                                                       \
			(((BUS) == RCC_I2SBus_APB1) || ((BUS) == RCC_I2SBus_APB2))
		/**
		 * @}
		 */
		#if defined(STM32F446xx)
			...
			#define RCC_SAICLKSource_HSI_HSE                                           \
				((uint32_t)RCC_DCKCFGR_SAI1SRC_0 | RCC_DCKCFGR_SAI1SRC_1)

			#define IS_RCC_SAICLK_SOURCE(SOURCE)                                       \
				(((SOURCE) == RCC_SAICLKSource_PLLSAI) ||                          \
		 ...
		 */
			...
			#define RCC_SAIACLKSource_HSI_HSE                                          \
				((uint32_t)RCC_DCKCFGR_SAI1ASRC_0 | RCC_DCKCFGR_SAI1ASRC_1)

			#define IS_RCC_SAIACLK_SOURCE(SOURCE)                                      \
				(((SOURCE) == RCC_SAIACLKSource_PLLI2S_R) ||                       \
				 ((SOURCE) == RCC_SAIACLKSource_I2SCKIN) ||                        \
				 ((SOURCE) == RCC_SAIACLKSource_PLLR) ||                           \
				 ((SOURCE) == RCC_SAIACLKSource_HSI_HSE))
			/**
			 * @}
			 */
			...
			#define RCC_SAIBCLKSource_HSI_HSE                                          \
				((uint32_t)RCC_DCKCFGR_SAI1BSRC_0 | RCC_DCKCFGR_SAI1BSRC_1)

			#define IS_RCC_SAIBCLK_SOURCE(SOURCE)                                      \
				(((SOURCE) == RCC_SAIBCLKSource_PLLI2S_R) ||                       \
				 ((SOURCE) == RCC_SAIBCLKSource_I2SCKIN) ||                        \
				 ((SOURCE) == RCC_SAIBCLKSource_PLLR) ||                           \
				 ((SOURCE) == RCC_SAIBCLKSource_HSI_HSE))
		/**
		 * @}
		 */
		#endif /* STM32F413_423xx */
 ...
 */
		...
		#define IS_RCC_DSI_CLOCKSOURCE(CLKSOURCE)                                          \
			(((CLKSOURCE) == RCC_DSICLKSource_PHY) ||                                  \
	 ...
	 */
		...
		#define IS_RCC_SDIO_CLOCKSOURCE(CLKSOURCE)                                         \
			(((CLKSOURCE) == RCC_SDIOCLKSource_48MHZ) ||                               \
		 ...
		 */
			...
			#define IS_RCC_48MHZ_CLOCKSOURCE(CLKSOURCE)                                \
				(((CLKSOURCE) == RCC_48MHZCLKSource_PLL) ||                        \
			...
			#define RCC_CK48CLKSOURCE_PLLI2SQ                                          \
				((uint8_t)0x01) /* Only for STM32F412xG and STM32F413_423xx        \
						   Devices */
			#define IS_RCC_48MHZ_CLOCKSOURCE(CLKSOURCE)                                \
				(((CLKSOURCE) == RCC_CK48CLKSOURCE_PLLQ) ||                        \
	 ...
	 */
		...
		#define IS_RCC_SPDIFRX_CLOCKSOURCE(CLKSOURCE)                                      \
			(((CLKSOURCE) == RCC_SPDIFRXCLKSource_PLLR) ||                             \
		...
		#define IS_RCC_CEC_CLOCKSOURCE(CLKSOURCE)                                          \
			(((CLKSOURCE) == RCC_CECCLKSource_HSIDiv488) ||                            \
		...
		#define IS_RCC_AHB1_CLOCKGATING(PERIPH)                                            \
	 ...
	 */
		...
		#define IS_RCC_FMPI2C1_CLOCKSOURCE(SOURCE)                                         \
			(((SOURCE) == RCC_FMPI2C1CLKSource_APB1) ||                                \
	 ...
	 */
		...
		#define IS_RCC_DFSDMCLK_SOURCE(SOURCE)                                             \
			(((SOURCE) == RCC_DFSDMCLKSource_APB) ||                                   \
			 ((SOURCE) == RCC_DFSDMCLKSource_SYS))
	...
	#define RCC_AHB2Periph_HASH ((uint32_t)0x00000020)
		...
		defined(STM32F427_437xx) || defined(STM32F429_439xx) || defined(STM32F469_479xx)
	...
	#define IS_RCC_MCO1DIV(DIV)                                                                \
		(((DIV) == RCC_MCO1Div_1) || ((DIV) == RCC_MCO1Div_2) ||                           \
		 ((DIV) == RCC_MCO1Div_3) || ((DIV) == RCC_MCO1Div_4) || ((DIV) == RCC_MCO1Div_5))
	/**
	 * @}
	 */
	...
	#define IS_RCC_MCO2DIV(DIV)                                                                \
		(((DIV) == RCC_MCO2Div_1) || ((DIV) == RCC_MCO2Div_2) ||                           \
		 ((DIV) == RCC_MCO2Div_3) || ((DIV) == RCC_MCO2Div_4) || ((DIV) == RCC_MCO2Div_5))
	/**
	 * @}
	 */
...
void RCC_DSIClockSourceConfig(uint8_t RCC_ClockSource);
	...
	/* Features available only for STM32F412xG/STM32F413_423xx/STM32F446xx/STM32F469_479xx
	 * devices */
	#if defined(STM32F412xG) || defined(STM32F413_423xx) || defined(STM32F446xx) ||            \
		defined(STM32F469_479xx)

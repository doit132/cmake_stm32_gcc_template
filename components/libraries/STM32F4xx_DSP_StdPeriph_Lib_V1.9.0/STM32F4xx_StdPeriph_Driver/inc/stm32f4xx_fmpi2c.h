...
typedef struct {
  ...
  */
        ...
        #define IS_FMPI2C_ANALOG_FILTER(FILTER) \
                (((FILTER) == FMPI2C_AnalogFilter_Enable) || ((FILTER) == FMPI2C_AnalogFilter_Disable))
        /**
  * @}
  */
  ...
  */
        ...
        #define IS_FMPI2C_ACKNOWLEDGE_ADDRESS(ADDRESS) \
                (((ADDRESS) == FMPI2C_AcknowledgedAddress_7bit) || ((ADDRESS) == FMPI2C_AcknowledgedAddress_10bit))
        /**
  * @}
  */
  ...
  */
        ...
        #define IS_FMPI2C_DIRECTION(DIRECTION) \
                (((DIRECTION) == FMPI2C_Direction_Transmitter) || ((DIRECTION) == FMPI2C_Direction_Receiver))
        /**
  * @}
  */
  ...
  */
        ...
        #define IS_FMPI2C_OWN_ADDRESS2_MASK(MASK)                                                                   \
                (((MASK) == FMPI2C_OA2_NoMask) || ((MASK) == FMPI2C_OA2_Mask01) || ((MASK) == FMPI2C_OA2_Mask02)    \
                 || ((MASK) == FMPI2C_OA2_Mask03) || ((MASK) == FMPI2C_OA2_Mask04) || ((MASK) == FMPI2C_OA2_Mask05) \
                 || ((MASK) == FMPI2C_OA2_Mask06) || ((MASK) == FMPI2C_OA2_Mask07))
  ...
  */
        ...
        #define IS_FMPI2C_REGISTER(REGISTER)                                                            \
                (((REGISTER) == FMPI2C_Register_CR1) || ((REGISTER) == FMPI2C_Register_CR2)             \
                 || ((REGISTER) == FMPI2C_Register_OAR1) || ((REGISTER) == FMPI2C_Register_OAR2)        \
                 || ((REGISTER) == FMPI2C_Register_TIMINGR) || ((REGISTER) == FMPI2C_Register_TIMEOUTR) \
                 || ((REGISTER) == FMPI2C_Register_ISR) || ((REGISTER) == FMPI2C_Register_ICR)          \
                 || ((REGISTER) == FMPI2C_Register_PECR) || ((REGISTER) == FMPI2C_Register_RXDR)        \
  ...
  */
        ...
        #define IS_FMPI2C_GET_FLAG(FLAG)                                                                           \
                (((FLAG) == FMPI2C_FLAG_TXE) || ((FLAG) == FMPI2C_FLAG_TXIS) || ((FLAG) == FMPI2C_FLAG_RXNE)       \
                 || ((FLAG) == FMPI2C_FLAG_ADDR) || ((FLAG) == FMPI2C_FLAG_NACKF) || ((FLAG) == FMPI2C_FLAG_STOPF) \
                 || ((FLAG) == FMPI2C_FLAG_TC) || ((FLAG) == FMPI2C_FLAG_TCR) || ((FLAG) == FMPI2C_FLAG_BERR)      \
                 || ((FLAG) == FMPI2C_FLAG_ARLO) || ((FLAG) == FMPI2C_FLAG_OVR) || ((FLAG) == FMPI2C_FLAG_PECERR)  \
                 || ((FLAG) == FMPI2C_FLAG_TIMEOUT) || ((FLAG) == FMPI2C_FLAG_ALERT) || ((FLAG) == FMPI2C_FLAG_BUSY))
  ...
  */
        ...
        #define IS_FMPI2C_GET_IT(IT)                                                                     \
                (((IT) == FMPI2C_IT_TXIS) || ((IT) == FMPI2C_IT_RXNE) || ((IT) == FMPI2C_IT_ADDR)        \
                 || ((IT) == FMPI2C_IT_NACKF) || ((IT) == FMPI2C_IT_STOPF) || ((IT) == FMPI2C_IT_TC)     \
                 || ((IT) == FMPI2C_IT_TCR) || ((IT) == FMPI2C_IT_BERR) || ((IT) == FMPI2C_IT_ARLO)      \
                 || ((IT) == FMPI2C_IT_OVR) || ((IT) == FMPI2C_IT_PECERR) || ((IT) == FMPI2C_IT_TIMEOUT) \
                 || ((IT) == FMPI2C_IT_ALERT))
  ...
  */
        ...
        #define IS_RELOAD_END_MODE(MODE) \
                (((MODE) == FMPI2C_Reload_Mode) || ((MODE) == FMPI2C_AutoEnd_Mode) || ((MODE) == FMPI2C_SoftEnd_Mode))
  ...
  */
        ...
        #define IS_START_STOP_MODE(MODE)                                                    \
                (((MODE) == FMPI2C_Generate_Stop) || ((MODE) == FMPI2C_Generate_Start_Read) \
...
void     FMPI2C_TransferHandling(FMPI2C_TypeDef* FMPI2Cx,
                                 uint16_t        Address,

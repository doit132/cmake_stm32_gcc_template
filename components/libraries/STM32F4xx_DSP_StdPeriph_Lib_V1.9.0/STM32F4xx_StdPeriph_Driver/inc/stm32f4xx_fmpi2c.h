...
typedef struct {
	uint32_t FMPI2C_Timing; /*!< Specifies the FMPI2C_TIMINGR_register value.
					 This parameter calculated by referring to FMPI2C
	...
	uint32_t FMPI2C_Ack; /*!< Enables or disables the acknowledgement.
				...
				FMPI2C_acknowledgement */

	uint32_t FMPI2C_AcknowledgedAddress; /*!< Specifies if 7-bit or 10-bit address is
					 acknowledged. This parameter can be a value of @ref
					 FMPI2C_acknowledged_address */
} FMPI2C_InitTypeDef;
	...
	#define IS_FMPI2C_ACKNOWLEDGE_ADDRESS(ADDRESS)                                             \
		(((ADDRESS) == FMPI2C_AcknowledgedAddress_7bit) ||                                 \
	...
	#define IS_FMPI2C_OWN_ADDRESS2_MASK(MASK)                                                  \
		(((MASK) == FMPI2C_OA2_NoMask) || ((MASK) == FMPI2C_OA2_Mask01) ||                 \
		 ((MASK) == FMPI2C_OA2_Mask02) || ((MASK) == FMPI2C_OA2_Mask03) ||                 \
		 ((MASK) == FMPI2C_OA2_Mask04) || ((MASK) == FMPI2C_OA2_Mask05) ||                 \
	...
	#define IS_FMPI2C_GET_FLAG(FLAG)                                                           \
		(((FLAG) == FMPI2C_FLAG_TXE) || ((FLAG) == FMPI2C_FLAG_TXIS) ||                    \
	...
	#define IS_FMPI2C_GET_IT(IT)                                                               \
		(((IT) == FMPI2C_IT_TXIS) || ((IT) == FMPI2C_IT_RXNE) ||                           \
		 ((IT) == FMPI2C_IT_ADDR) || ((IT) == FMPI2C_IT_NACKF) ||                          \
		 ((IT) == FMPI2C_IT_STOPF) || ((IT) == FMPI2C_IT_TC) || ((IT) == FMPI2C_IT_TCR) || \
		 ((IT) == FMPI2C_IT_BERR) || ((IT) == FMPI2C_IT_ARLO) ||                           \
		 ((IT) == FMPI2C_IT_OVR) || ((IT) == FMPI2C_IT_PECERR) ||                          \
		 ((IT) == FMPI2C_IT_TIMEOUT) || ((IT) == FMPI2C_IT_ALERT))
	...
	#define IS_RELOAD_END_MODE(MODE)                                                           \
		(((MODE) == FMPI2C_Reload_Mode) || ((MODE) == FMPI2C_AutoEnd_Mode) ||              \
...
void FMPI2C_TransferHandling(FMPI2C_TypeDef *FMPI2Cx, uint16_t Address, uint8_t Number_Bytes,

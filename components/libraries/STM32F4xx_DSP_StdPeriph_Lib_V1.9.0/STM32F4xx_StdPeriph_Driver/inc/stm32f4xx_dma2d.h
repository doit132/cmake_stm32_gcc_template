...
/** @defgroup DMA2D_MODE 
  ...
  */
        ...
        #define IS_DMA2D_MODE(MODE)                                                                \
                (((MODE) == DMA2D_M2M) || ((MODE) == DMA2D_M2M_PFC) || ((MODE) == DMA2D_M2M_BLEND) \
                 || ((MODE) == DMA2D_R2M))
  ...
  */
        ...
        #define IS_DMA2D_CMODE(MODE_ARGB)                                                                          \
                (((MODE_ARGB) == DMA2D_ARGB8888) || ((MODE_ARGB) == DMA2D_RGB888) || ((MODE_ARGB) == DMA2D_RGB565) \
                 || ((MODE_ARGB) == DMA2D_ARGB1555) || ((MODE_ARGB) == DMA2D_ARGB4444))
...
/** @defgroup DMA2D_FGCM
  ...
  */
        ...
        #define IS_DMA2D_FGCM(FGCM)                                                                                   \
                (((FGCM) == CM_ARGB8888) || ((FGCM) == CM_RGB888) || ((FGCM) == CM_RGB565) || ((FGCM) == CM_ARGB1555) \
                 || ((FGCM) == CM_ARGB4444) || ((FGCM) == CM_L8) || ((FGCM) == CM_AL44) || ((FGCM) == CM_AL88)        \
                 || ((FGCM) == CM_L4) || ((FGCM) == CM_A8) || ((FGCM) == CM_A4))

        #define IS_DMA2D_BGCM(BGCM)                                                                                   \
                (((BGCM) == CM_ARGB8888) || ((BGCM) == CM_RGB888) || ((BGCM) == CM_RGB565) || ((BGCM) == CM_ARGB1555) \
                 || ((BGCM) == CM_ARGB4444) || ((BGCM) == CM_L8) || ((BGCM) == CM_AL44) || ((BGCM) == CM_AL88)        \
                 || ((BGCM) == CM_L4) || ((BGCM) == CM_A8) || ((BGCM) == CM_A4))
...
/** DMA2D_FGPFC_ALPHA_MODE
  ...
  */
        ...
        #define IS_DMA2D_FG_ALPHA_MODE(FG_ALPHA_MODE)                                                  \
                (((FG_ALPHA_MODE) == NO_MODIF_ALPHA_VALUE) || ((FG_ALPHA_MODE) == REPLACE_ALPHA_VALUE) \
...
/** @defgroup DMA2D_Interrupts 
  ...
  */
        ...
        #define IS_DMA2D_IT(IT)                                                                                     \
                (((IT) == DMA2D_IT_CTC) || ((IT) == DMA2D_IT_CAE) || ((IT) == DMA2D_IT_TW) || ((IT) == DMA2D_IT_TC) \
...
/** @defgroup DMA2D_Flag 
  ...
  */
        ...
        #define IS_DMA2D_GET_FLAG(FLAG)                                                                \
                (((FLAG) == DMA2D_FLAG_CTC) || ((FLAG) == DMA2D_FLAG_CAE) || ((FLAG) == DMA2D_FLAG_TW) \
                 || ((FLAG) == DMA2D_FLAG_TC) || ((FLAG) == DMA2D_FLAG_TE) || ((FLAG) == DMA2D_FLAG_CE))

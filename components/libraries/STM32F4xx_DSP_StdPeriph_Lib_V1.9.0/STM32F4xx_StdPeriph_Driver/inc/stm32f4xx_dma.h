...
typedef struct {
        ...
        uint32_t
                DMA_PeripheralInc; /*!< Specifies whether the Peripheral address register should be incremented or not.
...
/** @defgroup DMA_Exported_Constants
  ...
  */
        ...
        #define IS_DMA_ALL_PERIPH(PERIPH)                                                                  \
                (((PERIPH) == DMA1_Stream0) || ((PERIPH) == DMA1_Stream1) || ((PERIPH) == DMA1_Stream2)    \
                 || ((PERIPH) == DMA1_Stream3) || ((PERIPH) == DMA1_Stream4) || ((PERIPH) == DMA1_Stream5) \
                 || ((PERIPH) == DMA1_Stream6) || ((PERIPH) == DMA1_Stream7) || ((PERIPH) == DMA2_Stream0) \
                 || ((PERIPH) == DMA2_Stream1) || ((PERIPH) == DMA2_Stream2) || ((PERIPH) == DMA2_Stream3) \
                 || ((PERIPH) == DMA2_Stream4) || ((PERIPH) == DMA2_Stream5) || ((PERIPH) == DMA2_Stream6) \
                 || ((PERIPH) == DMA2_Stream7))
  ...
  */
        ...
        #define IS_DMA_DIRECTION(DIRECTION)                                                                 \
                (((DIRECTION) == DMA_DIR_PeripheralToMemory) || ((DIRECTION) == DMA_DIR_MemoryToPeripheral) \
  ...
  */
        ...
        #define IS_DMA_FIFO_THRESHOLD(THRESHOLD)                                                                \
                (((THRESHOLD) == DMA_FIFOThreshold_1QuarterFull) || ((THRESHOLD) == DMA_FIFOThreshold_HalfFull) \
                 || ((THRESHOLD) == DMA_FIFOThreshold_3QuartersFull) || ((THRESHOLD) == DMA_FIFOThreshold_Full))
        /**
  * @}
  */
  ...
  */
        ...
        #define IS_DMA_PERIPHERAL_BURST(BURST)                                                    \
                (((BURST) == DMA_PeripheralBurst_Single) || ((BURST) == DMA_PeripheralBurst_INC4) \
  ...
  */
        ...
        #define IS_DMA_FIFO_STATUS(STATUS)                                                                  \
                (((STATUS) == DMA_FIFOStatus_Less1QuarterFull) || ((STATUS) == DMA_FIFOStatus_HalfFull)     \
                 || ((STATUS) == DMA_FIFOStatus_1QuarterFull) || ((STATUS) == DMA_FIFOStatus_3QuartersFull) \
  ...
  */
        ...
        #define IS_DMA_CLEAR_FLAG(FLAG)                                                                             \
                ((((FLAG)&0x30000000) != 0x30000000) && (((FLAG)&0x30000000) != 0) && (((FLAG)&0xC002F082) == 0x00) \
                 && ((FLAG) != 0x00))

        #define IS_DMA_GET_FLAG(FLAG)                                                                       \
                (((FLAG) == DMA_FLAG_TCIF0) || ((FLAG) == DMA_FLAG_HTIF0) || ((FLAG) == DMA_FLAG_TEIF0)     \
                 || ((FLAG) == DMA_FLAG_DMEIF0) || ((FLAG) == DMA_FLAG_FEIF0) || ((FLAG) == DMA_FLAG_TCIF1) \
                 || ((FLAG) == DMA_FLAG_HTIF1) || ((FLAG) == DMA_FLAG_TEIF1) || ((FLAG) == DMA_FLAG_DMEIF1) \
                 || ((FLAG) == DMA_FLAG_FEIF1) || ((FLAG) == DMA_FLAG_TCIF2) || ((FLAG) == DMA_FLAG_HTIF2)  \
                 || ((FLAG) == DMA_FLAG_TEIF2) || ((FLAG) == DMA_FLAG_DMEIF2) || ((FLAG) == DMA_FLAG_FEIF2) \
                 || ((FLAG) == DMA_FLAG_TCIF3) || ((FLAG) == DMA_FLAG_HTIF3) || ((FLAG) == DMA_FLAG_TEIF3)  \
                 || ((FLAG) == DMA_FLAG_DMEIF3) || ((FLAG) == DMA_FLAG_FEIF3) || ((FLAG) == DMA_FLAG_TCIF4) \
                 || ((FLAG) == DMA_FLAG_HTIF4) || ((FLAG) == DMA_FLAG_TEIF4) || ((FLAG) == DMA_FLAG_DMEIF4) \
                 || ((FLAG) == DMA_FLAG_FEIF4) || ((FLAG) == DMA_FLAG_TCIF5) || ((FLAG) == DMA_FLAG_HTIF5)  \
                 || ((FLAG) == DMA_FLAG_TEIF5) || ((FLAG) == DMA_FLAG_DMEIF5) || ((FLAG) == DMA_FLAG_FEIF5) \
                 || ((FLAG) == DMA_FLAG_TCIF6) || ((FLAG) == DMA_FLAG_HTIF6) || ((FLAG) == DMA_FLAG_TEIF6)  \
                 || ((FLAG) == DMA_FLAG_DMEIF6) || ((FLAG) == DMA_FLAG_FEIF6) || ((FLAG) == DMA_FLAG_TCIF7) \
                 || ((FLAG) == DMA_FLAG_HTIF7) || ((FLAG) == DMA_FLAG_TEIF7) || ((FLAG) == DMA_FLAG_DMEIF7) \
                 || ((FLAG) == DMA_FLAG_FEIF7))
        /**
  * @}
  */
  ...
  */
        ...
        #define IS_DMA_CLEAR_IT(IT)                                                              \
                ((((IT)&0x30000000) != 0x30000000) && (((IT)&0x30000000) != 0) && ((IT) != 0x00) \
                 && (((IT)&0x40820082) == 0x00))

        #define IS_DMA_GET_IT(IT)                                                                                      \
                (((IT) == DMA_IT_TCIF0) || ((IT) == DMA_IT_HTIF0) || ((IT) == DMA_IT_TEIF0) || ((IT) == DMA_IT_DMEIF0) \
                 || ((IT) == DMA_IT_FEIF0) || ((IT) == DMA_IT_TCIF1) || ((IT) == DMA_IT_HTIF1)                         \
                 || ((IT) == DMA_IT_TEIF1) || ((IT) == DMA_IT_DMEIF1) || ((IT) == DMA_IT_FEIF1)                        \
                 || ((IT) == DMA_IT_TCIF2) || ((IT) == DMA_IT_HTIF2) || ((IT) == DMA_IT_TEIF2)                         \
                 || ((IT) == DMA_IT_DMEIF2) || ((IT) == DMA_IT_FEIF2) || ((IT) == DMA_IT_TCIF3)                        \
                 || ((IT) == DMA_IT_HTIF3) || ((IT) == DMA_IT_TEIF3) || ((IT) == DMA_IT_DMEIF3)                        \
                 || ((IT) == DMA_IT_FEIF3) || ((IT) == DMA_IT_TCIF4) || ((IT) == DMA_IT_HTIF4)                         \
                 || ((IT) == DMA_IT_TEIF4) || ((IT) == DMA_IT_DMEIF4) || ((IT) == DMA_IT_FEIF4)                        \
                 || ((IT) == DMA_IT_TCIF5) || ((IT) == DMA_IT_HTIF5) || ((IT) == DMA_IT_TEIF5)                         \
                 || ((IT) == DMA_IT_DMEIF5) || ((IT) == DMA_IT_FEIF5) || ((IT) == DMA_IT_TCIF6)                        \
                 || ((IT) == DMA_IT_HTIF6) || ((IT) == DMA_IT_TEIF6) || ((IT) == DMA_IT_DMEIF6)                        \
                 || ((IT) == DMA_IT_FEIF6) || ((IT) == DMA_IT_TCIF7) || ((IT) == DMA_IT_HTIF7)                         \
                 || ((IT) == DMA_IT_TEIF7) || ((IT) == DMA_IT_DMEIF7) || ((IT) == DMA_IT_FEIF7))
        /**
  * @}
  */

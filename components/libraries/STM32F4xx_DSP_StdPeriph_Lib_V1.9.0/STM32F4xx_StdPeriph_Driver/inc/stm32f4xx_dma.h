...
typedef struct {
	...
	uint32_t DMA_PeripheralBaseAddr; /*!< Specifies the peripheral base address for DMAy
					    Streamx. */

	uint32_t DMA_Memory0BaseAddr; /*!< Specifies the memory 0 base address for DMAy Streamx.
					This memory is the default memory used when double buffer
					mode is not enabled. */
	...
	uint32_t DMA_BufferSize; /*!< Specifies the buffer size, in data unit, of the specified
				    Stream. The data unit is equal to the configuration set in
				    DMA_PeripheralDataSize or DMA_MemoryDataSize members depending
				    in the transfer direction. */

	uint32_t DMA_PeripheralInc; /*!< Specifies whether the Peripheral address register should be
				       incremented or not. This parameter can be a value of @ref
				       DMA_peripheral_incremented_mode */

	uint32_t DMA_MemoryInc; /*!< Specifies whether the memory address register should be
				   incremented or not. This parameter can be a value of @ref
	...
	uint32_t
		DMA_MemoryDataSize; /*!< Specifies the Memory data width.
	...
	uint32_t DMA_FIFOMode; /*!< Specifies if the FIFO mode or Direct mode will be used for the
	...
	uint32_t DMA_MemoryBurst; /*!< Specifies the Burst transfer configuration for the memory
				     transfers. It specifies the amount of data to be transferred in
				     a single non interruptable transaction. This parameter can be a
				     value of @ref DMA_memory_burst
					@note The burst mode is possible only if the address
				     Increment mode is enabled. */

	uint32_t DMA_PeripheralBurst; /*!< Specifies the Burst transfer configuration for the
					peripheral transfers. It specifies the amount of data to be
					transferred in a single non interruptable transaction. This
 ...
 */
	...
	#define IS_DMA_PERIPHERAL_BURST(BURST)                                                     \
		(((BURST) == DMA_PeripheralBurst_Single) ||                                        \
		 ((BURST) == DMA_PeripheralBurst_INC4) || ((BURST) == DMA_PeripheralBurst_INC8) || \
	...
	#define IS_DMA_GET_IT(IT)                                                                  \
		(((IT) == DMA_IT_TCIF0) || ((IT) == DMA_IT_HTIF0) || ((IT) == DMA_IT_TEIF0) ||     \
		 ((IT) == DMA_IT_DMEIF0) || ((IT) == DMA_IT_FEIF0) || ((IT) == DMA_IT_TCIF1) ||    \
		 ((IT) == DMA_IT_HTIF1) || ((IT) == DMA_IT_TEIF1) || ((IT) == DMA_IT_DMEIF1) ||    \
		 ((IT) == DMA_IT_FEIF1) || ((IT) == DMA_IT_TCIF2) || ((IT) == DMA_IT_HTIF2) ||     \
		 ((IT) == DMA_IT_TEIF2) || ((IT) == DMA_IT_DMEIF2) || ((IT) == DMA_IT_FEIF2) ||    \
		 ((IT) == DMA_IT_TCIF3) || ((IT) == DMA_IT_HTIF3) || ((IT) == DMA_IT_TEIF3) ||     \
		 ((IT) == DMA_IT_DMEIF3) || ((IT) == DMA_IT_FEIF3) || ((IT) == DMA_IT_TCIF4) ||    \
		 ((IT) == DMA_IT_HTIF4) || ((IT) == DMA_IT_TEIF4) || ((IT) == DMA_IT_DMEIF4) ||    \
		 ((IT) == DMA_IT_FEIF4) || ((IT) == DMA_IT_TCIF5) || ((IT) == DMA_IT_HTIF5) ||     \
		 ((IT) == DMA_IT_TEIF5) || ((IT) == DMA_IT_DMEIF5) || ((IT) == DMA_IT_FEIF5) ||    \
		 ((IT) == DMA_IT_TCIF6) || ((IT) == DMA_IT_HTIF6) || ((IT) == DMA_IT_TEIF6) ||     \
		 ((IT) == DMA_IT_DMEIF6) || ((IT) == DMA_IT_FEIF6) || ((IT) == DMA_IT_TCIF7) ||    \
		 ((IT) == DMA_IT_HTIF7) || ((IT) == DMA_IT_TEIF7) || ((IT) == DMA_IT_DMEIF7) ||    \
		 ((IT) == DMA_IT_FEIF7))
	/**
	 * @}
	 */

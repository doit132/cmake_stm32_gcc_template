...
typedef struct {
  ...
  */
        ...
        #define IS_QSPI_CSHTIME(CSHTIME)                                                     \
                (((CSHTIME) == QSPI_CSHTime_1Cycle) || ((CSHTIME) == QSPI_CSHTime_2Cycle)    \
                 || ((CSHTIME) == QSPI_CSHTime_3Cycle) || ((CSHTIME) == QSPI_CSHTime_4Cycle) \
                 || ((CSHTIME) == QSPI_CSHTime_5Cycle) || ((CSHTIME) == QSPI_CSHTime_6Cycle) \
                 || ((CSHTIME) == QSPI_CSHTime_7Cycle) || ((CSHTIME) == QSPI_CSHTime_8Cycle))
        /**
  * @}
  */
  ...
  */
        ...
        #define IS_QSPI_FMODE(FMODE)                                                                                 \
                (((FMODE) == QSPI_ComConfig_FMode_Indirect_Write) || ((FMODE) == QSPI_ComConfig_FMode_Indirect_Read) \
                 || ((FMODE) == QSPI_ComConfig_FMode_Auto_Polling) || ((FMODE) == QSPI_ComConfig_FMode_Memory_Mapped))
        /**
  * @}
  */
  ...
  */
        ...
        #define IS_QSPI_DDRMODE(DDRMODE) \
                (((DDRMODE) == QSPI_ComConfig_DDRMode_Disable) || ((DDRMODE) == QSPI_ComConfig_DDRMode_Enable))
        /**
  * @}
  */
  ...
  */
        ...
        #define IS_QSPI_DHHC(DHHC)          (((DHHC) == QSPI_ComConfig_DHHC_Disable) || ((DHHC) == QSPI_ComConfig_DHHC_Enable))
        /**
  * @}
  */
  ...
  */
        ...
        #define IS_QSPI_SIOOMODE(SIOOMODE) \
                (((SIOOMODE) == QSPI_ComConfig_SIOOMode_Disable) || ((SIOOMODE) == QSPI_ComConfig_SIOOMode_Enable))
        /**
  * @}
  */
  ...
  */
        ...
        #define IS_QSPI_DMODE(DMODE)                                                                 \
                (((DMODE) == QSPI_ComConfig_DMode_NoData) || ((DMODE) == QSPI_ComConfig_DMode_1Line) \
                 || ((DMODE) == QSPI_ComConfig_DMode_2Line) || ((DMODE) == QSPI_ComConfig_DMode_4Line))
        /**
  * @}
  */
  ...
  */
        ...
        #define IS_QSPI_ABSIZE(ABSIZE)                                                                 \
                (((ABSIZE) == QSPI_ComConfig_ABSize_8bit) || ((ABSIZE) == QSPI_ComConfig_ABSize_16bit) \
                 || ((ABSIZE) == QSPI_ComConfig_ABSize_24bit) || ((ABSIZE) == QSPI_ComConfig_ABSize_32bit))
        /**
  * @}
  */
  ...
  */
        ...
        #define IS_QSPI_ABMODE(ABMODE)                                                                            \
                (((ABMODE) == QSPI_ComConfig_ABMode_NoAlternateByte) || ((ABMODE) == QSPI_ComConfig_ABMode_1Line) \
                 || ((ABMODE) == QSPI_ComConfig_ABMode_2Line) || ((ABMODE) == QSPI_ComConfig_ABMode_4Line))
        /**
  * @}
  */
  ...
  */
        ...
        #define IS_QSPI_ADSIZE(ADSIZE)                                                                 \
                (((ADSIZE) == QSPI_ComConfig_ADSize_8bit) || ((ADSIZE) == QSPI_ComConfig_ADSize_16bit) \
                 || ((ADSIZE) == QSPI_ComConfig_ADSize_24bit) || ((ADSIZE) == QSPI_ComConfig_ADSize_32bit))
        /**
  * @}
  */
  ...
  */
        ...
        #define IS_QSPI_ADMODE(ADMODE)                                                                      \
                (((ADMODE) == QSPI_ComConfig_ADMode_NoAddress) || ((ADMODE) == QSPI_ComConfig_ADMode_1Line) \
                 || ((ADMODE) == QSPI_ComConfig_ADMode_2Line) || ((ADMODE) == QSPI_ComConfig_ADMode_4Line))
        /**
  * @}
  */
  ...
  */
        ...
        #define IS_QSPI_IMODE(IMODE)                                                                        \
                (((IMODE) == QSPI_ComConfig_IMode_NoInstruction) || ((IMODE) == QSPI_ComConfig_IMode_1Line) \
                 || ((IMODE) == QSPI_ComConfig_IMode_2Line) || ((IMODE) == QSPI_ComConfig_IMode_4Line))
        /**
  * @}
  */
  ...
  */
        ...
        #define IS_QSPI_GET_FLAG(FLAG)                                                            \
                (((FLAG) == QSPI_FLAG_TO) || ((FLAG) == QSPI_FLAG_SM) || ((FLAG) == QSPI_FLAG_FT) \
                 || ((FLAG) == QSPI_FLAG_TC) || ((FLAG) == QSPI_FLAG_TE) || ((FLAG) == QSPI_FLAG_BUSY))
        #define IS_QSPI_CLEAR_FLAG(FLAG)                                                          \
                (((FLAG) == QSPI_FLAG_TO) || ((FLAG) == QSPI_FLAG_SM) || ((FLAG) == QSPI_FLAG_TC) \
                 || ((FLAG) == QSPI_FLAG_TE))

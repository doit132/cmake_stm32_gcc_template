...
typedef struct {
  ...
  */
        #define DSI_RGB565 \
                ((uint32_t)0x00000000) /*!< The values 0x00000001 and 0x00000002 can also be used for the RGB565 color mode configuration */
        #define DSI_RGB666 \
                ((uint32_t)0x00000003) /*!< The value 0x00000004 can also be used for the RGB666 color mode configuration                 */
  ...
  */
        ...
        #define IS_DSI_PLL_IDF(IDF)                                                                        \
                (((IDF) == DSI_PLL_IN_DIV1) || ((IDF) == DSI_PLL_IN_DIV2) || ((IDF) == DSI_PLL_IN_DIV3)    \
                 || ((IDF) == DSI_PLL_IN_DIV4) || ((IDF) == DSI_PLL_IN_DIV5) || ((IDF) == DSI_PLL_IN_DIV6) \
                 || ((IDF) == DSI_PLL_IN_DIV7))
        /**
  * @}
  */
  ...
  */
        ...
        #define IS_DSI_PLL_ODF(ODF)                                                                        \
                (((ODF) == DSI_PLL_OUT_DIV1) || ((ODF) == DSI_PLL_OUT_DIV2) || ((ODF) == DSI_PLL_OUT_DIV4) \
  ...
  */
        ...
        #define IS_DSI_CLEAR_FLAG(FLAG)                                                          \
                (((FLAG) == DSI_FLAG_TE) || ((FLAG) == DSI_FLAG_ER) || ((FLAG) == DSI_FLAG_PLLL) \
                 || ((FLAG) == DSI_FLAG_PLLU) || ((FLAG) == DSI_FLAG_RR))
        #define IS_DSI_GET_FLAG(FLAG)                                                                    \
                (((FLAG) == DSI_FLAG_TE) || ((FLAG) == DSI_FLAG_ER) || ((FLAG) == DSI_FLAG_BUSY)         \
                 || ((FLAG) == DSI_FLAG_PLLLS) || ((FLAG) == DSI_FLAG_PLLL) || ((FLAG) == DSI_FLAG_PLLU) \
  ...
  */
        ...
        #define IS_DSI_IT(IT)                                                                                 \
                (((IT) == DSI_IT_TE) || ((IT) == DSI_IT_ER) || ((IT) == DSI_IT_PLLL) || ((IT) == DSI_IT_PLLU) \
                 || ((IT) == DSI_IT_RR))
        /**
  * @}
  */
  ...
  */
        ...
        #define IS_DSI_LANE(Lane) \
                (((Lane) == DSI_CLOCK_LANE) || ((Lane) == DSI_DATA_LANE0) || ((Lane) == DSI_DATA_LANE1))
        /**
  * @}
  */
  ...
  */
        ...
        #define IS_DSI_PHY_TIMING(Timing)                                                                    \
                (((Timing) == DSI_TCLK_POST) || ((Timing) == DSI_TLPX_CLK) || ((Timing) == DSI_THS_EXIT)     \
                 || ((Timing) == DSI_TLPX_DATA) || ((Timing) == DSI_THS_ZERO) || ((Timing) == DSI_THS_TRAIL) \
                 || ((Timing) == DSI_THS_PREPARE) || ((Timing) == DSI_TCLK_ZERO) || ((Timing) == DSI_TCLK_PREPARE))
        /**
  * @}
  */

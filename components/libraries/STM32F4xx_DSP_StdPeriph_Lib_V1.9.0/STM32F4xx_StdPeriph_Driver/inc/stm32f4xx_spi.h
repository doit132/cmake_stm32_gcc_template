  ...
  */
        ...
        #define IS_SPI_ALL_PERIPH(PERIPH)                                                             \
                (((PERIPH) == SPI1) || ((PERIPH) == SPI2) || ((PERIPH) == SPI3) || ((PERIPH) == SPI4) \
                 || ((PERIPH) == SPI5) || ((PERIPH) == SPI6))

        #define IS_SPI_ALL_PERIPH_EXT(PERIPH)                                                         \
                (((PERIPH) == SPI1) || ((PERIPH) == SPI2) || ((PERIPH) == SPI3) || ((PERIPH) == SPI4) \
                 || ((PERIPH) == SPI5) || ((PERIPH) == SPI6) || ((PERIPH) == I2S2ext) || ((PERIPH) == I2S3ext))

        #define IS_SPI_23_PERIPH(PERIPH) (((PERIPH) == SPI2) || ((PERIPH) == SPI3))

        #define IS_SPI_23_PERIPH_EXT(PERIPH) \
                (((PERIPH) == SPI2) || ((PERIPH) == SPI3) || ((PERIPH) == I2S2ext) || ((PERIPH) == I2S3ext))
...
/** @defgroup SPI_I2S_interrupts_definition 
  ...
  */
        ...
        #define IS_SPI_I2S_GET_IT(IT)                                                             \
                (((IT) == SPI_I2S_IT_RXNE) || ((IT) == SPI_I2S_IT_TXE) || ((IT) == SPI_IT_CRCERR) \
                 || ((IT) == SPI_IT_MODF) || ((IT) == SPI_I2S_IT_OVR) || ((IT) == I2S_IT_UDR)     \
  ...
  */
        ...
        #define IS_SPI_I2S_GET_FLAG(FLAG)                                                                  \
                (((FLAG) == SPI_I2S_FLAG_BSY) || ((FLAG) == SPI_I2S_FLAG_OVR) || ((FLAG) == SPI_FLAG_MODF) \
                 ...
                 || ((FLAG) == SPI_I2S_FLAG_TXE) || ((FLAG) == SPI_I2S_FLAG_RXNE) || ((FLAG) == SPI_I2S_FLAG_TIFRFE))
/**
  * @}
  */

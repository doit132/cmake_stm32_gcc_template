...
typedef struct {
        ...
        uint32_t
                SPDIFRX_ChannelSelection; /*!< Specifies whether the control flow will take the channel status from channel A or B.
  ...
  */
        ...
        #define IS_SPDIFRX_INPUT_SELECT(INPUT)                                                                      \
                (((INPUT) == SPDIFRX_Input_IN1) || ((INPUT) == SPDIFRX_Input_IN2) || ((INPUT) == SPDIFRX_Input_IN3) \
  ...
  */
        ...
        #define IS_SPDIFRX_MAX_RETRIES(RET)                                         \
                (((RET) == SPDIFRX_1MAX_RETRIES) || ((RET) == SPDIFRX_4MAX_RETRIES) \
                 || ((RET) == SPDIFRX_16MAX_RETRIES) || ((RET) == SPDIFRX_64MAX_RETRIES))
        /**
  * @}
  */
  ...
  */
        ...
        #define IS_SPDIFRX_CHANNEL(CHANNEL) \
                (((CHANNEL) == SPDIFRX_Select_Channel_A) || ((CHANNEL) == SPDIFRX_Select_Channel_B))
        /**
  * @}
  */
  ...
  */
        ...
        #define IS_STEREO_MODE(MODE)        (((MODE) == SPDIFRX_StereoMode_Disabled) || ((MODE) == SPDIFRX_StereoMode_Enabled))
        /**
  * @}
  */
  ...
  */
        ...
        #define IS_SPDIFRX_STATE(STATE) \
                (((STATE) == SPDIFRX_STATE_IDLE) || ((STATE) == SPDIFRX_STATE_SYNC) || ((STATE) == SPDIFRX_STATE_RCV))
        /**
  * @}
  */
  ...
  */
        ...
        #define IS_SPDIFRX_CONFIG_IT(IT)                                                                      \
                (((IT) == SPDIFRX_IT_RXNE) || ((IT) == SPDIFRX_IT_CSRNE) || ((IT) == SPDIFRX_IT_PERRIE)       \
                 || ((IT) == SPDIFRX_IT_OVRIE) || ((IT) == SPDIFRX_IT_SBLKIE) || ((IT) == SPDIFRX_IT_SYNCDIE) \
                 || ((IT) == SPDIFRX_IT_IFEIE))
        /**
  * @}
  */
  ...
  */
        ...
        #define IS_SPDIFRX_FLAG(FLAG)                                                                             \
                (((FLAG) == SPDIFRX_FLAG_RXNE) || ((FLAG) == SPDIFRX_FLAG_CSRNE) || ((FLAG) == SPDIFRX_FLAG_PERR) \
                 || ((FLAG) == SPDIFRX_FLAG_OVR) || ((FLAG) == SPDIFRX_SR_SBD) || ((FLAG) == SPDIFRX_SR_SYNCD)    \
                 || ((FLAG) == SPDIFRX_SR_FERR) || ((FLAG) == SPDIFRX_SR_SERR) || ((FLAG) == SPDIFRX_SR_TERR))
        #define IS_SPDIFRX_CLEAR_FLAG(FLAG)                                                                  \
                (((FLAG) == SPDIFRX_FLAG_PERR) || ((FLAG) == SPDIFRX_FLAG_OVR) || ((FLAG) == SPDIFRX_SR_SBD) \

...
typedef struct {
	 ...
	 * @{
	 */
	#define CEC_SignalFreeTime_Standard                                                        \
		((uint32_t)0x00000000) /*!< CEC Signal Free Time Standard         */
	#define CEC_SignalFreeTime_1T                                                              \
		((uint32_t)0x00000001) /*!< CEC  1.5 nominal data bit periods     */
	#define CEC_SignalFreeTime_2T                                                              \
		((uint32_t)0x00000002) /*!< CEC  2.5 nominal data bit periods     */
	#define CEC_SignalFreeTime_3T                                                              \
		((uint32_t)0x00000003) /*!< CEC  3.5 nominal data bit periods     */
	#define CEC_SignalFreeTime_4T                                                              \
		((uint32_t)0x00000004) /*!< CEC  4.5 nominal data bit periods     */
	#define CEC_SignalFreeTime_5T                                                              \
		((uint32_t)0x00000005) /*!< CEC  5.5 nominal data bit periods     */
	#define CEC_SignalFreeTime_6T                                                              \
		((uint32_t)0x00000006) /*!< CEC  6.5 nominal data bit periods     */
	#define CEC_SignalFreeTime_7T                                                              \
		((uint32_t)0x00000007) /*!< CEC  7.5 nominal data bit periods     */

	#define IS_CEC_SIGNAL_FREE_TIME(TIME)                                                      \
		(((TIME) == CEC_SignalFreeTime_Standard) || ((TIME) == CEC_SignalFreeTime_1T) ||   \
		 ((TIME) == CEC_SignalFreeTime_2T) || ((TIME) == CEC_SignalFreeTime_3T) ||         \
		 ((TIME) == CEC_SignalFreeTime_4T) || ((TIME) == CEC_SignalFreeTime_5T) ||         \
		 ((TIME) == CEC_SignalFreeTime_6T) || ((TIME) == CEC_SignalFreeTime_7T))
	/**
	 * @}
	 */
	 ...
	 * @{
	 */
	#define CEC_RxTolerance_Standard                                                           \
		((uint32_t)0x00000000)			/*!< Standard Tolerance Margin            */
	 ...
	 * @{
	 */
	#define CEC_StopReception_Off                                                              \
		((uint32_t)0x00000000)		     /*!< No RX Stop on bit Rising Error (BRE) */
	#define CEC_StopReception_On CEC_CFGR_BRESTP /*!< RX Stop on bit Rising Error (BRE)    */

	#define IS_CEC_STOP_RECEPTION(RECEPTION)                                                   \
		(((RECEPTION) == CEC_StopReception_On) || ((RECEPTION) == CEC_StopReception_Off))
	/**
	 * @}
	 */
	 ...
	 * @{
	 */
	#define CEC_LongBitPeriodError_Off                                                         \
		((uint32_t)0x00000000) /*!< Long Bit Period Error generation turned Off */
	#define CEC_LongBitPeriodError_On                                                          \
		CEC_CFGR_LREGEN /*!< Long Bit Period Error generation turned On  */

	#define IS_CEC_LONG_BIT_PERIOD_ERROR(ERROR)                                                \
		(((ERROR) == CEC_LongBitPeriodError_Off) || ((ERROR) == CEC_LongBitPeriodError_On))
	/**
	 * @}
	 */
	...
	#define CEC_BRDNoGen_Off                                                                   \
		((uint32_t)0x00000000) /*!< Broadcast Bit Rising Error generation turned Off */
	#define CEC_BRDNoGen_On                                                                    \
		CEC_CFGR_BRDNOGEN /*!< Broadcast Bit Rising Error generation turned On  */

	#define IS_CEC_BDR_NO_GEN_ERROR(ERROR)                                                     \
		(((ERROR) == CEC_BRDNoGen_Off) || ((ERROR) == CEC_BRDNoGen_On))
	/**
	 * @}
	 */
	 ...
	 * @{
	 */
	#define CEC_SFTOption_Off                                                                  \
		((uint32_t)0x00000000)		 /*!< SFT option turned Off                   */
	#define CEC_SFTOption_On CEC_CFGR_SFTOPT /*!< SFT option turned On                    */

	#define IS_CEC_SFT_OPTION(OPTION)                                                          \
		(((OPTION) == CEC_SFTOption_Off) || ((OPTION) == CEC_SFTOption_On))
	/**
	 * @}
	 */
	...
	#define IS_CEC_GET_IT(IT)                                                                  \
		(((IT) == CEC_IT_TXACKE) || ((IT) == CEC_IT_TXERR) || ((IT) == CEC_IT_TXUDR) ||    \
		 ((IT) == CEC_IT_TXEND) || ((IT) == CEC_IT_TXBR) || ((IT) == CEC_IT_ARBLST) ||     \
		 ((IT) == CEC_IT_RXACKE) || ((IT) == CEC_IT_LBPE) || ((IT) == CEC_IT_SBPE) ||      \
		 ((IT) == CEC_IT_BRE) || ((IT) == CEC_IT_RXOVR) || ((IT) == CEC_IT_RXEND) ||       \
		 ((IT) == CEC_IT_RXBR))
	/**
	 * @}
	 */
	...
	#define IS_CEC_GET_FLAG(FLAG)                                                              \
		(((FLAG) == CEC_FLAG_TXACKE) || ((FLAG) == CEC_FLAG_TXERR) ||                      \
		 ((FLAG) == CEC_FLAG_TXUDR) || ((FLAG) == CEC_FLAG_TXEND) ||                       \
		 ((FLAG) == CEC_FLAG_TXBR) || ((FLAG) == CEC_FLAG_ARBLST) ||                       \
		 ((FLAG) == CEC_FLAG_RXACKE) || ((FLAG) == CEC_FLAG_LBPE) ||                       \
		 ((FLAG) == CEC_FLAG_SBPE) || ((FLAG) == CEC_FLAG_BRE) ||                          \
		 ((FLAG) == CEC_FLAG_RXOVR) || ((FLAG) == CEC_FLAG_RXEND) ||                       \
		 ((FLAG) == CEC_FLAG_RXBR))
/**
 * @}
 */

...
typedef struct {
  ...
  */
        ...
        #define IS_CEC_RX_TOLERANCE(TOLERANCE) \
                (((TOLERANCE) == CEC_RxTolerance_Standard) || ((TOLERANCE) == CEC_RxTolerance_Extended))
        /**
  * @}
  */
  ...
  */
        ...
        #define IS_CEC_BDR_NO_GEN_ERROR(ERROR) (((ERROR) == CEC_BRDNoGen_Off) || ((ERROR) == CEC_BRDNoGen_On))
        /**
  * @}
  */
  ...
  */
        ...
        #define IS_CEC_SFT_OPTION(OPTION) (((OPTION) == CEC_SFTOption_Off) || ((OPTION) == CEC_SFTOption_On))
        /**
  * @}
  */
  ...
  */
        ...
        #define IS_CEC_GET_IT(IT)                                                                                      \
                (((IT) == CEC_IT_TXACKE) || ((IT) == CEC_IT_TXERR) || ((IT) == CEC_IT_TXUDR) || ((IT) == CEC_IT_TXEND) \
                 || ((IT) == CEC_IT_TXBR) || ((IT) == CEC_IT_ARBLST) || ((IT) == CEC_IT_RXACKE)                        \
                 || ((IT) == CEC_IT_LBPE) || ((IT) == CEC_IT_SBPE) || ((IT) == CEC_IT_BRE) || ((IT) == CEC_IT_RXOVR)   \
                 || ((IT) == CEC_IT_RXEND) || ((IT) == CEC_IT_RXBR))
        /**
  * @}
  */
  ...
  */
        ...
        #define IS_CEC_GET_FLAG(FLAG)                                                                      \
                (((FLAG) == CEC_FLAG_TXACKE) || ((FLAG) == CEC_FLAG_TXERR) || ((FLAG) == CEC_FLAG_TXUDR)   \
                 || ((FLAG) == CEC_FLAG_TXEND) || ((FLAG) == CEC_FLAG_TXBR) || ((FLAG) == CEC_FLAG_ARBLST) \
                 || ((FLAG) == CEC_FLAG_RXACKE) || ((FLAG) == CEC_FLAG_LBPE) || ((FLAG) == CEC_FLAG_SBPE)  \
                 || ((FLAG) == CEC_FLAG_BRE) || ((FLAG) == CEC_FLAG_RXOVR) || ((FLAG) == CEC_FLAG_RXEND)   \
                 || ((FLAG) == CEC_FLAG_RXBR))
/**
  * @}
  */

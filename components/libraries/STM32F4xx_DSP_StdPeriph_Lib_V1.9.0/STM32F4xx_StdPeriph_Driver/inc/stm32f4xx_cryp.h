...
typedef struct {
  ...
  */
        ...
        #define IS_CRYP_ALGOMODE(ALGOMODE)                                                         \
                (((ALGOMODE) == CRYP_AlgoMode_TDES_ECB) || ((ALGOMODE) == CRYP_AlgoMode_TDES_CBC)  \
  ...
  */
        ...
        #define IS_CRYP_PHASE(PHASE)                                                                               \
                (((PHASE) == CRYP_Phase_Init) || ((PHASE) == CRYP_Phase_Header) || ((PHASE) == CRYP_Phase_Payload) \
  ...
  */
        ...
        #define IS_CRYP_GET_FLAG(FLAG)                                                                       \
                (((FLAG) == CRYP_FLAG_IFEM) || ((FLAG) == CRYP_FLAG_IFNF) || ((FLAG) == CRYP_FLAG_OFNE)      \
                 || ((FLAG) == CRYP_FLAG_OFFU) || ((FLAG) == CRYP_FLAG_BUSY) || ((FLAG) == CRYP_FLAG_OUTRIS) \
...
ErrorStatus
        CRYP_AES_ECB(uint8_t Mode, uint8_t* Key, uint16_t Keysize, uint8_t* Input, uint32_t Ilength, uint8_t* Output);

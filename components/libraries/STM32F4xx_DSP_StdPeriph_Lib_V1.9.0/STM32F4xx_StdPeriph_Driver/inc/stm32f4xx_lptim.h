...
typedef struct {
  ...
  */
        ...
        #define IS_LPTIM_CLOCK_SOURCE(SOURCE) \
                (((SOURCE) == LPTIM_ClockSource_ULPTIM) || ((SOURCE) == LPTIM_ClockSource_APBClock_LPosc))
        /**
  * @}
  */
  ...
  */
        ...
        #define IS_LPTIM_CLOCK_PRESCALER(PRESCALER)                                                  \
                (((PRESCALER) == LPTIM_Prescaler_DIV1) || ((PRESCALER) == LPTIM_Prescaler_DIV2)      \
                 || ((PRESCALER) == LPTIM_Prescaler_DIV4) || ((PRESCALER) == LPTIM_Prescaler_DIV8)   \
                 || ((PRESCALER) == LPTIM_Prescaler_DIV16) || ((PRESCALER) == LPTIM_Prescaler_DIV32) \
                 || ((PRESCALER) == LPTIM_Prescaler_DIV64) || ((PRESCALER) == LPTIM_Prescaler_DIV128))
        /**
  * @}
  */
  ...
  */
        ...
        #define IS_LPTIM_WAVEFORM(WAVE)     (((WAVE) == LPTIM_Waveform_SetOnce) || ((WAVE) == LPTIM_Waveform_PWM_OnePulse))
        /**
  * @}
  */
  ...
  */
        ...
        #define IS_LPTIM_OUTPUT_POLARITY(POLARITY) \
                (((POLARITY) == LPTIM_OutputPolarity_Low) || ((POLARITY) == LPTIM_OutputPolarity_High))
        /**
  * @}
  */
  ...
  */
        ...
        #define IS_LPTIM_CLOCK_POLARITY(POLARITY)                                                                  \
                (((POLARITY) == LPTIM_ClockPolarity_RisingEdge) || ((POLARITY) == LPTIM_ClockPolarity_FallingEdge) \
  ...
  */
        ...
        #define IS_LPTIM_EXT_TRG_SOURCE(TRIG)                                            \
                (((TRIG) == LPTIM_ExtTRGSource_0) || ((TRIG) == LPTIM_ExtTRGSource_1)    \
                 || ((TRIG) == LPTIM_ExtTRGSource_2) || ((TRIG) == LPTIM_ExtTRGSource_3) \
                 || ((TRIG) == LPTIM_ExtTRGSource_4) || ((TRIG) == LPTIM_ExtTRGSource_5) \
                 || ((TRIG) == LPTIM_ExtTRGSource_6) || ((TRIG) == LPTIM_ExtTRGSource_7))
        /**
  * @}
  */
  ...
  */
        ...
        #define IS_LPTIM_EXT_TRG_POLARITY(POLAR)                                                               \
                (((POLAR) == LPTIM_ExtTRGPolarity_RisingEdge) || ((POLAR) == LPTIM_ExtTRGPolarity_FallingEdge) \
  ...
  */
        ...
        #define IS_LPTIM_CLOCK_SAMPLE_TIME(SAMPLETIME)                     \
                (((SAMPLETIME) == LPTIM_ClockSampleTime_DirectTransistion) \
  ...
  */
        ...
        #define IS_LPTIM_TRIG_SAMPLE_TIME(SAMPLETIME)                     \
                (((SAMPLETIME) == LPTIM_TrigSampleTime_DirectTransistion) \
  ...
  */
        ...
        #define IS_LPTIM_MODE(MODE)   (((MODE) == LPTIM_Mode_Continuous) || ((MODE) == LPTIM_Mode_Single))
        /**
  * @}
  */
  ...
  */
        ...
        #define IS_LPTIM_UPDATE(UPDATE)  (((UPDATE) == LPTIM_Update_Immediate) || ((UPDATE) == LPTIM_Update_EndOfPeriod))
        /**
  * @}
  */
  ...
  */
        ...
        #define IS_LPTIM_IT(IT)                                                                       \
                (((IT) == LPTIM_IT_DOWN) || ((IT) == LPTIM_IT_UP) || ((IT) == LPTIM_IT_ARROK)         \
                 || ((IT) == LPTIM_IT_CMPOK) || ((IT) == LPTIM_IT_EXTTRIG) || ((IT) == LPTIM_IT_ARRM) \
                 || ((IT) == LPTIM_IT_CMPM))

        #define IS_LPTIM_GET_IT(IT)                                                                   \
                (((IT) == LPTIM_IT_DOWN) || ((IT) == LPTIM_IT_UP) || ((IT) == LPTIM_IT_ARROK)         \
                 || ((IT) == LPTIM_IT_CMPOK) || ((IT) == LPTIM_IT_EXTTRIG) || ((IT) == LPTIM_IT_ARRM) \
                 || ((IT) == LPTIM_IT_CMPM))
        /**
  ...
  */
        ...
        #define IS_LPTIM_GET_FLAG(FLAG)                                                                           \
                (((FLAG) == LPTIM_FLAG_DOWN) || ((FLAG) == LPTIM_FLAG_UP) || ((FLAG) == LPTIM_FLAG_ARROK)         \
                 || ((FLAG) == LPTIM_FLAG_CMPOK) || ((FLAG) == LPTIM_FLAG_EXTTRIG) || ((FLAG) == LPTIM_FLAG_ARRM) \
  ...
  */
        ...
        #define IS_LPTIM_CLEAR_FLAG(CLEARF)                                                                        \
                (((CLEARF) == LPTIM_CLEAR_DOWN) || ((CLEARF) == LPTIM_CLEAR_UP) || ((CLEARF) == LPTIM_CLEAR_ARROK) \
                 || ((CLEARF) == LPTIM_CLEAR_CMPOK) || ((CLEARF) == LPTIM_CLEAR_EXTTRIG)                           \
                 || ((CLEARF) == LPTIM_CLEAR_ARRM) || ((CLEARF) == LPTIM_CLEAR_CMPM))
        /**
  * @}
  */

...
void RCC_DeInit(void)
{
        ...
        || defined(STM32F411xE) || defined(STM32F446xx) || defined(STM32F413_423xx) || defined(STM32F469_479xx)
...
void RCC_PLLConfig(uint32_t RCC_PLLSource, uint32_t PLLM, uint32_t PLLN, uint32_t PLLP, uint32_t PLLQ, uint32_t PLLR)
{
        ...
        RCC->PLLCFGR = PLLM | (PLLN << 6) | (((PLLP >> 1) - 1) << 16) | (RCC_PLLSource) | (PLLQ << 24) | (PLLR << 28);
}
...
void RCC_GetClocksFreq(RCC_ClocksTypeDef* RCC_Clocks)
{
        ...
        switch (tmp) {
        case 0x00: /* HSI used as system clock source */ RCC_Clocks->SYSCLK_Frequency = HSI_VALUE; break;
        case 0x04: /* HSE used as system clock  source */ RCC_Clocks->SYSCLK_Frequency = HSE_VALUE; break;
    ...
    */
        ...
        default: RCC_Clocks->SYSCLK_Frequency = HSI_VALUE; break;
        }

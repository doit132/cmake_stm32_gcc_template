 ...
 ===============================================================================
    [..]
      ...
      (+) There is one Wake-up pin: Wake-up Pin 1 on PA.00.
	   ...
	   (++) For STM32F410xx/STM32F412xG/STM32F413_423xx there are three Wake-Up pins: Pin1 on
 ...
 *            @arg PWR_WakeUp_Pin3: WKUP3 pin is used for wakeup from Standby mode.(only for
 * STM32F410xx, STM32F412xG and STM32F413_423xx Devices)
 * @param  NewState: new state of the WakeUp Pin functionality.
 *         This parameter can be: ENABLE or DISABLE.
 * @retval None
 */
...
only available when the main regulator or the low power regulator is in low voltage mode. This mode
is enabled through PWR_UnderDriveCmd() function.
 ...
 *                                                System frequency up to 120 MHz (only for
 ...
 * STM32F401xx/STM32F410xx/STM32F411xx/STM32F412xG/STM32F413_423xx devices.
 *
 ...
 * @note   The Wakeup flag (WUF) need to be cleared at application level before to call this
 * function
 * @param  None
 * @retval None
 */

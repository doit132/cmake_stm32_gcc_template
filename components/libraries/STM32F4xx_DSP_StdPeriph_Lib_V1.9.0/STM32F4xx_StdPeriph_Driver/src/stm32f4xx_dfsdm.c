			   ...
			   DFSDM_TransceiverInitTypeDef *DFSDM_TransceiverInitStruct)
{
	...
	assert_param(
		IS_DFSDM_DATA_RIGHT_BIT_SHIFT(DFSDM_TransceiverInitStruct->DFSDM_DataRightShift));
	assert_param(IS_DFSDM_OFFSET(DFSDM_TransceiverInitStruct->DFSDM_Offset));
	assert_param(
		IS_DFSDM_CLK_DETECTOR_STATE(DFSDM_TransceiverInitStruct->DFSDM_CLKAbsenceDetector));
	assert_param(IS_DFSDM_SC_DETECTOR_STATE(
...
void DFSDM_FilterInit(DFSDM_Filter_TypeDef *DFSDMx, DFSDM_FilterInitTypeDef *DFSDM_FilterInitStruct)
{
	...
	assert_param(
		IS_DFSDM_SINC_OVRSMPL_RATIO(DFSDM_FilterInitStruct->DFSDM_FilterOversamplingRatio));
	assert_param(IS_DFSDM_INTG_OVRSMPL_RATIO(
		DFSDM_FilterInitStruct->DFSDM_IntegratorOversamplingRatio));
 ...
 *            @arg DFSDM2_Channel6 : DFSDM 2 Channel 6 (available only for STM32F413_423xx devices)
 *            @arg DFSDM2_Channel7 : DFSDM 2 Channel 7 (available only for STM32F413_423xx devices)
 * @param  DFSDM_SCDBreak_i: where i can be a value from 0 to 3 to select the specified Break
 * signal.
...
/**
 * @brief  Defines the threshold counter for the short circuit detector for the selected
 * DFSDM_Channelx.
 * @param  DFSDM_Channelx: specifies the channel to be selected.
 *         This parameter can be one of the following values :
 *            @arg DFSDM1_Channel0 : DFSDM 1 Channel 0
 ...
 *            @arg DFSDM2_Channel6 : DFSDM 2 Channel 6 (available only for STM32F413_423xx devices)
 *            @arg DFSDM2_Channel7 : DFSDM 2 Channel 7 (available only for STM32F413_423xx devices)
 * @param  DFSDM_SCDThreshold: The threshold counter, this parameter can be a value between 0 and
 * 255.
 * @retval None
 */
...
/**
 * @brief  Selects the channel to be guarded by the Analog watchdog of the selected DFSDMx, and the
 * mode to be used.
 * @param  DFSDMx: specifies the filter to be selected :
 *         This parameter can be one of the following values :
 *            @arg DFSDM1_0 : DFSDM 1 Filter 0
 ...
 *            @arg DFSDM2_2 : DFSDM 2 Filter 2 (available only for STM32F413_423xx devices)
 *            @arg DFSDM2_3 : DFSDM 2 Filter 3 (available only for STM32F413_423xx devices)
 * @param  DFSDM_ExtremChannelx: where x can be a value from 0 to 7 to select the Channel to be
 * connected to the Extremes detector.
 * @retval None
 */
...
/**
 * @brief  Returns the number of channel on which is captured the highest converted data by the
 * DFSDMx.
 * @param  DFSDMx: specifies the filter to be selected :
 *         This parameter can be one of the following values :
 *            @arg DFSDM1_0 : DFSDM 1 Filter 0
...
/**
 * @brief  Returns the number of channel on which is captured the lowest converted data by the
 * DFSDMx.
 * @param  DFSDMx: specifies the filter to be selected :
 *         This parameter can be one of the following values :
 *            @arg DFSDM1_0 : DFSDM 1 Filter 0
 ...
 *            @arg DFSDM2_Channel6 : DFSDM 2 Channel 6 (available only for STM32F413_423xx devices)
 *            @arg DFSDM2_Channel7 : DFSDM 2 Channel 7 (available only for STM32F413_423xx devices)
 * @param  DFSDM_AWDSincOrder: The Sinc Filter order this parameter can be a value of @ref
 * DFSDM_AWD_Sinc_Order.
 * @param  DFSDM_AWDSincOverSampleRatio: The Filter Oversampling ratio, this parameter can be a
...
/**
 * @brief  Configures the High Threshold and the Low threshold for the Analog watchdog of the
 * selected DFSDMx.
 * @param  DFSDMx: specifies the filter to be selected :
 *         This parameter can be one of the following values :
 *            @arg DFSDM1_0 : DFSDM 1 Filter 0
 ...
 *            @arg DFSDM2_2 : DFSDM 2 Filter 2 (available only for STM32F413_423xx devices)
 *            @arg DFSDM2_3 : DFSDM 2 Filter 3 (available only for STM32F413_423xx devices)
 * @param  DFSDM_HighThreshold: High threshold value. This parameter can be value between 0 and
 * 0xFFFFFF.
 * @param  DFSDM_LowThreshold: Low threshold value. This parameter can be value between 0 and
 * 0xFFFFFF.
 * @retval None.
 * @note   In case of channels transceivers monitoring (Analog Watchdog fast mode Enabled)),
 *         only the higher 16 bits define the 16-bit threshold compared with analog watchdog filter
 * output.
 */
 ...
 *            @arg DFSDM2_2 : DFSDM 2 Filter 2 (available only for STM32F413_423xx devices)
 *            @arg DFSDM2_3 : DFSDM 2 Filter 3 (available only for STM32F413_423xx devices)
 * @param  DFSDM_InjectedChannelx: where x can be a value from 0 to 7 to select the Channel to be
 * configuraed as injected channel.
 * @retval None
 ...
 *            @arg DFSDM2_2 : DFSDM 2 Filter 2 (available only for STM32F413_423xx devices)
 *            @arg DFSDM2_3 : DFSDM 2 Filter 3 (available only for STM32F413_423xx devices)
 * @param  DFSDM_RegularChannelx: where x can be a value from 0 to 7 to select the Channel to be
 * configurated as regular channel.
 * @retval None
...
/**
 * @brief  Enables or Disables the continue mode for Regular conversion for the selected filter
 * DFSDMx.
 * @param  DFSDMx: specifies the filter to be selected :
 *         This parameter can be one of the following values :
 *            @arg DFSDM1_0 : DFSDM 1 Filter 0
...
/**
 * @brief  Enables or Disables the DMA to read data for the injected channel group of the selected
 * filter DFSDMx.
 * @param  DFSDMx: specifies the filter to be selected :
 *         This parameter can be one of the following values :
 *            @arg DFSDM1_0 : DFSDM 1 Filter 0
 ...
 *            @arg DFSDM_DMAConversionMode_Regular:  DMA channel Enabled/Disabled to read data for
 * the regular conversion
 *            @arg DFSDM_DMAConversionMode_Injected: DMA channel Enabled/Disabled to read data for
...
@verbatim
 ...
 ===============================================================================
  ...
  - To check if an interrupt was occurred, call
"DFSDM_GetITStatus","DFSDM_GetClockAbsenceITStatusfunction" and "DFSDM_GetGetShortCircuitITStatus"
functions and read returned values.
  - To get a flag status, call the "DFSDM_GetFlagStatus" ,"DFSDM_GetClockAbsenceFlagStatus"
,"DFSDM_GetShortCircuitFlagStatus" and "DFSDM_GetWatchdogFlagStatus" functions and read the returned
value.

...
void CAN_ClearITPendingBit(CAN_TypeDef *CANx, uint32_t CAN_IT)
{
	...
	case CAN_IT_EWG:
		...
		/* @note the corresponding Flag is cleared by hardware depending on the CAN Bus
		 * status*/
		break;
	case CAN_IT_EPV:
		/* Clear CAN_MSR_ERRI (rc_w1) */
	...
	case CAN_IT_ERR:
		...
		/* Clear CAN_MSR_ERRI (rc_w1) */
		CANx->MSR = CAN_MSR_ERRI;
		/* @note BOFF, EPVF and EWGF Flags are cleared by hardware depending on the CAN Bus
		 * status*/
		break;
	default:
		break;

...
#define RTC_FLAGS_MASK                                                                                               \
        ((uint32_t)(RTC_FLAG_TSOVF | RTC_FLAG_TSF | RTC_FLAG_WUTF | RTC_FLAG_ALRBF | RTC_FLAG_ALRAF | RTC_FLAG_INITF \
                    | RTC_FLAG_RSF | RTC_FLAG_INITS | RTC_FLAG_WUTWF | RTC_FLAG_ALRBWF | RTC_FLAG_ALRAWF             \
                    | RTC_FLAG_TAMP1F | RTC_FLAG_TAMP2F | RTC_FLAG_RECALPF | RTC_FLAG_SHPF))
...
ErrorStatus RTC_SetTime(uint32_t RTC_Format, RTC_TimeTypeDef* RTC_TimeStruct)
{
        ...
        if (RTC_Format != RTC_Format_BIN) {
                tmpreg = (((uint32_t)(RTC_TimeStruct->RTC_Hours) << 16) | ((uint32_t)(RTC_TimeStruct->RTC_Minutes) << 8)
                          | ((uint32_t)RTC_TimeStruct->RTC_Seconds) | ((uint32_t)(RTC_TimeStruct->RTC_H12) << 16));
        } else {
...
ErrorStatus RTC_SetDate(uint32_t RTC_Format, RTC_DateTypeDef* RTC_DateStruct)
{
        ...
        /* Check the input parameters format */
        if (RTC_Format != RTC_Format_BIN) {
                tmpreg = ((((uint32_t)RTC_DateStruct->RTC_Year) << 16) | (((uint32_t)RTC_DateStruct->RTC_Month) << 8)
                          | ((uint32_t)RTC_DateStruct->RTC_Date) | (((uint32_t)RTC_DateStruct->RTC_WeekDay) << 13));
        } else {
                                  ...
                                  uint32_t RTC_SmouthCalibMinusPulsesValue)
{
        ...
        if ((RTC->ISR & RTC_ISR_RECALPF) != RESET) {
                ...
                while (((RTC->ISR & RTC_ISR_RECALPF) != RESET) && (recalpfcount != RECALPF_TIMEOUT)) { recalpfcount++; }
        }
...
ErrorStatus RTC_SynchroShiftConfig(uint32_t RTC_ShiftAdd1S, uint32_t RTC_ShiftSubFS)
{
        ...
        if ((RTC->ISR & RTC_ISR_SHPF) != RESET) {
                ...
                while (((RTC->ISR & RTC_ISR_SHPF) != RESET) && (shpfcount != SHPF_TIMEOUT)) { shpfcount++; }
        }
...
void RTC_ClearITPendingBit(uint32_t RTC_IT)
{
        ...
        RTC->ISR
                = (uint32_t)((uint32_t)(~((tmpreg | RTC_ISR_INIT) & 0x0000FFFF) | (uint32_t)(RTC->ISR & RTC_ISR_INIT)));
}

...
void SAI_Init(SAI_Block_TypeDef* SAI_Block_x, SAI_InitTypeDef* SAI_InitStruct)
{
     ...
     edge, Synchronization mode, Output drive, Master Divider and FIFO level */
        ...
        tmpreg |= (uint32_t)(SAI_InitStruct->SAI_AudioMode | SAI_InitStruct->SAI_Protocol | SAI_InitStruct->SAI_DataSize
                             | SAI_InitStruct->SAI_FirstBit | SAI_InitStruct->SAI_ClockStrobing
                             | SAI_InitStruct->SAI_Synchro | SAI_InitStruct->SAI_OUTDRIV | SAI_InitStruct->SAI_NoDivider
...
void SAI_FrameInit(SAI_Block_TypeDef* SAI_Block_x, SAI_FrameInitTypeDef* SAI_FrameInitStruct)
{
     ...
     Definition, Frame Synchronization Polarity and Frame Synchronization Polarity */
        ...
        tmpreg |= (uint32_t)((uint32_t)(SAI_FrameInitStruct->SAI_FrameLength - 1) | SAI_FrameInitStruct->SAI_FSOffset
                             | SAI_FrameInitStruct->SAI_FSDefinition | SAI_FrameInitStruct->SAI_FSPolarity
...
void SAI_SlotInit(SAI_Block_TypeDef* SAI_Block_x, SAI_SlotInitTypeDef* SAI_SlotInitStruct)
{
     ...
     audio frame and slots activated in audio frame */
        ...
        tmpreg |= (uint32_t)(SAI_SlotInitStruct->SAI_FirstBitOffset | SAI_SlotInitStruct->SAI_SlotSize
...
void SAI_BlockSynchroConfig(SAI_InitTypeDef* SAI_InitStruct, SAI_TypeDef* SAIx)
{
        ...
        case SAI_SyncExt_Disable: tmpregisterGCR = 0U; break;

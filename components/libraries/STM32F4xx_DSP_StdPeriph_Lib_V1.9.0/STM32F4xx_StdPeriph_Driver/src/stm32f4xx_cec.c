...
@verbatim
 ...
 ===============================================================================
    ...
    [..] In polling mode, the CEC can be managed by the following flags:
	    ...
	    (+) CEC_FLAG_SBPE   : to indicate a short bit period error generated during receive
mode.
	    (+) CEC_FLAG_BRE    : to indicate a bit rising error generated during receive mode.
	    (+) CEC_FLAG_RXOVR  : to indicate if an overrun error occur while receiving a CEC
message. A byte is not yet received while a new byte is stored in the RXDR register.
    ...
    [..] In Interrupt mode, the CEC can be managed by the following interrupt sources:
	   ...
	   (+) CEC_IT_TXBR   : to indicate the next transmission data has to be written to TXDR
register.
	   ...
	   (+) CEC_IT_RXOVR  : to indicate if an overrun error occur while receiving a CEC message.
			       A byte is not yet received while a new byte is stored in the RXDR
register.

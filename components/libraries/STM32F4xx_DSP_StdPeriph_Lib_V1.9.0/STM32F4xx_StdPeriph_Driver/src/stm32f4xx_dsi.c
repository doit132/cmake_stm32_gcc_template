...
/** @addtogroup DSI
  ...
  */
        ...
        #define DSI_ERROR_ACK_MASK                                                                           \
                (DSI_ISR0_AE0 | DSI_ISR0_AE1 | DSI_ISR0_AE2 | DSI_ISR0_AE3 | DSI_ISR0_AE4 | DSI_ISR0_AE5     \
                 | DSI_ISR0_AE6 | DSI_ISR0_AE7 | DSI_ISR0_AE8 | DSI_ISR0_AE9 | DSI_ISR0_AE10 | DSI_ISR0_AE11 \
...
void DSI_ConfigAdaptedCommandMode(DSI_TypeDef* DSIx, DSI_CmdCfgTypeDef* CmdCfg)
{
        ...
        DSIx->WCFGR |= (CmdCfg->TearingEffectSource | CmdCfg->TearingEffectPolarity | CmdCfg->AutomaticRefresh
                        | CmdCfg->VSyncPol);
...
void DSI_ConfigCommand(DSI_TypeDef* DSIx, DSI_LPCmdTypeDef* LPCmd)
{
        ...
        DSIx->CMCR &= ~(DSI_CMCR_GSW0TX | DSI_CMCR_GSW1TX | DSI_CMCR_GSW2TX | DSI_CMCR_GSR0TX | DSI_CMCR_GSR1TX
                        | DSI_CMCR_GSR2TX | DSI_CMCR_GLWTX | DSI_CMCR_DSW0TX | DSI_CMCR_DSW1TX | DSI_CMCR_DSR0TX
                        | DSI_CMCR_DLWTX | DSI_CMCR_MRDPS);
        DSIx->CMCR |= (LPCmd->LPGenShortWriteNoP | LPCmd->LPGenShortWriteOneP | LPCmd->LPGenShortWriteTwoP
                       | LPCmd->LPGenShortReadNoP | LPCmd->LPGenShortReadOneP | LPCmd->LPGenShortReadTwoP
                       | LPCmd->LPGenLongWrite | LPCmd->LPDcsShortWriteNoP | LPCmd->LPDcsShortWriteOneP
                       | LPCmd->LPDcsShortReadNoP | LPCmd->LPDcsLongWrite | LPCmd->LPMaxReadPacket);
                   ...
                   uint8_t*     ParametersTable)
{
        ...
        DSI_ConfigPacketHeader(DSIx, ChannelID, Mode, ((NbParams + 1) & 0x00FF), (((NbParams + 1) & 0xFF00) >> 8));
}
...
/**
  ...
  */
static void
        DSI_ConfigPacketHeader(DSI_TypeDef* DSIx, uint32_t ChannelID, uint32_t DataType, uint32_t Data0, uint32_t Data1)
{

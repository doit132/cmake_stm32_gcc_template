...
void LTDC_LayerInit(LTDC_Layer_TypeDef* LTDC_Layerx, LTDC_Layer_InitTypeDef* LTDC_Layer_InitStruct)
{
        ...
        LTDC_Layerx->BFCR
                = (LTDC_Layer_InitStruct->LTDC_BlendingFactor_1 | LTDC_Layer_InitStruct->LTDC_BlendingFactor_2);
...
void LTDC_LayerPixelFormat(LTDC_Layer_TypeDef* LTDC_Layerx, uint32_t PixelFormat)
{
        ...
        if (PixelFormat == LTDC_Pixelformat_ARGB8888) {
                ...
                temp = 3;
        } else if ((PixelFormat == LTDC_Pixelformat_ARGB4444) || (PixelFormat == LTDC_Pixelformat_RGB565)
                   || (PixelFormat == LTDC_Pixelformat_ARGB1555) || (PixelFormat == LTDC_Pixelformat_AL88)) {
                temp = 2;
        } else {
                temp = 1;
        }

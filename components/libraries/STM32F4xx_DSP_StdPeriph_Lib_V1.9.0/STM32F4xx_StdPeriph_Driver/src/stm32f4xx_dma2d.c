...
void DMA2D_FGConfig(DMA2D_FG_InitTypeDef* DMA2D_FG_InitStruct)
{
        ...
        DMA2D->FGPFCCR
                |= (DMA2D_FG_InitStruct->DMA2D_FGCM | fg_clutcolormode | fg_clutsize | fg_alpha_mode | fg_alphavalue);
...
void DMA2D_BGConfig(DMA2D_BG_InitTypeDef* DMA2D_BG_InitStruct)
{
        ...
        DMA2D->BGPFCCR
                |= (DMA2D_BG_InitStruct->DMA2D_BGCM | bg_clutcolormode | bg_clutsize | bg_alpha_mode | bg_alphavalue);

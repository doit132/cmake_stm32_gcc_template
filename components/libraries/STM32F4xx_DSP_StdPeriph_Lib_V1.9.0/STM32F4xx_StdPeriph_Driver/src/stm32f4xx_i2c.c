...
/**
  ...
  *
  * @note   This function can be used only for STM32F42xxx/STM3243xxx, STM32F401xx, STM32F410xx and
  STM32F411xE devices.
  *
  * @param  I2Cx: where x can be 1, 2 or 3 to select the I2C peripheral.
...
ErrorStatus I2C_CheckEvent(I2C_TypeDef *I2Cx, uint32_t I2C_EVENT)
{
	...
	/* I2C_SR2 must be read only when ADDR is found set in I2C_SR1 or when the STOPF bit is
	 * cleared */

...
void FMC_NORSRAMInit(FMC_NORSRAMInitTypeDef* FMC_NORSRAMInitStruct)
{
        ...
        assert_param(
                IS_FMC_TURNAROUND_TIME(FMC_NORSRAMInitStruct->FMC_ReadWriteTimingStruct->FMC_BusTurnAroundDuration));
        ...
        tmpbcr &= ((uint32_t) ~(FMC_BCR1_MBKEN | FMC_BCR1_MUXEN | FMC_BCR1_MTYP | FMC_BCR1_MWID | FMC_BCR1_FACCEN
        ...
        tmpbcr |= (uint32_t)FMC_NORSRAMInitStruct->FMC_DataAddressMux | FMC_NORSRAMInitStruct->FMC_MemoryType
                  | FMC_NORSRAMInitStruct->FMC_MemoryDataWidth | FMC_NORSRAMInitStruct->FMC_BurstAccessMode
                  | FMC_NORSRAMInitStruct->FMC_WaitSignalPolarity | FMC_NORSRAMInitStruct->FMC_WrapMode
                  | FMC_NORSRAMInitStruct->FMC_WaitSignalActive | FMC_NORSRAMInitStruct->FMC_WriteOperation
                  | FMC_NORSRAMInitStruct->FMC_WaitSignal | FMC_NORSRAMInitStruct->FMC_ExtendedMode
                  | FMC_NORSRAMInitStruct->FMC_AsynchronousWait | FMC_NORSRAMInitStruct->FMC_WriteBurst
        ...
        if ((FMC_NORSRAMInitStruct->FMC_ContinousClock == FMC_CClock_SyncAsync)
            && (FMC_NORSRAMInitStruct->FMC_Bank != FMC_Bank1_NORSRAM1)) {
                ...
                FMC_Bank1->BTCR[FMC_Bank1_NORSRAM1 + 1]
                        = (uint32_t)(tmpr
                                     | (((FMC_NORSRAMInitStruct->FMC_ReadWriteTimingStruct->FMC_CLKDivision) - 1)
                                        << 20));
        }
        ...
        if (FMC_NORSRAMInitStruct->FMC_ExtendedMode == FMC_ExtendedMode_Enable) {
                assert_param(
                        IS_FMC_ADDRESS_SETUP_TIME(FMC_NORSRAMInitStruct->FMC_WriteTimingStruct->FMC_AddressSetupTime));
                assert_param(
                        IS_FMC_ADDRESS_HOLD_TIME(FMC_NORSRAMInitStruct->FMC_WriteTimingStruct->FMC_AddressHoldTime));
                ...
                tmpbwr &= ((uint32_t) ~(FMC_BWTR1_ADDSET | FMC_BWTR1_ADDHLD | FMC_BWTR1_DATAST | FMC_BWTR1_BUSTURN
                                        | FMC_BWTR1_ACCMOD));
...
void FMC_NANDInit(FMC_NANDInitTypeDef* FMC_NANDInitStruct)
{
        ...
        tmppcr &= ((uint32_t) ~(FMC_PCR2_PWAITEN | FMC_PCR2_PBKEN | FMC_PCR2_PTYP | FMC_PCR2_PWID | FMC_PCR2_ECCEN
                                | FMC_PCR2_TCLR | FMC_PCR2_TAR | FMC_PCR2_ECCPS));
        ...
        tmppcr |= (uint32_t)FMC_NANDInitStruct->FMC_Waitfeature | PCR_MEMORYTYPE_NAND
                  ...
                  | FMC_NANDInitStruct->FMC_ECCPageSize | (FMC_NANDInitStruct->FMC_TCLRSetupTime << 9)
        ...
        tmppmem &= ((uint32_t) ~(FMC_PMEM2_MEMSET2 | FMC_PMEM2_MEMWAIT2 | FMC_PMEM2_MEMHOLD2 | FMC_PMEM2_MEMHIZ2));
        ...
        tmppatt &= ((uint32_t) ~(FMC_PATT2_ATTSET2 | FMC_PATT2_ATTWAIT2 | FMC_PATT2_ATTHOLD2 | FMC_PATT2_ATTHIZ2));
...
void FMC_PCCARDInit(FMC_PCCARDInitTypeDef* FMC_PCCARDInitStruct)
{
        ...
        tmppcr |= (uint32_t)FMC_PCCARDInitStruct->FMC_Waitfeature | FMC_NAND_MemoryDataWidth_16b
                  | (FMC_PCCARDInitStruct->FMC_TCLRSetupTime << 9) | (FMC_PCCARDInitStruct->FMC_TARSetupTime << 13);
        ...
        /* Clear MEMSETx, MEMWAITx, MEMHOLDx and MEMHIZx bits */
        tmpmem &= ((uint32_t) ~(FMC_PMEM4_MEMSET4 | FMC_PMEM4_MEMWAIT4 | FMC_PMEM4_MEMHOLD4 | FMC_PMEM4_MEMHIZ4));
        ...
        /* Clear ATTSETx, ATTWAITx, ATTHOLDx and ATTHIZx bits */
        tmppatt &= ((uint32_t) ~(FMC_PATT4_ATTSET4 | FMC_PATT4_ATTWAIT4 | FMC_PATT4_ATTHOLD4 | FMC_PATT4_ATTHIZ4));
        ...
        tmppio &= ((uint32_t) ~(FMC_PIO4_IOSET4 | FMC_PIO4_IOWAIT4 | FMC_PIO4_IOHOLD4 | FMC_PIO4_IOHIZ4));
...
void FMC_SDRAMInit(FMC_SDRAMInitTypeDef* FMC_SDRAMInitStruct)
{
        ...
        assert_param(
                IS_FMC_EXITSELFREFRESH_DELAY(FMC_SDRAMInitStruct->FMC_SDRAMTimingStruct->FMC_ExitSelfRefreshDelay));
        ...
        tmpr1 &= ((uint32_t) ~(FMC_SDCR1_NC | FMC_SDCR1_NR | FMC_SDCR1_MWID | FMC_SDCR1_NB | FMC_SDCR1_CAS
                               | FMC_SDCR1_WP | FMC_SDCR1_SDCLK | FMC_SDCR1_RBURST | FMC_SDCR1_RPIPE));

        /* SDRAM bank control register configuration */
        tmpr1 |= (uint32_t)FMC_SDRAMInitStruct->FMC_ColumnBitsNumber | FMC_SDRAMInitStruct->FMC_RowBitsNumber
                 | FMC_SDRAMInitStruct->FMC_SDMemoryDataWidth | FMC_SDRAMInitStruct->FMC_InternalBankNumber
                 | FMC_SDRAMInitStruct->FMC_CASLatency | FMC_SDRAMInitStruct->FMC_WriteProtection
                 | FMC_SDRAMInitStruct->FMC_SDClockPeriod | FMC_SDRAMInitStruct->FMC_ReadBurst
        ...
        } else /* SDCR2 "don't care" bits configuration */
        {
                ...
                /* Clear NC, NR, MWID, NB, CAS, WP, SDCLK, RBURST, and RPIPE bits */
                tmpr3 &= ((uint32_t) ~(FMC_SDCR1_NC | FMC_SDCR1_NR | FMC_SDCR1_MWID | FMC_SDCR1_NB | FMC_SDCR1_CAS
                                       | FMC_SDCR1_WP | FMC_SDCR1_SDCLK | FMC_SDCR1_RBURST | FMC_SDCR1_RPIPE));

                tmpr3 |= (uint32_t)FMC_SDRAMInitStruct->FMC_SDClockPeriod | FMC_SDRAMInitStruct->FMC_ReadBurst
                         | FMC_SDRAMInitStruct->FMC_ReadPipeDelay;
        ...
        if (FMC_SDRAMInitStruct->FMC_Bank == FMC_Bank1_SDRAM) {
                ...
                tmpr2 &= ((uint32_t) ~(FMC_SDTR1_TMRD | FMC_SDTR1_TXSR | FMC_SDTR1_TRAS | FMC_SDTR1_TRC | FMC_SDTR1_TWR
                                       | FMC_SDTR1_TRP | FMC_SDTR1_TRCD));
        ...
        } else /* SDTR "don't care bits configuration */
        {
                ...
                /* Clear TMRD, TXSR, TRAS, TRC, TWR, TRP and TRCD bits */
                tmpr4 &= ((uint32_t) ~(FMC_SDTR1_TMRD | FMC_SDTR1_TXSR | FMC_SDTR1_TRAS | FMC_SDTR1_TRC | FMC_SDTR1_TWR
                                       | FMC_SDTR1_TRP | FMC_SDTR1_TRCD));
...
void FMC_SDRAMCmdConfig(FMC_SDRAMCommandTypeDef* FMC_SDRAMCommandStruct)
{
        ...
        tmpr = (uint32_t)(FMC_SDRAMCommandStruct->FMC_CommandMode | FMC_SDRAMCommandStruct->FMC_CommandTarget

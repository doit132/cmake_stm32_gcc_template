                         ...
                         uint32_t TAGSize)
{
        ...
        for (loopcounter = 0; loopcounter < NonceSize; loopcounter++) { blockb0[loopcounter + 1] = Nonce[loopcounter]; }
        for (; loopcounter < 13; loopcounter++) { blockb0[loopcounter + 1] = 0; }
  ...
  */
        ...
        for (loopcounter = 1; loopcounter < NonceSize + 1; loopcounter++) { ctr[loopcounter] = blockb0[loopcounter]; }
        /* Set the LSB to 1 */
        ctr[15] |= 0x01;

...
@verbatim
 ...
 ===============================================================================
    ...
    [..] Before enabling Stop mode using FMPI2C_StopModeCmd() FMPI2C Clock source must be set to
	 HSI and Digital filters must be disabled. This feature is not available for STM32F410xx
devices.
...
void FMPI2C_Init(FMPI2C_TypeDef *FMPI2Cx, FMPI2C_InitTypeDef *FMPI2C_InitStruct)
{
	...
	tmpreg |= (uint32_t)FMPI2C_InitStruct->FMPI2C_AnalogFilter |
		  (FMPI2C_InitStruct->FMPI2C_DigitalFilter << 8);
...
/**
 * @brief  Handles FMPI2Cx communication when starting transfer or during transfer (TC or TCR flag
 * are set).
 * @param  FMPI2Cx: where x can be 1 to select the FMPI2C peripheral.
 * @param  Address: specifies the slave address to be programmed.
 * @param  Number_Bytes: specifies the number of bytes to be programmed.
			     ...
			     uint32_t ReloadEndMode, uint32_t StartStopMode)
{
	...
	tmpreg &= (uint32_t) ~((uint32_t)(FMPI2C_CR2_SADD | FMPI2C_CR2_NBYTES | FMPI2C_CR2_RELOAD |
...
@verbatim
 ...
 ===============================================================================
    ...
    [..] In this Mode it is advised to use the following function:
	 (+) FMPI2C_DMACmd(FMPI2C_TypeDef* FMPI2Cx, uint32_t FMPI2C_DMAReq, FunctionalState
NewState);
@endverbatim
  * @{
  */
...
@verbatim
  ...
  *** Interrupt Mode ***
  ======================
	...
	(#) FMPI2C_IT_NACKI: specifies the interrupt source for the Not Acknowledge received
interrupt.

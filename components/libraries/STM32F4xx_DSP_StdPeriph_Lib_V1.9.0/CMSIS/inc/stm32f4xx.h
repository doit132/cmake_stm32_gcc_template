 ...
 * @brief In the following line adjust the External High Speed oscillator (HSE) Startup
   ...
   */
		...
		#define HSI_VALUE                                                                  \
			((uint32_t)16000000) /*!< Value of the Internal oscillator in              \
						Hz*/
	#endif				     /* HSI_VALUE */
 ...
 */
	...
	#define DFSDM_CHCFGR1_DATPACK                                                              \
		((uint32_t)0x0000C000)			       /*!< DATPACK[1:0] Data packing mode \
								*/
	...
	#define DFSDM_FLTCR1_AWFSEL                                                                \
		((uint32_t)0x40000000)			 /*!< Analog watchdog fast mode select     \
							  */
...
/********************  Bit definition for DMA2D_ISR register  *****************/
	...
	#define DMA2D_ISR_CTCIF                                                                    \
		((uint32_t)0x00000010)		      /*!< CLUT Transfer Complete Interrupt Flag   \
						       */
...
/********************  Bit definition for DMA2D_AMTCR register  ***************/
	...
	#define FLASH_OPTCR1_nWRP_11	((uint32_t)0x08000000)
		...
		#define FMC_SDCR1_NR                                                               \
			((uint32_t)0x0000000C) /*!<NR[1:0] bits (Number of row bits)               \
						*/
		...
		#define FMC_SDTR1_TRC                                                              \
			((uint32_t)0x0000F000)		       /*!<TRC[2:0] bits (Row cycle delay) \
								*/
	...
	#define I2C_FLTR_ANOFF ((uint8_t)0x10) /*!<Analog Noise Filter OFF */
		...
		#define FMPI2C_OAR1_OA1MODE                                                        \
			((uint32_t)0x00000400)			  /*!< Own address 1 10-bit mode   \
								   */
		...
		#define FMPI2C_ISR_TC                                                              \
			((uint32_t)0x00000040) /*!< Transfer complete (master mode)                \
						*/
		...
		#define FMPI2C_ICR_ADDRCF                                                          \
			((uint32_t)0x00000008)			 /*!< Address matched clear flag   \
								  */
		...
		#define FMPI2C_ICR_ARLOCF                                                          \
			((uint32_t)0x00000200) /*!< Arbitration lost clear flag                    \
						*/
		#define FMPI2C_ICR_OVRCF                                                           \
			((uint32_t)0x00000400)			/*!< Overrun/Underrun clear flag   \
								 */
...
/********************  Bit definition for LTDC_ICR register  ******************/
	...
	#define LTDC_ICR_CRRIF                                                                     \
		((uint32_t)0x00000008) /*!< Clears Register Reload interrupt Flag                  \
					*/
...
/********************  Bit definition for LTDC_LxWHPCR register  **************/
	...
	#define LTDC_LxWHPCR_WHSTPOS                                                               \
		((uint32_t)0x00000FFF) /*!< Window Horizontal Start Position                       \
					*/
	#define LTDC_LxWHPCR_WHSPPOS                                                               \
		((uint32_t)0xFFFF0000) /*!< Window Horizontal Stop Position                        \
					*/
...
/********************  Bit definition for LTDC_LxCFBAR register  **************/
	...
	#define LTDC_LxCFBAR_CFBADD                                                                \
		((uint32_t)0xFFFFFFFF) /*!< Color Frame Buffer Start Address                       \
					*/
...
/********************  Bit definition for LTDC_LxCLUTWR register  *************/
	...
	#define LTDC_LxCLUTWR_CLUTADD ((uint32_t)0xFF000000) /*!< CLUT address */
		...
		#define DSI_VVFPCR_VFP                                                             \
			((uint32_t)0x000003FF) /*!< Vertical Front-Porch duration                  \
						*/
		...
		#define DSI_ISR1_GPTXE                                                             \
			((uint32_t)0x00000400)		      /*!< Generic Payload Transmit Error  \
							       */
		#define DSI_ISR1_GPRDE ((uint32_t)0x00000800) /*!< Generic Payload Read Error */
		#define DSI_ISR1_GPRXE                                                             \
			((uint32_t)0x00001000) /*!< Generic Payload Receive Error                  \
						*/
		...
		#define DSI_IER1_EOTPEIE                                                           \
			((uint32_t)0x00000040) /*!< EoTp Error Interrupt Enable                    \
						*/
		...
		#define DSI_VMCCR_LPHFE                                                            \
			((uint32_t)0x00002000) /*!< Low-power Horizontal Front-porch Enable */
		#define DSI_VMCCR_FBTAAE                                                           \
			((uint32_t)0x00004000) /*!< Frame BTA Acknowledge Enable                   \
						*/
		...
		#define DSI_VVBPCCR_VBP                                                            \
			((uint32_t)0x000003FF) /*!< Vertical Back-Porch duration                   \
						*/
		...
		#define DSI_WIER_TEIE                                                              \
			((uint32_t)0x00000001) /*!< Tearing Effect Interrupt Enable                \
						*/
		#define DSI_WIER_ERIE                                                              \
			((uint32_t)0x00000002) /*!< End of Refresh Interrupt Enable                \
						*/
		...
		#define DSI_WISR_RRIF                                                              \
			((uint32_t)0x00002000) /*!< Regulator Ready Interrupt Flag                 \
						*/
		...
		#define DSI_WPCR0_UIX4                                                             \
			((uint32_t)0x0000003F) /*!< Unit Interval multiplied by 4                  \
						*/
		...
		#define DSI_WRPCR_PLL_ODF                                                          \
			((uint32_t)0x00030000) /*!< PLL Output Division Factor                     \
						*/
	...
	#define PWR_CR_ADCDC1                                                                      \
		((uint32_t)0x00002000) /*!< Refer to AN4073 on how to use this bit                 \
					*/
	...
	#define PWR_CSR_REGRDY PWR_CSR_VOSRDY
		...
		#define QUADSPI_FCR_CTCF                                                           \
			((uint32_t)0x00000002)			/*!< Clear Transfer Complete Flag  \
								 */
		...
		#define QUADSPI_CCR_ADMODE                                                         \
			((uint32_t)0x00000C00)			    /*!< ADMODE[1:0]: Address Mode \
								     */
		...
		#define QUADSPI_CCR_ADSIZE                                                         \
			((uint32_t)0x00003000)			    /*!< ADSIZE[1:0]: Address Size \
								     */
		...
		#define QUADSPI_CCR_FMODE                                                          \
			((uint32_t)0x0C000000) /*!< FMODE[1:0]: Functional Mode                    \
						*/
		...
		#define QUADSPI_CCR_DHHC                                                           \
			((uint32_t)0x40000000) /*!< DHHC: Delay Half Hclk Cycle                    \
						*/
		#define QUADSPI_CCR_DDRM                                                           \
			((uint32_t)0x80000000) /*!< DDRM: Double Data Rate Mode                    \
						*/
		...
		#define QUADSPI_PSMAR_MATCH                                                        \
			((uint32_t)0xFFFFFFFF) /*!< MATCH[31:0]: Status Match                      \
						*/

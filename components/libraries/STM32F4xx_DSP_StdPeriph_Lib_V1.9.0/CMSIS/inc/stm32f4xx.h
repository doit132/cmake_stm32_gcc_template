...
typedef struct {
        ...
        __IO uint32_t
                LVCIDR; /*!< DSI Host LTDC VCID Register,                               Address offset: 0x0C       */
        __IO uint32_t
                LCOLCR; /*!< DSI Host LTDC Color Coding Register,                       Address offset: 0x10       */
        __IO uint32_t
                LPCR; /*!< DSI Host LTDC Polarity Configuration Register,             Address offset: 0x14       */
        __IO uint32_t
                 LPMCR; /*!< DSI Host Low-Power Mode Configuration Register,            Address offset: 0x18       */
        uint32_t RESERVED0
                [4];       /*!< Reserved, 0x1C - 0x2B                                                                 */
        __IO uint32_t PCR; /*!< DSI Host Protocol Configuration Register,                  Address offset: 0x2C       */
        __IO uint32_t
                GVCIDR;    /*!< DSI Host Generic VCID Register,                            Address offset: 0x30       */
        __IO uint32_t MCR; /*!< DSI Host Mode Configuration Register,                      Address offset: 0x34       */
        __IO uint32_t
                VMCR; /*!< DSI Host Video Mode Configuration Register,                Address offset: 0x38       */
        __IO uint32_t
                VPCR; /*!< DSI Host Video Packet Configuration Register,              Address offset: 0x3C       */
        __IO uint32_t
                VCCR; /*!< DSI Host Video Chunks Configuration Register,              Address offset: 0x40       */
        __IO uint32_t
                VNPCR; /*!< DSI Host Video Null Packet Configuration Register,         Address offset: 0x44       */
        __IO uint32_t
                VHSACR; /*!< DSI Host Video HSA Configuration Register,                 Address offset: 0x48       */
        __IO uint32_t
                VHBPCR; /*!< DSI Host Video HBP Configuration Register,                 Address offset: 0x4C       */
        __IO uint32_t
                VLCR; /*!< DSI Host Video Line Configuration Register,                Address offset: 0x50       */
        __IO uint32_t
                VVSACR; /*!< DSI Host Video VSA Configuration Register,                 Address offset: 0x54       */
        __IO uint32_t
                VVBPCR; /*!< DSI Host Video VBP Configuration Register,                 Address offset: 0x58       */
        __IO uint32_t
                VVFPCR; /*!< DSI Host Video VFP Configuration Register,                 Address offset: 0x5C       */
        __IO uint32_t
                VVACR; /*!< DSI Host Video VA Configuration Register,                  Address offset: 0x60       */
        __IO uint32_t
                LCCR; /*!< DSI Host LTDC Command Configuration Register,              Address offset: 0x64       */
        __IO uint32_t
                CMCR; /*!< DSI Host Command Mode Configuration Register,              Address offset: 0x68       */
        __IO uint32_t
                GHCR; /*!< DSI Host Generic Header Configuration Register,            Address offset: 0x6C       */
        __IO uint32_t
                GPDR; /*!< DSI Host Generic Payload Data Register,                    Address offset: 0x70       */
        __IO uint32_t
                GPSR; /*!< DSI Host Generic Packet Status Register,                   Address offset: 0x74       */
        __IO uint32_t
                TCCR[6]; /*!< DSI Host Timeout Counter Configuration Register,           Address offset: 0x78-0x8F  */
        __IO uint32_t
                TDCR; /*!< DSI Host 3D Configuration Register,                        Address offset: 0x90       */
        __IO uint32_t
                CLCR; /*!< DSI Host Clock Lane Configuration Register,                Address offset: 0x94       */
        __IO uint32_t
                CLTCR; /*!< DSI Host Clock Lane Timer Configuration Register,          Address offset: 0x98       */
        __IO uint32_t
                DLTCR; /*!< DSI Host Data Lane Timer Configuration Register,           Address offset: 0x9C       */
        __IO uint32_t
                PCTLR; /*!< DSI Host PHY Control Register,                             Address offset: 0xA0       */
        __IO uint32_t
                PCONFR; /*!< DSI Host PHY Configuration Register,                       Address offset: 0xA4       */
        __IO uint32_t
                PUCR; /*!< DSI Host PHY ULPS Control Register,                        Address offset: 0xA8       */
        __IO uint32_t
                PTTCR;     /*!< DSI Host PHY TX Triggers Configuration Register,           Address offset: 0xAC       */
        __IO uint32_t PSR; /*!< DSI Host PHY Status Register,                              Address offset: 0xB0       */
        uint32_t      RESERVED1
                [2]; /*!< Reserved, 0xB4 - 0xBB                                                                 */
        __IO uint32_t
                ISR[2]; /*!< DSI Host Interrupt & Status Register,                      Address offset: 0xBC-0xC3  */
        __IO uint32_t
                 IER[2]; /*!< DSI Host Interrupt Enable Register,                        Address offset: 0xC4-0xCB  */
        uint32_t RESERVED2
                [3]; /*!< Reserved, 0xD0 - 0xD7                                                                 */
        __IO uint32_t
                 FIR[2]; /*!< DSI Host Force Interrupt Register,                         Address offset: 0xD8-0xDF  */
        uint32_t RESERVED3
                [8]; /*!< Reserved, 0xE0 - 0xFF                                                                 */
        __IO uint32_t
                 VSCR; /*!< DSI Host Video Shadow Control Register,                    Address offset: 0x100      */
        uint32_t RESERVED4
                [2]; /*!< Reserved, 0x104 - 0x10B                                                               */
        __IO uint32_t
                LCVCIDR; /*!< DSI Host LTDC Current VCID Register,                       Address offset: 0x10C      */
        __IO uint32_t
                LCCCR; /*!< DSI Host LTDC Current Color Coding Register,               Address offset: 0x110      */
        uint32_t
                RESERVED5; /*!< Reserved, 0x114                                                                       */
        __IO uint32_t
                 LPMCCR; /*!< DSI Host Low-power Mode Current Configuration Register,    Address offset: 0x118      */
        uint32_t RESERVED6
                [7]; /*!< Reserved, 0x11C - 0x137                                                               */
        __IO uint32_t
                VMCCR; /*!< DSI Host Video Mode Current Configuration Register,        Address offset: 0x138      */
        __IO uint32_t
                VPCCR; /*!< DSI Host Video Packet Current Configuration Register,      Address offset: 0x13C      */
        __IO uint32_t
                VCCCR; /*!< DSI Host Video Chuncks Current Configuration Register,     Address offset: 0x140      */
        __IO uint32_t
                VNPCCR; /*!< DSI Host Video Null Packet Current Configuration Register, Address offset: 0x144      */
        __IO uint32_t
                VHSACCR; /*!< DSI Host Video HSA Current Configuration Register,         Address offset: 0x148      */
        __IO uint32_t
                VHBPCCR; /*!< DSI Host Video HBP Current Configuration Register,         Address offset: 0x14C      */
        __IO uint32_t
                VLCCR; /*!< DSI Host Video Line Current Configuration Register,        Address offset: 0x150      */
        __IO uint32_t
                VVSACCR; /*!< DSI Host Video VSA Current Configuration Register,         Address offset: 0x154      */
        __IO uint32_t
                VVBPCCR; /*!< DSI Host Video VBP Current Configuration Register,         Address offset: 0x158      */
        __IO uint32_t
                VVFPCCR; /*!< DSI Host Video VFP Current Configuration Register,         Address offset: 0x15C      */
        __IO uint32_t
                 VVACCR; /*!< DSI Host Video VA Current Configuration Register,          Address offset: 0x160      */
        uint32_t RESERVED7
                [11]; /*!< Reserved, 0x164 - 0x18F                                                               */
        __IO uint32_t
                 TDCCR; /*!< DSI Host 3D Current Configuration Register,                Address offset: 0x190      */
        uint32_t RESERVED8
                [155]; /*!< Reserved, 0x194 - 0x3FF                                                               */
        __IO uint32_t
                WCFGR;     /*!< DSI Wrapper Configuration Register,                       Address offset: 0x400       */
        __IO uint32_t WCR; /*!< DSI Wrapper Control Register,                             Address offset: 0x404       */
        __IO uint32_t
                WIER; /*!< DSI Wrapper Interrupt Enable Register,                    Address offset: 0x408       */
        __IO uint32_t
                WISR; /*!< DSI Wrapper Interrupt and Status Register,                Address offset: 0x40C       */
        __IO uint32_t
                WIFCR; /*!< DSI Wrapper Interrupt Flag Clear Register,                Address offset: 0x410       */
        uint32_t
                RESERVED9; /*!< Reserved, 0x414                                                                       */
        __IO uint32_t
                WPCR[5]; /*!< DSI Wrapper PHY Configuration Register,                   Address offset: 0x418-0x42B */
        uint32_t
                RESERVED10; /*!< Reserved, 0x42C                                                                       */
        __IO uint32_t
...
typedef struct {
        ...
        __IO uint32_t
                CLUTWR; /*!< LTDC Layerx CLUT Write Register                               Address offset: 0x144 */
...
typedef struct {
        ...
        __IO uint32_t
                PLLSAICFGR;    /*!< RCC PLLSAI configuration register,                           Address offset: 0x88 */
...
/** @addtogroup Peripheral_memory_map
  ...
  */
        ...
        #define CCMDATARAM_BASE \
                ((uint32_t)0x10000000) /*!< CCM(core coupled memory) data RAM(64 KB) base address in the alias region  */
        #define SRAM1_BASE \
        ...
        #if defined(STM32F40_41xxx) || (STM32F427_437xx) || (STM32F429_439xx) || (STM32F410xx) || (STM32F412xG) \
                || (STM32F413_423xx) || (STM32F446xx) || (STM32F469_479xx)
                #define BKPSRAM_BASE \
                        ((uint32_t)0x40024000) /*!< Backup SRAM(4 KB) base address in the alias region                         */
        ...
        #define CCMDATARAM_BB_BASE \
                ((uint32_t)0x12000000) /*!< CCM(core coupled memory) data RAM(64 KB) base address in the bit-band region  */
        #define SRAM1_BB_BASE \
                ((uint32_t)0x22000000) /*!< SRAM1(112 KB) base address in the bit-band region                             */
        #if defined(STM32F40_41xxx) || defined(STM32F427_437xx) || defined(STM32F429_439xx) || defined(STM32F446xx)
                #define SRAM2_BB_BASE \
                        ((uint32_t)0x22380000) /*!< SRAM2(16 KB) base address in the bit-band region                              */
                #define SRAM3_BB_BASE \
                        ((uint32_t)0x22400000) /*!< SRAM3(64 KB) base address in the bit-band region                              */
        #elif defined(STM32F469_479xx)
                #define SRAM2_BB_BASE \
                        ((uint32_t)0x22500000) /*!< SRAM2(16 KB) base address in the bit-band region                              */
                #define SRAM3_BB_BASE \
                        ((uint32_t)0x22600000) /*!< SRAM3(64 KB) base address in the bit-band region                              */
        #elif defined(STM32F413_423xx)
                #define SRAM2_BB_BASE \
                        ((uint32_t)0x22800000) /*!< SRAM2(64 KB) base address in the bit-band region                              */
        #else                                  /* STM32F411xE || STM32F410xx || STM32F412xG */
        #endif /* STM32F40_41xxx || STM32F427_437xx || STM32F429_439xx ||  STM32F446xx */
...
/** @addtogroup Peripheral_Registers_Bits_Definition
  ...
  */
        ...
        #define ADC_CR2_JEXTSEL \
                ((uint32_t)0x000F0000) /*!<JEXTSEL[3:0] bits (External event select for injected group) */
        #define ADC_CR2_JEXTSEL_0 ((uint32_t)0x00010000) /*!<Bit 0 */
        #define ADC_CR2_JEXTSEL_1 ((uint32_t)0x00020000) /*!<Bit 1 */
        #define ADC_CR2_JEXTSEL_2 ((uint32_t)0x00040000) /*!<Bit 2 */
        #define ADC_CR2_JEXTSEL_3 ((uint32_t)0x00080000) /*!<Bit 3 */
        #define ADC_CR2_JEXTEN \
                ((uint32_t)0x00300000) /*!<JEXTEN[1:0] bits (External Trigger Conversion mode for injected channelsp) */
        ...
        #define ADC_CR2_EXTEN \
                ((uint32_t)0x30000000) /*!<EXTEN[1:0] bits (External Trigger Conversion mode for regular channelsp) */
        ...
        #define DFSDM_CHAWSCDR_AWFORD \
                ((uint32_t)0x00C00000) /*!< AWFORD[1:0] Analog watchdog Sinc filter order on channel y */
        ...
        #define DFSDM_CHAWSCDR_AWFOSR \
                ((uint32_t)0x001F0000) /*!< AWFOSR[4:0] Analog watchdog filter oversampling ratio on channel y */
        #define DFSDM_CHAWSCDR_BKSCD \
                ((uint32_t)0x0000F000) /*!< BKSCD[3:0] Break signal assignment for short circuit detector on channel y */
        #define DFSDM_CHAWSCDR_SCDT \
                ((uint32_t)0x000000FF) /*!< SCDT[7:0] Short circuit detector threshold for channel y */
        ...
        #define DFSDM_CHDATINR_INDAT0 \
                ((uint32_t)0x0000FFFF) /*!< INDAT0[31:16] Input data for channel y or channel (y+1) */
        ...
        #define DFSDM_FLTCR1_RDMAEN \
                ((uint32_t)0x00200000) /*!< DMA channel enabled to read data for the regular conversion */
        ...
        #define DFSDM_FLTCR1_JEXTEN \
                ((uint32_t)0x00006000) /*!< JEXTEN[1:0] Trigger enable and trigger edge selection for injected conversions */
        #define DFSDM_FLTCR1_JEXTEN_1 \
                ((uint32_t)0x00004000) /*!< Trigger enable and trigger edge selection for injected conversions, Bit 1 */
        #define DFSDM_FLTCR1_JEXTEN_0 \
                ((uint32_t)0x00002000) /*!< Trigger enable and trigger edge selection for injected conversions, Bit 0 */
        #define DFSDM_FLTCR1_JEXTSEL \
                ((uint32_t)0x00000700) /*!< JEXTSEL[2:0]Trigger signal selection for launching injected conversions */
        #define DFSDM_FLTCR1_JEXTSEL_2 \
                ((uint32_t)0x00000400) /*!< Trigger signal selection for launching injected conversions, Bit 2 */
        #define DFSDM_FLTCR1_JEXTSEL_1 \
                ((uint32_t)0x00000200) /*!< Trigger signal selection for launching injected conversions, Bit 1 */
        #define DFSDM_FLTCR1_JEXTSEL_0 \
                ((uint32_t)0x00000100) /*!< Trigger signal selection for launching injected conversions, Bit 0 */
        #define DFSDM_FLTCR1_JDMAEN \
                ((uint32_t)0x00000020) /*!< DMA channel enabled to read data for the injected channel group */
        #define DFSDM_FLTCR1_JSCAN \
                ((uint32_t)0x00000010) /*!< Scanning conversion in continuous mode selection for injected conversions */
        #define DFSDM_FLTCR1_JSYNC \
                ((uint32_t)0x00000008) /*!< Launch an injected conversion synchronously with DFSDMx JSWSTART trigger  */
        ...
        #define DFSDM_FLTFCR_FOSR \
                ((uint32_t)0x03FF0000) /*!< FOSR[9:0] Sinc filter oversampling ratio (decimation rate) */
        #define DFSDM_FLTFCR_IOSR \
                ((uint32_t)0x000000FF) /*!< IOSR[7:0] Integrator oversampling ratio (averaging length) */
        ...
        #define DFSDM_FLTAWHTR_BKAWH \
                ((uint32_t)0x0000000F) /*!< BKAWH[3:0] Break signal assignment to analog watchdog high threshold event */
        ...
        #define DFSDM_FLTAWLTR_BKAWL \
                ((uint32_t)0x0000000F) /*!< BKAWL[3:0] Break signal assignment to analog watchdog low threshold event */

        /***************  Bit definition for DFSDM_FLTAWSR register *******************/
        #define DFSDM_FLTAWSR_AWHTF \
                ((uint32_t)0x00000F00) /*!< AWHTF[15:8] Analog watchdog high threshold error on given channels */
        #define DFSDM_FLTAWSR_AWLTF \
                ((uint32_t)0x0000000F) /*!< AWLTF[7:0] Analog watchdog low threshold error on given channels */

        /***************  Bit definition for DFSDM_FLTAWCFR register ******************/
        #define DFSDM_FLTAWCFR_CLRAWHTF \
                ((uint32_t)0x00000F00) /*!< CLRAWHTF[15:8] Clear the Analog watchdog high threshold flag */
        #define DFSDM_FLTAWCFR_CLRAWLTF \
                ((uint32_t)0x0000000F) /*!< CLRAWLTF[7:0] Clear the Analog watchdog low threshold flag */
...
/********************  Bit definition for DMA2D_AMTCR register  ***************/
        ...
        #define I2C_FLTR_ANOFF ((uint8_t)0x10) /*!<Analog Noise Filter OFF */
                ...
                #define FMPI2C_CR2_HEAD10R \
                        ((uint32_t)0x00001000) /*!< 10-bit address header only read direction (master mode) */
...
/********************  Bit definition for LTDC_LxCLUTWR register  *************/
        ...
        #define LTDC_LxCLUTWR_CLUTADD ((uint32_t)0xFF000000) /*!< CLUT address */
                ...
                #define DSI_IER1_TOHSTXIE \
                        ((uint32_t)0x00000001) /*!< Timeout High-Speed Transmission Interrupt Enable */
                ...
                #define DSI_WPCR1_LPSRCCL \
                        ((uint32_t)0x000000C0) /*!< Low-Power transmission Slew Rate Compensation on Clock Lane */
                #define DSI_WPCR1_LPSRCCL0 ((uint32_t)0x00000040)
                #define DSI_WPCR1_LPSRCCL1 ((uint32_t)0x00000080)

                #define DSI_WPCR1_LPSRCDL \
                        ((uint32_t)0x00000300) /*!< Low-Power transmission Slew Rate Compensation on Data Lane */
                ...
                #define DSI_WPCR1_LPRXVCDL \
                        ((uint32_t)0x0000C000) /*!< Low-Power Reception V-IL Compensation on Data Lanes */
...
/********************  Bit definition for RCC_AHB3ENR register  ***************/
        ...
        #define SAI_xIMR_AFSDETIE \
                ((uint32_t)0x00000020) /*!<Anticipated frame synchronization detection interrupt enable   */
        ...
        #define SAI_xDR_DATA ((uint32_t)0xFFFFFFFF)
                ...
                #define SPDIFRX_CR_NBTR \
                        ((uint32_t)0x00003000) /*!<Maximum allowed re-tries during synchronization phase */
  ...
  */
        ...
        #define SYSCFG_CMPCR_READY  ((uint32_t)0x00000100) /*!<Compensation cell power-down */
                ...
                #define SYSCFG_MCHDLYCR_DFSDM1CK02SEL \
                        ((uint32_t)0x00000010) /*!<Distribution of the bitstreamclock gated by TIM4 OC2 */
                #define SYSCFG_MCHDLYCR_DFSDM1CK13SEL \
                        ((uint32_t)0x00000020) /*!<Distribution of the bitstreamclock gated by TIM4 OC1 */
                ...
                #define SYSCFG_MCHDLYCR_DFSDM2CK04SEL \
                        ((uint32_t)0x00002000) /*!<Distribution of the bitstreamclock gated by TIM3 OC4 */
                #define SYSCFG_MCHDLYCR_DFSDM2CK15SEL \
                        ((uint32_t)0x00004000) /*!<Distribution of the bitstreamclock gated by TIM3 OC3 */
                #define SYSCFG_MCHDLYCR_DFSDM2CK26SEL \
                        ((uint32_t)0x00008000) /*!Distribution of the bitstreamclock gated by TIM3 OC2  */
                #define SYSCFG_MCHDLYCR_DFSDM2CK37SEL \
                        ((uint32_t)0x00010000) /*!<Distribution of the bitstreamclock gated by TIM3 OC1 */
...
/*----------------------------------------------------------------------------*/
        ...
        #define TIM_OR_ITR1_RMP_1 ((uint16_t)0x0800) /*!<Bit 1 */
                ...
                #define LPTIM_IER_UPIE \
                        ((uint32_t)0x00000020) /*!< Counter direction change down to up Interrupt Enable */
                #define LPTIM_IER_DOWNIE \
                        ((uint32_t)0x00000040) /*!< Counter direction change up to down Interrupt Enable */
                ...
                #define LPTIM_CFGR_CKFLT \
                        ((uint32_t)0x00000018) /*!< CKFLT[1:0] bits (Configurable digital filter for external clock) */
                ...
                #define LPTIM_CFGR_TRGFLT \
                        ((uint32_t)0x000000C0) /*!< TRGFLT[1:0] bits (Configurable digital filter for trigger) */
   ...
   Wake-UpFrame Filter Re7 : Filter3 CRC16 - Filter2 CRC16 */
        ...
        #define ETH_MMCTGFMSCCR_TGFMSCC \
                ((uint32_t)0xFFFFFFFF) /* Number of successfully transmitted frames after more than a single collision in Half-duplex mode. */
        ...
        #define ETH_PTPTSSR_TSSMRME \
                ((uint32_t)0x00008000) /* Time stamp snapshot for message relevant to master enable */
        ...
        #define ETH_PTPTSSR_TSPTPPSV2E \
                ((uint32_t)0x00000400) /* Time stamp PTP packet snooping for version2 format enable */

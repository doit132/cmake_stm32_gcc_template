  ...
  */
        ...
        #define IS_TIM_ALL_PERIPH(PERIPH)                                                                    \
                (((PERIPH) == TIM1) || ((PERIPH) == TIM2) || ((PERIPH) == TIM3) || ((PERIPH) == TIM4)        \
                 ...
                 || ((PERIPH) == TIM13) || ((PERIPH) == TIM14) || ((PERIPH) == TIM15) || ((PERIPH) == TIM16) \
                 || ((PERIPH) == TIM17))
        ...
        #define IS_TIM_LIST2_PERIPH(PERIPH)                                                             \
                (((PERIPH) == TIM1) || ((PERIPH) == TIM8) || ((PERIPH) == TIM15) || ((PERIPH) == TIM16) \
                 || ((PERIPH) == TIM17))
        ...
        #define IS_TIM_LIST4_PERIPH(PERIPH)                                                                \
                (((PERIPH) == TIM1) || ((PERIPH) == TIM2) || ((PERIPH) == TIM3) || ((PERIPH) == TIM4)      \
                 || ((PERIPH) == TIM5) || ((PERIPH) == TIM8) || ((PERIPH) == TIM15) || ((PERIPH) == TIM16) \
                 || ((PERIPH) == TIM17))

        /* LIST5: TIM 1, 2, 3, 4, 5, 8 and 15 */
        #define IS_TIM_LIST5_PERIPH(PERIPH)                                                           \
                (((PERIPH) == TIM1) || ((PERIPH) == TIM2) || ((PERIPH) == TIM3) || ((PERIPH) == TIM4) \
                 || ((PERIPH) == TIM5) || ((PERIPH) == TIM8) || ((PERIPH) == TIM15))
